...
# Example usage:
file_list = ['100.csv', '200.csv', '300.csv', '400.csv', '500.csv', '600.csv', '700.csv', '800.csv', '900.csv', '1000.csv']
file_list = ['reward1_partial/'+x for x in file_list] + ['reward2_partial/'+x for x in file_list]
output_csv = 'summary_partial.csv'
