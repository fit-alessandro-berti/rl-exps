...
from transformers import AutoTokenizer, AutoModelForCausalLM, DataCollatorForCompletionOnlyLM
...
def load_limited_dataset(data_dir: str, max_samples: int) -> Dataset:
    ...
    for file_name in file_names[:max_samples]:
        ...
        data_list.append({"prompt": prompt, "completion": powl_code})
...
training_args = SFTConfig(
    ...
    report_to="none",
    packing=False,  # Disable packing to use completion-only loss
)
...
print("Look for 'loss' in the logs below.")
