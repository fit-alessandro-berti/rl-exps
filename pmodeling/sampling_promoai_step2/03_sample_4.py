...
auto_alert = Transition(label='Send an automated alert')
...
root = StrictPartialOrder(nodes=[
    check_inventory, inspect_stock, place_order, place_stock_storage, place_stock_shelves, receive_stock, record_stock,
    manual_alert, auto_alert, update_inventory, update_inventory_system
])
...
root.order.add_edge(record_stock, auto_alert)
root.order.add_edge(manual_alert, update_inventory)
root.order.add_edge(auto_alert, update_inventory)
