...
root.order.add_edge(inspect_returned_items, notify_about_failed_payment)
root.order.add_edge(notify_about_failed_payment, package_items)
...
root.order.add_edge(pick_items_from_warehouse, place_order)
root.order.add_edge(place_order, prepare_documentation_for_international_orders)
root.order.add_edge(prepare_documentation_for_international_orders, prepare_shipping_documents_and_labels)
root.order.add_edge(prepare_shipping_documents_and_labels, process_payment)
...
root.order.add_edge(receive_back_order, receive_returned_items)
root.order.add_edge(receive_returned_items, inspect_returned_items)
root.order.add_edge(receive_returned_items, process_refund)
root.order.add_edge(receive_returned_items, process_replacement)
root.order.add_edge(receive_returned_items, send_return_shipping_label)
root.order.add_edge(receive_returned_items, send_follow_up_email)
root.order.add_edge(receive_returned_items, update_inventory_levels)
...
root.order.add_edge(record_order_details, check_stock_availability)
