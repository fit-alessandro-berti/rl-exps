...
root.order.add_edge(kitchen_prepares_food, sommelier_fetches_wine_and_prepares_alcoholic_beverages)
root.order.add_edge(sommelier_fetches_wine_and_prepares_alcoholic_beverages, waiter_debits_guests_account)
