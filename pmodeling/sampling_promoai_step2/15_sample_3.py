...
root = StrictPartialOrder(nodes=[award_certification, conduct_external_audit, conduct_final_audit, conduct_self_assessment, gather_evidence, identify_gaps_or_issues, issue_official_documents, make_necessary_corrections_or_improvements, prepare_documentation, schedule_compliance_audit])
