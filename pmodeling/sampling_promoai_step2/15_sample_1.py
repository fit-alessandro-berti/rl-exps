...
root.order.add_edge(identify_gaps_or_issues, conduct_external_audit)
root.order.add_edge(conduct_external_audit, conduct_final_audit)
root.order.add_edge(conduct_final_audit, make_necessary_corrections_or_improvements)
root.order.add_edge(make_necessary_corrections_or_improvements, issue_official_documents)
