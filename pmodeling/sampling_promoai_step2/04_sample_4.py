...
root = StrictPartialOrder(nodes=[analyze_performance, campaign_ends, collect_leads, create_content, define_objectives, design_visuals, launch_campaign, sales_follow_up, select_channels, track_performance])
...
root.order.add_edge(track_performance, sales_follow_up)
root.order.add_edge(sales_follow_up, collect_leads)
root.order.add_edge(collect_leads, analyze_performance)
