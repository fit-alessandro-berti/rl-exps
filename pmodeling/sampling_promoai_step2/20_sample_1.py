...
# Define dependencies
root.order.add_edge(guest_calls_room_service, kitchen_prepares_food)
root.order.add_edge(kitchen_prepares_food, manager_assigns_order_to_waiter)
...
root.order.add_edge(manager_takes_down_the_order, sommelier_fetches_wine_and_prepares_alcoholic_beverages)
