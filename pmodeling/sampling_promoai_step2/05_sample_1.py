...
root.order.add_edge(onboard_supplier, begin_contract_negotiations)
root.order.add_edge(begin_contract_negotiations, conduct_interview)
root.order.add_edge(conduct_interview, conduct_site_visit)
root.order.add_edge(conduct_site_visit, execute_contract)
