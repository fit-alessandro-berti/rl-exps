...
# Define the process
root = StrictPartialOrder(nodes=[submit_request, assess_compatibility, evaluate_cost, procure_tools, install_solution, test_solution, roll_out_solution, provide_training, provide_support])
