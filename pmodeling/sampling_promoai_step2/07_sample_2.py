...
root.order.add_edge(select_date_and_time, provide_personal_info)
...
root.order.add_edge(send_ticket_via_email, send_instructions)
root.order.add_edge(send_ticket_via_sms, send_instructions)
root.order.add_edge(send_instructions, send_reminder)
root.order.add_edge(send_reminder, update_seat_inventory)
