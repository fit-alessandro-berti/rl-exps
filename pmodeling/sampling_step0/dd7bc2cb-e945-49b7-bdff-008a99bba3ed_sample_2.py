...
loop = OperatorPOWL(operator=Operator.LOOP, children=[milk_test, milk_pasteurize, curd_form, whey_drain, cheese_press, salt_rub, aging_set, flavor_check, texture_scan, quality_approve, custom_pack])
xor = OperatorPOWL(operator=Operator.XOR, children=[cold_ship, retail_train, feedback_log])
