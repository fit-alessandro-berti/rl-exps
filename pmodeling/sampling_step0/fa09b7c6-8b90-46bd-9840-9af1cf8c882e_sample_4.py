...
# Define the loop
loop = OperatorPOWL(operator=Operator.LOOP, children=[yield_review, legal_review])

# Define the exclusive choice
xor = OperatorPOWL(operator=Operator.XOR, children=[pest_control, skip])

# Define the partial order
root = StrictPartialOrder(nodes=[site_survey, design_layout, install_lighting, setup_hydroponics, calibrate_sensors, select_crops, mix_nutrients, deploy_iot, energy_audit, train_staff, xor, loop, market_analysis, plan_logistics])
