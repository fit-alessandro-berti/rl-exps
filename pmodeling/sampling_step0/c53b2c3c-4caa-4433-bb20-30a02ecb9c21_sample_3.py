...
skip_secure_transfer = SilentTransition()
...
# Add the silent transitions to the appropriate places
root.order.add_edge(initial_survey, skip_initial_survey)
root.order.add_edge(legal_review, skip_legal_review)
root.order.add_edge(secure_transfer, skip_secure_transfer)
