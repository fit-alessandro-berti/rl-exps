...
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[harvest_crop, quality_sort, pack_goods, cold_store, market_ship])
xor1 = OperatorPOWL(operator=Operator.XOR, children=[data_analyze, loop1])
