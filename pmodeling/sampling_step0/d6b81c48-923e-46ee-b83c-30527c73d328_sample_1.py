...
loop = OperatorPOWL(operator=Operator.LOOP, children=[flight_launch, telemetry_monitor, anomaly_detect, collision_assess, data_upload])
xor = OperatorPOWL(operator=Operator.XOR, children=[postflight_review, battery_optimize, damage_repair, compliance_report, performance_log, mission_debrief])
