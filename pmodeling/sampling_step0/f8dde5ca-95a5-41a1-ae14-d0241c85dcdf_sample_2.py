...
# Define loop node for conservation plan
loop = OperatorPOWL(operator=Operator.LOOP, children=[conservation_plan, skip])

# Define XOR node for expert panel
xor = OperatorPOWL(operator=Operator.XOR, children=[expert_panel, skip])
