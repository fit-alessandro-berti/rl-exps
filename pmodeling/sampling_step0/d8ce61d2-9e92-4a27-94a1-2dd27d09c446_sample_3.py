...
root = StrictPartialOrder(nodes=[initial_audit, artist_review, material_check, condition_scan, ownership_verify_xor, restoration_loop, logistics_book, shipping_monitor, customs_clear, legal_compliance, ledger_update, exhibition_setup, public_showcase, archival_prep, final_report])
...
root.order.add_edge(condition_scan, ownership_verify_xor)
root.order.add_edge(ownership_verify_xor, restoration_loop)
