root = StrictPartialOrder(nodes=[Transition(label='Trend Scan'), Transition(label='Opportunity Map'), Transition(label='Expert Gather'), Transition(label='Idea Sprint'), Transition(label='Proto Build'), Transition(label='User Feedback'), Transition(label='Risk Review'), Transition(label='IP Audit'), Transition(label='Pilot Launch'), Transition(label='Stakeholder Meet'), Transition(label='Resource Shift'), Transition(label='Scale Up'), Transition(label='Impact Assess'), Transition(label='Knowledge Share'), Transition(label='Monitor Trends')])
root.order.add_edge(Transition(label='Trend Scan'), Transition(label='Opportunity Map'))
root.order.add_edge(Transition(label='Opportunity Map'), Transition(label='Expert Gather'))
