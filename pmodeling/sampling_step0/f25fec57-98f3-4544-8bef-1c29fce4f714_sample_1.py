...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[crop_seeding, quality_testing, harvest_scheduling, distribution_plan])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[staff_training, nutrient_sourcing, waste_planning])
loop3 = OperatorPOWL(operator=Operator.LOOP, children=[site_survey, permit_filing, structure_design, system_install, hydroponic_setup, climate_config, ai_integration])
