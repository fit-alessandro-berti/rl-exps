...
root = StrictPartialOrder(nodes=[activities['Client Profiling'], activities['Ingredient Sourcing'], activities['Quality Check'], activities['Blend Experiment'], activities['Maturation Cycle'], activities['Sensory Panel'], activities['Refinement Loop'], activities['Stability Test'], activities['Packaging Design'], activities['Batch Coordination'], activities['Compliance Audit'], activities['Market Survey'], activities['Feedback Review'], activities['Order Finalize'], activities['Distribution Plan'], activities['Inventory Update']])
