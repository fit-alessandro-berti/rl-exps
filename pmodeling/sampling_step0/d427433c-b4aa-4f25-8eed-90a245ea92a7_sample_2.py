...
# Milk Collection --> Quality Testing
# Milk Collection --> Milk Blending
# Milk Blending --> Starter Culture
# Starter Culture --> Fermentation Check
# Fermentation Check --> Curd Cutting
# Curd Cutting --> Whey Separation
# Whey Separation --> Molding Press
# Molding Press --> Salting Stage
# Salting Stage --> Aging Control
# Aging Control --> Packaging Design
# Packaging Design --> Cold Shipping
# Cold Shipping --> Compliance Audit
# Compliance Audit --> Blockchain Log
# Blockchain Log --> Market Pricing
# Market Pricing --> Order Fulfillment
# Order Fulfillment --> Feedback Review
# Feedback Review --> Milk Collection

# Define the root model
root = StrictPartialOrder()
root.nodes.extend([milk_collection, quality_testing, milk_blending, starter_culture, fermentation_check, curd_cutting, whey_separation, molding_press, salting_stage, aging_control, packaging_design, cold_shipping, compliance_audit, blockchain_log, market_pricing, order_fulfillment, feedback_review])

# Define the partial order
root.order.add_edge(milk_collection, quality_testing)
root.order.add_edge(milk_collection, milk_blending)
...
root.order.add_edge(feedback_review, milk_collection)