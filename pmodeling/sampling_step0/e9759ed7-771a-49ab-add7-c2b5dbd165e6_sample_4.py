...
root = StrictPartialOrder(nodes=[
    ingredient_sourcing_to_sample_testing,
    sample_testing_to_oil_extraction,
    oil_extraction_to_blend_formulation,
    blend_formulation_to_quality_control,
    quality_control_to_aging_process,
    aging_process_to_allergen_check,
    allergen_check_to_market_research,
    market_research_to_bottle_design,
    bottle_design_to_label_approval,
    label_approval_to_packaging_setup,
    packaging_setup_to_batch_mixing,
    batch_mixing_to_scent_profiling,
    scent_profiling_to_client_feedback,
    client_feedback_to_release_scheduling,
    release_scheduling_to_regulatory_review,
    regulatory_review_to_sales_training
])
root.order.add_edge(ingredient_sourcing_to_sample_testing, sample_testing_to_oil_extraction)
root.order.add_edge(sample_testing_to_oil_extraction, oil_extraction_to_blend_formulation)
root.order.add_edge(oil_extraction_to_blend_formulation, blend_formulation_to_quality_control)
root.order.add_edge(blend_formulation_to_quality_control, quality_control_to_aging_process)
root.order.add_edge(quality_control_to_aging_process, aging_process_to_allergen_check)
root.order.add_edge(aging_process_to_allergen_check, allergen_check_to_market_research)
root.order.add_edge(allergen_check_to_market_research, market_research_to_bottle_design)
root.order.add_edge(market_research_to_bottle_design, bottle_design_to_label_approval)
root.order.add_edge(bottle_design_to_label_approval, label_approval_to_packaging_setup)
root.order.add_edge(label_approval_to_packaging_setup, packaging_setup_to_batch_mixing)
root.order.add_edge(packaging_setup_to_batch_mixing, batch_mixing_to_scent_profiling)
root.order.add_edge(batch_mixing_to_scent_profiling, scent_profiling_to_client_feedback)
root.order.add_edge(scent_profiling_to_client_feedback, client_feedback_to_release_scheduling)
root.order.add_edge(client_feedback_to_release_scheduling, release_scheduling_to_regulatory_review)
root.order.add_edge(release_scheduling_to_regulatory_review, regulatory_review_to_sales_training)