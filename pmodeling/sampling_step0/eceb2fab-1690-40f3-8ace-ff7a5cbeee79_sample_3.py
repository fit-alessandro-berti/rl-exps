...
root = StrictPartialOrder(nodes=[
    ...
    material_test_to_disassembly,
    disassembly_to_surface_clean,
    surface_clean_to_structural_repair,
    structural_repair_to_reconstruction,
    reconstruction_to_finish_match,
    finish_match_to_stabilize_parts,
    stabilize_parts_to_documentation,
    documentation_to_quality_audit,
    quality_audit_to_valuation,
    valuation_to_market_analysis,
    market_analysis_to_target_outreach,
    target_outreach_to_delivery_prep,
    delivery_prep_to_client_feedback
])
