...
# Define the loop node for material analysis
loop = OperatorPOWL(operator=Operator.LOOP, children=[material_analysis, skip])

# Define the exclusive choice node for data review
xor = OperatorPOWL(operator=Operator.XOR, children=[data_review, skip])

# Define the root of the POWL model
root = StrictPartialOrder(nodes=[artifact_intake, provenance_check, archive_research, expert_interview, loop, xor, material_analysis, spectroscopy_test, carbon_dating, digital_imaging, three_d_modeling, data_review, consensus_meeting, conservation_plan, preservation_setup, documentation, exhibition_prep])
