root = StrictPartialOrder(nodes=[
    ...
    Transition(label='Seasonal Adjustments'),
    Transition(label='Real-Time Inventory Tracking'),
    Transition(label='Consumer Feedback Loop'),
    Transition(label='Artisan Branding Enhancement')
])
