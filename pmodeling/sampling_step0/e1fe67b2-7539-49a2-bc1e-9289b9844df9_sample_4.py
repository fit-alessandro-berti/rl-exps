...
root = StrictPartialOrder(
    nodes=[Gather_Specs, Design_Custom, Source_Parts, Firmware_Load, Mechanical_Fit, Cable_Routing, Sensor_Align, Component_Test, Software_Sync, Flight_Calibrate, Enviro_Test, Remote_Pair, Quality_Check, Package_Unit, Register_Drone, Client_Train]
)
