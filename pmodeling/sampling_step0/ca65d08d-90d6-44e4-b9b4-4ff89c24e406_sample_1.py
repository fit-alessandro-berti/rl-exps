...
root.order.add_edge(system_build, select_crops)
root.order.add_edge(select_crops, setup_lighting)
root.order.add_edge(select_crops, configure_climate)
root.order.add_edge(setup_lighting, nutrient_mix)
root.order.add_edge(setup_lighting, automate_watering)
root.order.add_edge(configure_climate, nutrient_mix)
root.order.add_edge(configure_climate, automate_watering)
