...
quality_tasting_loop = OperatorPOWL(operator=Operator.LOOP, children=[quality_tasting])
milk_sourcing_loop = OperatorPOWL(operator=Operator.LOOP, children=[milk_sourcing])

# Define the partial order
root = StrictPartialOrder(nodes=[aging_loop, quality_tasting_loop, milk_sourcing_loop])
root.order.add_edge(aging_loop, quality_tasting_loop)
root.order.add_edge(quality_tasting_loop, milk_sourcing_loop)
root.order.add_edge(milk_sourcing_loop, milk_testing)
