...
# Define the loop for the adaptation process
adaptation_loop = OperatorPOWL(operator=Operator.LOOP, children=[
    risk_assess,
    source_alternatives,
    supplier_audit,
    contract_review,
...
root = StrictPartialOrder(nodes=[adaptation_loop, market_monitor, team_sync])
root.order.add_edge(adaptation_loop, market_monitor)
root.order.add_edge(adaptation_loop, team_sync)
