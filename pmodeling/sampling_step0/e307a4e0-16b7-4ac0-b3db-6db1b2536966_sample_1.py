...
root = StrictPartialOrder(nodes=[InitialAssess, ArtifactScan, ConditionMap, MaterialTest, CleaningPhase, StabilityCheck, MinorRepair, StructuralReinforce, SurfaceRestore, CoatingApply, EthicsReview, ProvenanceVerify, ClientUpdate, FinalReport, ArchiveStore])
