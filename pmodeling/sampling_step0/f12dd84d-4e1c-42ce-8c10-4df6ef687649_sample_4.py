...
root = StrictPartialOrder(nodes=[Sourcing_Loop, Aging_Loop, Curd_Processing, Salt_Application, Mold_Inoculation, Press_Molding, Brine_Soaking, Microbial_Check, Packaging_Design, Label_Printing, Trace_Logging, Distribution_Plan, Customer_Review, Inventory_Audit, Sustainability_Audit])
root.order.add_edge(Sourcing_Loop, Aging_Loop)
root.order.add_edge(Aging_Loop, Curd_Processing)
