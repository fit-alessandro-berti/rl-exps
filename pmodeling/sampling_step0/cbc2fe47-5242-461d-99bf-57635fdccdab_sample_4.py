...
root = StrictPartialOrder(nodes=[artifact_intake, document_check, provenance_loop, radiocarbon_loop, expert_panel_choice, report_draft, quality_review, catalog_entry, insurance_setup, archive_data, reevaluation_trigger])
...
root.order.add_edge(radiocarbon_loop, expert_panel_choice)
root.order.add_edge(expert_panel_choice, report_draft)
...
root.order.add_edge(reevaluation_trigger, provenance_loop)