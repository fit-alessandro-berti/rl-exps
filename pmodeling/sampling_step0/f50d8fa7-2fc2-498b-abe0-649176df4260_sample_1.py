...
root = StrictPartialOrder(nodes=[activities['Site Survey'], activities['Design Plan'], activities['Permit Acquire'], activities['Structural Retrofit'], activities['System Install'], activities['Lighting Setup'], activities['Sensor Deploy'], activities['Seed Sourcing'], activities['Nutrient Prep'], activities['Staff Training'], activities['Data Monitor'], activities['Yield Analyze'], activities['Compliance Check'], activities['Community Meet'], activities['Market Launch'], activities['Logistics Plan']])
