...
loop = OperatorPOWL(operator=Operator.LOOP, children=[firmware_build, pcb_assembly, sensor_install, motor_mount, battery_test, ai_module, system_integrate, flight_simulate, stress_test, compliance_check, quality_audit, package_drone, delivery_plan])
xor = OperatorPOWL(operator=Operator.XOR, children=[client_brief, design_draft, component_order])
