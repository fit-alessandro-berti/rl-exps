...
feedback_loop = OperatorPOWL(operator=Operator.XOR, children=[component_fabric, circuit_assembly])
...
root.order.add_edge(feedback_loop, component_fabric)
root.order.add_edge(feedback_loop, circuit_assembly)
root.order.add_edge(component_fabric, quality_check)
root.order.add_edge(circuit_assembly, quality_check)
