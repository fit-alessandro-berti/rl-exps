...
root.nodes = [asset_intake, provenance_check, material_sampling, radiocarbon_test, style_compare, historical_search, expert_consult, condition_review, scientific_analysis, data_compilation, peer_review, report_draft, certification, digital_archive, client_delivery]
...
root.order.add_edge(radiocarbon_test, scientific_analysis)
root.order.add_edge(style_compare, scientific_analysis)
