...
# Design Layout -> Module Build
# Module Build -> System Install
# System Install -> Water Prep
# Water Prep -> Seed Selection
# Seed Selection -> Nutrient Mix
# Nutrient Mix -> Climate Setup
# Climate Setup -> Sensor Deploy
# Sensor Deploy -> Pest Scan
# Pest Scan -> Growth Monitor
# Growth Monitor -> Data Sync
# Data Sync -> Energy Manage
# Energy Manage -> Harvest Plan
# Harvest Plan -> Community Link

# Create the POWL model
root = StrictPartialOrder(nodes=[
    site_survey, design_layout, module_build, system_install, water_prep, seed_selection,
    nutrient_mix, climate_setup, sensor_deploy, pest_scan, growth_monitor, data_sync,
