...
# Define the loop
loop = OperatorPOWL(operator=Operator.LOOP, children=[trend_scan, xor])

# Define the root
root = StrictPartialOrder(nodes=[loop, idea_workshop, concept_draft, expert_review, prototype_build, regulation_check, ip_alignment, supply_sync, market_mapping, pilot_launch, feedback_loop, design_iterate, impact_measure, strategy_adapt])
