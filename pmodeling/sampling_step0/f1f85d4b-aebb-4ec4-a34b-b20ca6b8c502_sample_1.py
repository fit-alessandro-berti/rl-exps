...
loop = OperatorPOWL(operator=Operator.LOOP, children=[InitialReview, ProvenanceCheck, MaterialTesting, ExpertSurvey, DigitalScan, ConditionReport, LegalReview, RiskAnalysis, SellerNegotiation, Documentation, ArchivalEntry, CommitteeReview, FinalApproval, AcquisitionSetup, ExhibitPlanning])
