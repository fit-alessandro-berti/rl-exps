...
root.nodes = [Site_Survey, Structure_Assess, System_Design, Crop_Select, Permit_Obtain, Enviro_Setup, Irrigation_Plan, Sensor_Install, AI_Calibration, Staff_Train, Nutrient_Mix, Pest_Monitor, Yield_Analyze, Market_Align, Launch_Farm]
