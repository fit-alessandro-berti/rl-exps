...
root.order.add_edge(Transition('Artist Check'), Transition('Document Review'))
root.order.add_edge(Transition('Provenance Scan'), Transition('Material Test'))
root.order.add_edge(Transition('Provenance Scan'), Transition('Pigment Analysis'))
