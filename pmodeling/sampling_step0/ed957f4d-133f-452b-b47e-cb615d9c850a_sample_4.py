...
root = StrictPartialOrder(
    nodes=[source_materials, vet_suppliers, design_modules, prototype_build, test_durability, secure_permits,
           map_habitats, micro_warehouse, inventory_sync, pack_sustainably, route_optimize, engage_community,
           collect_feedback, adjust_production, partner_ngo, launch_campaign, monitor_sensors, report_impact],
    order={})
...
# Ensure all activities are connected
root.order.add_edge(source_materials, micro_warehouse)
root.order.add_edge(vet_suppliers, micro_warehouse)
root.order.add_edge(design_modules, micro_warehouse)
root.order.add_edge(prototype_build, micro_warehouse)
root.order.add_edge(test_durability, micro_warehouse)
root.order.add_edge(secure_permits, micro_warehouse)
root.order.add_edge(map_habitats, micro_warehouse)
root.order.add_edge(inventory_sync, micro_warehouse)
root.order.add_edge(pack_sustainably, micro_warehouse)
root.order.add_edge(route_optimize, micro_warehouse)
root.order.add_edge(engage_community, micro_warehouse)
root.order.add_edge(collect_feedback, micro_warehouse)
root.order.add_edge(adjust_production, micro_warehouse)
root.order.add_edge(partner_ngo, micro_warehouse)
root.order.add_edge(launch_campaign, micro_warehouse)
root.order.add_edge(monitor_sensors, micro_warehouse)
root.order.add_edge(report_impact, micro_warehouse)

# Ensure all activities are connected to each other
root.order.add_edge(vet_suppliers, design_modules)
root.order.add_edge(design_modules, prototype_build)
root.order.add_edge(prototype_build, test_durability)
root.order.add_edge(test_durability, secure_permits)
...
# Ensure all activities are connected to the final activity
root.order.add_edge(report_impact, report_impact)
