...
# Define the loop
loop = OperatorPOWL(operator=Operator.LOOP, children=[monitor_growth, data_analyze, pest_control])

# Define the root POWL model
root = StrictPartialOrder(nodes=[site_survey, permit_approval, design_layout, system_procure, nutrient_prep, structure_build, sensor_install, climate_setup, seed_select, germinate_seeds, loop, xor])
...
root.order.add_edge(xor, harvest_crop)
