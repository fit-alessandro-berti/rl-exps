...
loop_1 = OperatorPOWL(operator=Operator.LOOP, children=[scenario_setup, resource_mapping, team_briefing, tech_deployment, data_sync, comm_setup, live_monitoring, variable_adjust, incident_injection, response_tracking, interlock_check, real_time_feedback, debrief_session])
loop_2 = OperatorPOWL(operator=Operator.LOOP, children=[outcome_analysis, report_generation, improvement_plan])

# Define XOR transitions
xor_1 = OperatorPOWL(operator=Operator.XOR, children=[loop_1, loop_2])

# Define the root of the POWL model
root = StrictPartialOrder(nodes=[xor_1])
