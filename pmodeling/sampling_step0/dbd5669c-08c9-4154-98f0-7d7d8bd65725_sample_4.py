...
xor = OperatorPOWL(operator=Operator.XOR, children=[site_survey, design_layout])
root = StrictPartialOrder(nodes=[material_sourcing, unit_assembly, system_wiring, sensor_install, water_testing, nutrient_mix, seed_selection, planting_setup, climate_control, pest_management, data_calibration, yield_analysis, community_meet, compliance_check, expansion_plan])
