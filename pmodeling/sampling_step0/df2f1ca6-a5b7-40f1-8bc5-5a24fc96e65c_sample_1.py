...
custom_package = Transition(label='Custom Packaging')
...
exclusive_choice1 = OperatorPOWL(operator=Operator.XOR, children=[sourcing, vetting])
exclusive_choice2 = OperatorPOWL(operator=Operator.XOR, children=[sample_review, design_finalize])
exclusive_choice3 = OperatorPOWL(operator=Operator.XOR, children=[batch_schedule, quality_check])
exclusive_choice4 = OperatorPOWL(operator=Operator.XOR, children=[custom_package, demand_forecast])
...
root.order.add_edge(exclusive_choice8, exclusive_choice1)