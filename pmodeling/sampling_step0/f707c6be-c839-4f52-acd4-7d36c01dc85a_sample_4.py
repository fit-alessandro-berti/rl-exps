...
xor = OperatorPOWL(operator=Operator.XOR, children=[multi_spectral_scan, material_test])
...
xor7 = OperatorPOWL(operator=Operator.XOR, children=[archival_update, skip])
