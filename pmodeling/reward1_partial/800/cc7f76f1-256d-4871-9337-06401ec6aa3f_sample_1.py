...
root.order.add_edge(flag_suspicion, employee_train)
root.order.add_edge(flag_suspicion, threat_simulate)
root.order.add_edge(legal_review, incident_plan)
root.order.add_edge(compliance_check, incident_plan)
