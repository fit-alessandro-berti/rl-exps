...
site_survey_to_design_layout = OperatorPOWL(operator=Operator.XOR, children=[permits_check, site_survey])
design_layout_to_foundation_prep = OperatorPOWL(operator=Operator.XOR, children=[foundation_prep, design_layout])
foundation_prep_to_frame_assembly = OperatorPOWL(operator=Operator.XOR, children=[frame_assembly, foundation_prep])
frame_assembly_to_hydro_setup = OperatorPOWL(operator=Operator.XOR, children=[hydro_setup, frame_assembly])
hydro_setup_to_climate_setup = OperatorPOWL(operator=Operator.XOR, children=[climate_setup, hydro_setup])
climate_setup_to_seed_selection = OperatorPOWL(operator=Operator.XOR, children=[seed_selection, climate_setup])
seed_selection_to_nutrient_mix = OperatorPOWL(operator=Operator.XOR, children=[nutrient_mix, seed_selection])
nutrient_mix_to_system_calibration = OperatorPOWL(operator=Operator.XOR, children=[system_calibration, nutrient_mix])
system_calibration_to_pest_control = OperatorPOWL(operator=Operator.XOR, children=[pest_control, system_calibration])
pest_control_to_automation_link = OperatorPOWL(operator=Operator.XOR, children=[automation_link, pest_control])
automation_link_to_staff_training = OperatorPOWL(operator=Operator.XOR, children=[staff_training, automation_link])
staff_training_to_yield_tracking = OperatorPOWL(operator=Operator.XOR, children=[yield_tracking, staff_training])
yield_tracking_to_distribution_plan = OperatorPOWL(operator=Operator.XOR, children=[distribution_plan, yield_tracking])
...
root.order.add_edge(site_survey_to_design_layout, design_layout_to_foundation_prep)
