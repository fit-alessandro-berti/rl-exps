...
formula_adjustment = Transition(label='Formula Adjust')
...
root.order.add_edge(sensory_panel, formula_adjustment)
root.order.add_edge(formula_adjustment, safety_review)
