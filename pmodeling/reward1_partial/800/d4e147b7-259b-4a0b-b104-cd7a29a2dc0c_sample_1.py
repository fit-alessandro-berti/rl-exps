...
root = StrictPartialOrder(nodes=[
    artifact_intake, visual_scan, material_test, radiocarbon_check,
    provenance_search, archive_review, expert_consult, microscope_exam,
    infrared_scan, legal_verify, condition_report, digital_catalog,
    ownership_audit, restoration_plan, final_approval, authentication_cert
])
...
root.order.add_edge(visual_scan, provenance_search)
root.order.add_edge(visual_scan, archive_review)
root.order.add_edge(visual_scan, expert_consult)
root.order.add_edge(material_test, provenance_search)
root.order.add_edge(material_test, archive_review)
root.order.add_edge(material_test, expert_consult)
root.order.add_edge(radiocarbon_check, provenance_search)
root.order.add_edge(radiocarbon_check, archive_review)
root.order.add_edge(radiocarbon_check, expert_consult)
root.order.add_edge(provenance_search, microscope_exam)
root.order.add_edge(provenance_search, infrared_scan)
root.order.add_edge(provenance_search, legal_verify)
root.order.add_edge(archive_review, microscope_exam)
root.order.add_edge(archive_review, infrared_scan)
root.order.add_edge(archive_review, legal_verify)
root.order.add_edge(expert_consult, microscope_exam)
root.order.add_edge(expert_consult, infrared_scan)
