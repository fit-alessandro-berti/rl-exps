...
# Define the loop for cleaning and stabilization
clean_stabilize_loop = OperatorPOWL(operator=Operator.LOOP, children=[clean_surface, stabilize_structure])
...
root.order.add_edge(plan_conservation, clean_stabilize_loop)
root.order.add_edge(clean_stabilize_loop, source_materials)
