...
root.order.add_edge(preliminary_inspect, archival_research)
root.order.add_edge(preliminary_inspect, material_testing)
root.order.add_edge(provenance_check, archival_research)
root.order.add_edge(provenance_check, material_testing)
root.order.add_edge(archival_research, stylistic_assess)
root.order.add_edge(material_testing, stylistic_assess)
