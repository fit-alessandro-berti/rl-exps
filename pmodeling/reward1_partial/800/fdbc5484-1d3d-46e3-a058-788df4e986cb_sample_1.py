...
root = StrictPartialOrder(nodes=[
    AssetID, ValueAssess, RiskScan, MarketReview, InitialOffer, CounterOffer, Negotiation,
    ContractDraft, LegalReview, DigitalSign, RoyaltySetup, TransferRecord, ComplianceCheck,
    AuditSchedule, MarketFeedback, StrategyUpdate
])
