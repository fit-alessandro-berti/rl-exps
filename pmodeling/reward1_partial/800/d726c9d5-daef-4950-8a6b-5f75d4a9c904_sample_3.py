...
root.order.add_edge(structure_check, crop_selection)
root.order.add_edge(structure_check, material_order)
root.order.add_edge(soil_sample, material_order)
root.order.add_edge(water_test, material_order)
root.order.add_edge(crop_selection, planter_setup)
root.order.add_edge(crop_selection, irrigation_install)
root.order.add_edge(material_order, planter_setup)
root.order.add_edge(material_order, irrigation_install)
root.order.add_edge(planter_setup, sensor_deploy)
root.order.add_edge(planter_setup, solar_setup)
root.order.add_edge(irrigation_install, sensor_deploy)
root.order.add_edge(irrigation_install, solar_setup)
...
root.order.add_edge(data_integration, training_session)
root.order.add_edge(community_meet, yield_monitor)
