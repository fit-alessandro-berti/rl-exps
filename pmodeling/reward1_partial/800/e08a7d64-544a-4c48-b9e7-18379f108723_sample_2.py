...
certification_loop = OperatorPOWL(operator=Operator.LOOP, children=[certification, final_audit])
certification_loop.add_edge(certification, final_audit)

# Define root POWL model
root = StrictPartialOrder(nodes=[
    provenance_check_step,
    material_testing_step,
    expert_review_step,
    legal_verify_step,
    risk_assess_step,
    material_or_insurance,
    catalog_or_digital,
    condition_or_transport,
    customs_or_exhibit,
    certification_loop
])
