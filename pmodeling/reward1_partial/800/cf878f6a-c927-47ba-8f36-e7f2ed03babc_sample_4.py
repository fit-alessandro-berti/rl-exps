...
root = StrictPartialOrder(nodes=[
    SiteAssess, ZoningCheck, DesignFarm, ProcureGear, InstallSystems,
    SetupSensors, SelectCrops, PrepareSeeds, MixNutrients, MonitorGrowth,
    AdjustClimate, RoboticHarvest, GradeQuality, PackProduce, ManageLogistics,
