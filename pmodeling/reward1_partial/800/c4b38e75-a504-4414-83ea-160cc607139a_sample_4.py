...
# Define silent transitions (for concurrency or empty steps)
skip = SilentTransition()

# Define the POWL model
root = StrictPartialOrder(nodes=[
    site_survey, design_modules, install_sensors, calibrate_climate,
    select_seeds, optimize_nutrients, deploy_robots, monitor_growth,
    detect_pests, analyze_data, harvest_crops, customize_pack,
    recycle_waste, audit_energy, align_demand
])

# Define dependencies (POWL graph structure)
