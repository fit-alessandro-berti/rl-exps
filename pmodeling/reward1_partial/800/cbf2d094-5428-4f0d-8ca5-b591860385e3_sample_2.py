...
root = StrictPartialOrder(nodes=[seed_select, nutrient_mix, climate_adjust, planting_robotic, growth_monitor, pest_control_loop, demand_forecast, delivery_plan, data_feedback])
...
root.order.add_edge(pest_control, pest_control_loop)
root.order.add_edge(pest_control_loop, demand_forecast)
root.order.add_edge(demand_forecast, delivery_plan)
root.order.add_edge(delivery_plan, package_fresh)
