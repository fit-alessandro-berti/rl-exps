...
root = StrictPartialOrder(nodes=[
    concept_approve, budget_align, design_review, structure_simulate, material_procure,
    vendor_select, permit_apply, safety_check, site_prep, logistics_plan, fabricate_parts,
    assemble_onsite, quality_inspect, weather_monitor, public_unveil, maintenance_plan, stakeholder_meet
])
