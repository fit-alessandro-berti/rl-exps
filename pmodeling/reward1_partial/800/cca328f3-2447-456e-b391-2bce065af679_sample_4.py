...
skip_legal_audit = SilentTransition()
skip_cultural_assess = SilentTransition()
...
root.order.add_edge(material_scan, skip_material_scan)
root.order.add_edge(style_compare, skip_style_compare)
root.order.add_edge(database_search, skip_database_search)
root.order.add_edge(legal_audit, skip_legal_audit)
root.order.add_edge(cultural_assess, skip_cultural_assess)
