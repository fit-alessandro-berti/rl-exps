...
# Define silent transition for skipping
...
root.nodes.add(insurance_quote)
root.nodes.add(price_negotiation)
root.nodes.add(contract_draft)
root.nodes.add(final_approval)
root.nodes.add(asset_registration)
