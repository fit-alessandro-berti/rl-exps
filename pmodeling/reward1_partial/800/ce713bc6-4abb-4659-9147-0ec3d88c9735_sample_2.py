...
root.order.add_edge(document_review, forensic_testing)
root.order.add_edge(historical_research, material_sampling)
root.order.add_edge(historical_research, forensic_testing)
root.order.add_edge(material_sampling, ownership_audit)
root.order.add_edge(material_sampling, legal_verification)
...
root.order.add_edge(legal_verification, expert_consultation)
root.order.add_edge(ethical_screening, cultural_assessment)
root.order.add_edge(ethical_screening, condition_survey)
...
root.order.add_edge(report_compilation, repatriation_review)
