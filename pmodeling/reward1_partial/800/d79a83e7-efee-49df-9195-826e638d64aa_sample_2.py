...
root = StrictPartialOrder(
    nodes=[site_survey, env_assessment, reg_compliance, modular_setup, crop_selection, iot_integration,
           nutrient_flow, light_calibration, staff_training, pest_control, market_strategy, logistics_plan,
           yield_analysis, data_review, community_engage],
    order={
        site_survey: [env_assessment],
        env_assessment: [reg_compliance],
        reg_compliance: [modular_setup],
        modular_setup: [crop_selection],
        crop_selection: [iot_integration],
        iot_integration: [nutrient_flow, light_calibration],
        nutrient_flow: [staff_training],
        light_calibration: [pest_control],
        staff_training: [market_strategy],
        pest_control: [logistics_plan],
        market_strategy: [yield_analysis],
        logistics_plan: [data_review],
        yield_analysis: [community_engage]
    }
)
