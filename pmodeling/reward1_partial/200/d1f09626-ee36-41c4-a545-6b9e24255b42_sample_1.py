...
root.order.add_edge(load_test, energy_setup)
root.order.add_edge(load_test, pest_control)
...
root.order.add_edge(climate_check, energy_setup)
root.order.add_edge(climate_check, pest_control)
...
root.order.add_edge(energy_setup, stakeholder_meet)
...
root.order.add_edge(stakeholder_meet, growth_monitor)
root.order.add_edge(stakeholder_meet, harvest_plan)
root.order.add_edge(stakeholder_meet, waste_recycle)
root.order.add_edge(stakeholder_meet, yield_report)
