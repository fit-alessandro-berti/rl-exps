...
root.order.add_edge(risk_assessment, contract_drafting)
root.order.add_edge(risk_assessment, approval_process)
root.order.add_edge(license_targeting, negotiation_phase)
root.order.add_edge(license_targeting, contract_drafting)
root.order.add_edge(license_targeting, approval_process)
root.order.add_edge(buyer_outreach, negotiation_phase)
root.order.add_edge(buyer_outreach, contract_drafting)
root.order.add_edge(buyer_outreach, approval_process)
...
root.order.add_edge(approval_process, compliance_check)
root.order.add_edge(approval_process, renewal_management)
root.order.add_edge(portfolio_tracking, revenue_monitoring)
root.order.add_edge(portfolio_tracking, compliance_check)
