...
root.order.add_edge(provenance_check, documentation_verify)
...
root.order.add_edge(chemical_test, forgery_detect)
root.order.add_edge(historical_match, cross_border_check)
