...
loop = OperatorPOWL(operator=Operator.LOOP, children=[germination_start, seedling_transplant])
xor = OperatorPOWL(operator=Operator.XOR, children=[nutrient_mix, water_delivery, light_adjustment, climate_control, sensor_monitoring, health_check, pest_control, harvest_planning, crop_harvest, waste_sorting, biomass_process, energy_recycling, data_analysis, yield_forecast])
