...
root = StrictPartialOrder(nodes=[
    SiteSurvey, ClimateStudy, DesignLayout, SystemInstall, CropSelect, NutrientPlan,
    SensorSetup, AutomationTest, StaffTrain, ComplianceCheck, MarketingSync,
    DataMonitor, YieldAnalyze, SupplyChain, CustomerEngage
])
