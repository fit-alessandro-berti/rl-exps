...
# Define XOR for quality audit and retail sync
xor = OperatorPOWL(operator=Operator.XOR, children=[quality_audit, retail_sync])

# Define root POWL model
root = StrictPartialOrder(nodes=[milk_sourcing, culture_selection, milk_testing, curd_formation, whey_separation, molding_cheese, salting_process, aging_loop, packaging_design, blockchain_entry, xor, transport_prep, delivery_tracking, customer_feedback])
