...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[milk_test, milk_pasteurize, curd_form, whey_drain, cheese_press, salt_rub, aging_set, flavor_check, texture_scan, quality_approve, custom_pack, cold_ship])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[retail_train, feedback_log, batch_adjust])
xor = OperatorPOWL(operator=Operator.XOR, children=[farm_select, loop1, loop2])
