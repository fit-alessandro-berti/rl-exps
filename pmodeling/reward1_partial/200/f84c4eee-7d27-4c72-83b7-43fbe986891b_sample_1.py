...
root = StrictPartialOrder(nodes=[
    sourcing, assembly, sensor_mounting, wiring_harness, circuit_testing, 
    firmware_loading, initial_calibration, software_integration, flight_testing, 
    data_logging, performance_tuning, packaging_prep, custom_labeling, documentation_print, 
    quality_review, client_training, remote_monitoring, firmware_update
])

# Define the process structure with dependencies
root.order.add_edge(sourcing, assembly)
root.order.add_edge(assembly, sensor_mounting)
