...
root = StrictPartialOrder(nodes=[Receive_Artifact, Condition_Log, Radiocarbon_Test, Spectroscopy_Scan, Expert_Consult, Provenance_Check, Archive_Search, Risk_Assess, ThreeD_Scan, Legal_Review, Insurance_Setup, Certificate_Draft, Certificate_Approve, Climate_Pack, Conservation_Plan, Monitoring_Schedule])
