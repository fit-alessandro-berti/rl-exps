...
# Define silent transitions (skip)
skip = SilentTransition()

# Define the process structure
loop = OperatorPOWL(operator=Operator.LOOP, children=[
    material_sampling, radiocarbon_test, provenance_review, imaging_capture, chemical_analysis, historical_match, expert_consult, forgery_scan, market_survey
])

xor = OperatorPOWL(operator=Operator.XOR, children=[
    value_estimate, certification, skip
])
