...
root.order.add_edge(hydroponic_setup, software_install)
root.order.add_edge(hydroponic_setup, system_testing)
root.order.add_edge(climate_control, growth_monitor)
root.order.add_edge(nutrient_design, growth_monitor)
root.order.add_edge(staff_hiring, growth_monitor)
root.order.add_edge(staff_training, growth_monitor)
root.order.add_edge(software_install, growth_monitor)
