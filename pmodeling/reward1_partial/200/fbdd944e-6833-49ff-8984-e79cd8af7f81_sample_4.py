...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[fleet_deploy, xor2])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[monitor_setup, xor3])
loop3 = OperatorPOWL(operator=Operator.LOOP, children=[usage_track, xor4])

root = StrictPartialOrder(nodes=[client_onboard, needs_assess, drone_config, route_program, xor1, loop1, xor2, xor3, xor4, xor5])
