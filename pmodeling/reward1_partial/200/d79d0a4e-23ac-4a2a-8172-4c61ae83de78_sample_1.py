...
root.order.add_edge(spec_review, component_pick_to_frame_build)
root.order.add_edge(component_pick, frame_build_to_motor_mount)
root.order.add_edge(frame_build, motor_mount_to_sensor_fit)
root.order.add_edge(motor_mount, sensor_fit_to_wiring_setup)
root.order.add_edge(sensor_fit, wiring_setup_to_software_load)
root.order.add_edge(wiring_setup, software_load_to_calibration_test)
root.order.add_edge(software_load, calibration_test_to_stress_check)
root.order.add_edge(calibration_test, stress_check_to_firmware_flash)
root.order.add_edge(stress_check, firmware_flash_to_feedback_loop)
root.order.add_edge(firmware_flash, feedback_loop_to_package_prep)
root.order.add_edge(feedback_loop, package_prep_to_doc_compile)
root.order.add_edge(package_prep, doc_compile_to_ship_arrange)
root.order.add_edge(doc_compile, ship_arrange_to_remote_setup)
