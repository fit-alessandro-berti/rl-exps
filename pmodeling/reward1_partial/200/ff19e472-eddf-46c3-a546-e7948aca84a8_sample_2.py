...
root = StrictPartialOrder(
    ...
    order=[
        ...
        (design_layout, install_modules),
        (install_modules, calibrate_climate),
        (calibrate_climate, prepare_nutrients),
        (prepare_nutrients, select_seeds),
        (select_seeds, start_germination),
        (start_germination, deploy_sensors),
        (deploy_sensors, monitor_growth),
        (monitor_growth, manage_pests),
        (manage_pests, schedule_harvest),
        (schedule_harvest, process_waste),
        (process_waste, optimize_energy),
        (optimize_energy, conduct_training),
        (conduct_training, update_records),
        (update_records, review_performance)
    ]
)
