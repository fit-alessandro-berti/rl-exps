...
# Define silent transitions (tau transitions)
...
root = StrictPartialOrder(
    ...
    order={
        ...
        sample_collection: [spectroscopy_test, carbon_dating],
        spectroscopy_test: [expert_review],
        carbon_dating: [expert_review],
        expert_review: [legal_clearance, cultural_assessment],
        legal_clearance: [cultural_assessment],
        cultural_assessment: [digital_scan, report_draft],
        digital_scan: [report_draft],
        report_draft: [stakeholder_meet, acquisition_vote],
        stakeholder_meet: [acquisition_vote],
        acquisition_vote: [restoration_plan, condition_report],
