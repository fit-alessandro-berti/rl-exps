...
# Define the process
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[provenance_check, archive_search, expert_interview, material_scan, age_analysis, stylistic_review, context_mapping, legal_clearance, data_compilation, report_drafting, peer_review, final_assessment, acquisition_plan, restoration_prep, documentation, data_backup])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[skip1, skip2, skip3])
root = StrictPartialOrder(nodes=[artifact_intake, loop1, loop2])
