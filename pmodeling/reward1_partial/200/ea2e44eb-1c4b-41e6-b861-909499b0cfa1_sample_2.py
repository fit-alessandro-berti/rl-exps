...
root.order.add_edge(artifact_intake, certify_report)
root.order.add_edge(artifact_intake, condition_assess)
root.order.add_edge(artifact_intake, storage_plan)
root.order.add_edge(artifact_intake, catalog_entry)
root.order.add_edge(artifact_intake, display_prep)
root.order.add_edge(artifact_intake, loan_arrange)
root.order.add_edge(artifact_intake, monitor_setup)