...
root = StrictPartialOrder(
    ...
    order=[
        (client_consult, spec_analysis),
        (spec_analysis, module_select),
        (module_select, component_order),
        (component_order, parts_inspect),
        (parts_inspect, frame_assemble),
        (frame_assemble, sensor_install),
        (sensor_install, motor_attach),
        (motor_attach, wiring_connect),
        (wiring_connect, software_upload),
        (software_upload, calibration_test),
        (calibration_test, flight_simulate),
        (flight_simulate, quality_review),
        (quality_review, user_train),
        (user_train, remote_setup),
        (remote_setup, feedback_collect),
        (feedback_collect, support_schedule)
    ]
)
