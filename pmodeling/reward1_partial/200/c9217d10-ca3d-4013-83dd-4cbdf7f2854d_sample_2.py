...
root = StrictPartialOrder(nodes=[
    site_survey, climate_study, design_layout, system_install, crop_select, nutrient_plan, sensor_setup, automation_test,
    staff_train, compliance_check, marketing_sync, data_monitor, yield_analyze, supply_chain, customer_engage])
...
root.order.add_edge(system_install, nutrient_plan)
root.order.add_edge(system_install, sensor_setup)
root.order.add_edge(system_install, automation_test)
root.order.add_edge(crop_select, staff_train)
root.order.add_edge(nutrient_plan, staff_train)
...
root.order.add_edge(staff_train, marketing_sync)
root.order.add_edge(staff_train, data_monitor)
