...
xor = OperatorPOWL(operator=Operator.XOR, children=[coating_apply, skip])

root = StrictPartialOrder(nodes=[initial_assess, artifact_scan, condition_map, material_test, cleaning_phase, stability_check, minor_repair, structural_reinforce, surface_restore, xor, ethics_review, provenance_verify, client_update, final_report, archive_store])
