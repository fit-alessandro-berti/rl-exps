...
root = StrictPartialOrder(nodes=[site_survey_to_structure_reinforce, structure_reinforce_to_hydroponic_setup, hydroponic_setup_to_climate_install, climate_install_to_ai_integration, ai_integration_to_seed_sourcing, seed_sourcing_to_nutrient_prep, nutrient_prep_to_system_testing, system_testing_to_staff_training, staff_training_to_crop_planting, crop_planting_to_growth_monitor, growth_monitor_to_pest_control, pest_control_to_harvest_schedule, harvest_schedule_to_quality_check, quality_check_to_market_dispatch, market_dispatch_to_waste_recycle, waste_recycle_to_data_analysis])
