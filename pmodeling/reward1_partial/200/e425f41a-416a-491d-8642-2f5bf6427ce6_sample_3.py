...
root.order.add_edge(ingredient_sourcing, initial_blending)
root.order.add_edge(botanical_extraction, initial_blending)
root.order.add_edge(initial_blending, sensory_testing)
root.order.add_edge(initial_blending, chemical_analysis)
root.order.add_edge(sensory_testing, recipe_refinement)
