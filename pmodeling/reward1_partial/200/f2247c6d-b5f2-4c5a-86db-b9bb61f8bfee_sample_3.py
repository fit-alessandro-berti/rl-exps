...
update_coordinate = OperatorPOWL(operator=Operator.XOR, children=[update_inventory, coordinate_resale])
coordinate_refunds = OperatorPOWL(operator=Operator.XOR, children=[coordinate_resale, process_refunds])
...
root.order.add_edge(dispose_update, update_coordinate)
root.order.add_edge(update_coordinate, coordinate_refunds)
root.order.add_edge(coordinate_refunds, refunds_analyze)
