...
root = StrictPartialOrder(nodes=[
    ...
    climate_setup, lighting_configure, irrigation_setup, nutrient_mix, pest_check,
    sensor_calibrate, data_integration, crop_planting, growth_monitor, yield_analyze,
    waste_manage, energy_audit
])

# Define the dependencies between the activities (nodes)
