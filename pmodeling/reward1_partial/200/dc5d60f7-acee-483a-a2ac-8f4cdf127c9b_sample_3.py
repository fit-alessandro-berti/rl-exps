...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[intake_review, condition_scan, material_test, style_match, provenance_log, forger_risk, legal_audit, expert_panel, data_crosscheck, report_draft, blockchain_tag])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[certification, client_feedback, final_approval, release_prep])
