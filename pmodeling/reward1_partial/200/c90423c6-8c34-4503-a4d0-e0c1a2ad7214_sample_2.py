...
root = StrictPartialOrder(
    ...
    order={
        farm_selection: [sample_testing],
        sample_testing: [trade_negotiation],
        trade_negotiation: [micro_lot_sorting],
        micro_lot_sorting: [fermentation_control],
        fermentation_control: [sensory_profiling],
        sensory_profiling: [roast_calibration],
        roast_calibration: [blend_creation],
        blend_creation: [sustainability_audit],
        sustainability_audit: [packaging_design],
        packaging_design: [quality_inspection],
        quality_inspection: [inventory_sync],
        inventory_sync: [logistics_planning],
        logistics_planning: [cafe_training],
        cafe_training: [dynamic_pricing],
        dynamic_pricing: [customer_feedback],
