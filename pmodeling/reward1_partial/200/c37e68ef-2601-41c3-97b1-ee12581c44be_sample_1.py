...
root = StrictPartialOrder(nodes=[
    MilkSourcing, QualityTesting, StarterPrep, CurdCutting, WheyDraining, MoldingPress,
    FermentationControl, AgingSetup, HumidityCheck, PackagingDesign, LabelApproval,
    InventoryAudit, OrderScheduling, MarketDelivery, FeedbackReview, ComplianceCheck,
    MarketingSync])
