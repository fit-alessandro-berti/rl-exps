...
# Define the relationships between the transitions
root.nodes = [milk_sourcing, curd_preparation, starter_culture, temperature_control, pressing_cheese,
...
root.order.add_edge(milk_sourcing, skip)
root.order.add_edge(curd_preparation, skip)
root.order.add_edge(starter_culture, skip)
root.order.add_edge(temperature_control, skip)
root.order.add_edge(pressing_cheese, skip)
root.order.add_edge(salting_stage, skip)
root.order.add_edge(aging_process, skip)
root.order.add_edge(microbial_test, skip)
root.order.add_edge(quality_check, skip)
root.order.add_edge(eco_packaging, skip)
root.order.add_edge(label_printing, skip)
root.order.add_edge(inventory_audit, skip)
root.order.add_edge(order_processing, skip)
root.order.add_edge(retail_shipping, skip)
root.order.add_edge(customer_feedback, skip)
root.order.add_edge(recipe_update, skip)
root.order.add_edge(market_analysis, skip)

# Ensure all nodes are connected
root.order.add_edge(market_analysis, milk_sourcing)
