...
root = StrictPartialOrder(nodes=[
    milk_collection, culture_prep, curd_formation, whey_separation, molding_cheese,
    salting_process, initial_aging, humidity_control, temperature_check, flavor_testing,
    final_aging, packaging_artisanal, label_printing, inventory_audit, order_fulfillment,
...
# The 'root' variable now contains the POWL model for the described supply chain process.