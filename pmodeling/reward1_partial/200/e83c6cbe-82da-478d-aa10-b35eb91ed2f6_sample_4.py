...
root = StrictPartialOrder(
    ...
    order=[
        (provenance, material_testing),
        (material_testing, stylistic_review),
        (stylistic_review, expert_panel),
        (expert_panel, legal_clearance),
        (legal_clearance, ethics_audit),
        (ethics_audit, insurance_quote),
        (insurance_quote, risk_assess),
        (risk_assess, digital_archive),
        (digital_archive, replica_build),
        (replica_build, transport_prep),
        (transport_prep, final_review),
        (final_review, catalog_entry),
        (catalog_entry, public_notice),
        (public_notice, condition_report)
    ]
)

# Add edges for dependencies
root.order.add_edge(provenance, material_testing)
