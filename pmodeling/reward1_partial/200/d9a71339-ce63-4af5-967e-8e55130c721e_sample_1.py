...
# Workflow stages
site_survey_to_structural_check = OperatorPOWL(operator=Operator.LOOP, children=[site_survey, structural_check])
structural_check_to_modular_install = OperatorPOWL(operator=Operator.XOR, children=[modular_install, skip])
modular_install_to_hydroponic_setup = OperatorPOWL(operator=Operator.LOOP, children=[modular_install, hydroponic_setup])
hydroponic_setup_to_nutrient_mix = OperatorPOWL(operator=Operator.LOOP, children=[hydroponic_setup, nutrient_mix])
nutrient_mix_to_sensor_setup = OperatorPOWL(operator=Operator.LOOP, children=[nutrient_mix, sensor_setup])
sensor_setup_to_ai_training = OperatorPOWL(operator=Operator.LOOP, children=[sensor_setup, ai_training])
ai_training_to_data_capture = OperatorPOWL(operator=Operator.LOOP, children=[ai_training, data_capture])
data_capture_to_maintenance_plan = OperatorPOWL(operator=Operator.LOOP, children=[data_capture, maintenance_plan])
maintenance_plan_to_pest_scan = OperatorPOWL(operator=Operator.LOOP, children=[maintenance_plan, pest_scan])
pest_scan_to_growth_monitor = OperatorPOWL(operator=Operator.LOOP, children=[pest_scan, growth_monitor])
growth_monitor_to_harvest_sync = OperatorPOWL(operator=Operator.LOOP, children=[growth_monitor, harvest_sync])
harvest_sync_to_quality_test = OperatorPOWL(operator=Operator.LOOP, children=[harvest_sync, quality_test])
quality_test_to_package_prep = OperatorPOWL(operator=Operator.LOOP, children=[quality_test, package_prep])
package_prep_to_logistics_plan = OperatorPOWL(operator=Operator.LOOP, children=[package_prep, logistics_plan])
