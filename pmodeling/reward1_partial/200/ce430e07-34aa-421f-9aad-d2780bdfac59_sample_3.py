...
risk_assess_loop = OperatorPOWL(operator=Operator.LOOP, children=[risk_assess, source_alternatives, supplier_audit, contract_review, regulation_check, inventory_scan, logistics_reroute, customs_notify, stakeholder_alert, data_analyze, cost_forecast, compliance_verify, scenario_plan, decision_gate, feedback_loop, report_generate, market_monitor, team_sync])

root = StrictPartialOrder(nodes=[risk_assess_loop])
root.order.add_edge(risk_assess_loop, risk_assess_loop)