...
root.order.add_edge(idea_solicitation, expert_review)
root.order.add_edge(idea_solicitation, prototype_build)
root.order.add_edge(ai_filtering, community_voting)
root.order.add_edge(ai_filtering, expert_review)
root.order.add_edge(community_voting, iterate_feedback)
root.order.add_edge(expert_review, iterate_feedback)
root.order.add_edge(prototype_build, iterate_feedback)
root.order.add_edge(prototype_build, user_testing)
root.order.add_edge(user_testing, risk_assess)
root.order.add_edge(user_testing, compliance_check)
...
root.order.add_edge(pilot_launch, impact_analyze)
root.order.add_edge(performance_track, insight_gather)
