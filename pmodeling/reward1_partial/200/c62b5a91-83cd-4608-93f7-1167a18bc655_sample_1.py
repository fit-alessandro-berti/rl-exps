...
loop = OperatorPOWL(operator=Operator.LOOP, children=[
    provenance_research, scientific_testing, radiocarbon_dating, spectroscopy_scan,
    legal_clearance, heritage_compliance, digital_archiving, expert_review, committee_vote,
    acquisition_approval
])
root = StrictPartialOrder(nodes=[
    artifact_intake, condition_check, loop, conservation_plan, storage_setup, stakeholder_update
])
