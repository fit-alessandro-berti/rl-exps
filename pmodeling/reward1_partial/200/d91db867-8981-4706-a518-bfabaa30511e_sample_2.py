...
# Context Review
# Expert Consult
provenance_to_material_scan = OperatorPOWL(operator=Operator.XOR, children=[provenance, material_scan])
...
# Connect all nodes in a partial order
root = StrictPartialOrder(nodes=[
    provenance_to_material_scan,
    material_scan_to_context_review,
    context_review_to_expert_consult,
    expert_consult_to_image_capture,
    image_capture_to_condition_test,
    condition_test_to_forger_risk,
    forger_risk_to_registry_crosscheck,
    registry_crosscheck_to_legal_verify,
    legal_verify_to_ethics_review,
    ethics_review_to_report_draft,
    report_draft_to_certificate_issue,
    certificate_issue_to_digital_archive,
    digital_archive_to_transfer_setup,
    transfer_setup_to_final_approval
])
root.order.add_edge(provenance_to_material_scan, material_scan_to_context_review)
