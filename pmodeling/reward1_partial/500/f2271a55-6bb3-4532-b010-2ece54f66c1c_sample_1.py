...
root = StrictPartialOrder(nodes=[provenance_check, spectroscopy_test, carbon_dating, style_analysis, image_scanning, restoration_scan, appraiser_review, database_match, blockchain_entry, certificate_issue, forgeries_detect, report_compilation, client_briefing, secure_storage, final_approval])
...
root.order.add_edge(spectroscopy_test, appraiser_review)
root.order.add_edge(carbon_dating, appraiser_review)
root.order.add_edge(style_analysis, appraiser_review)
root.order.add_edge(image_scanning, appraiser_review)
