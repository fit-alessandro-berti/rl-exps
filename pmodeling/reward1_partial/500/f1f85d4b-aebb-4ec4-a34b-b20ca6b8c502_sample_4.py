...
expert_survey_and_condition_report = OperatorPOWL(operator=Operator.XOR, children=[expert_survey, condition_report])
...
archival_entry_and_committee_review = OperatorPOWL(operator=Operator.XOR, children=[archival_entry, committee_review])
...
root = StrictPartialOrder(nodes=[
    ...
    expert_survey_and_condition_report,
    legal_review_and_risk_analysis,
    seller_negotiation_and_documentation,
    archival_entry_and_committee_review,
    acquisition_setup_and_exhibit_planning,
    final_approval
])
root.order.add_edge(initial_review, provenance_check_and_material_testing)
root.order.add_edge(provenance_check_and_material_testing, expert_survey_and_condition_report)
root.order.add_edge(expert_survey_and_condition_report, legal_review_and_risk_analysis)
root.order.add_edge(legal_review_and_risk_analysis, seller_negotiation_and_documentation)
root.order.add_edge(seller_negotiation_and_documentation, archival_entry_and_committee_review)
root.order.add_edge(archival_entry_and_committee_review, acquisition_setup_and_exhibit_planning)
root.order.add_edge(acquisition_setup_and_exhibit_planning, final_approval)