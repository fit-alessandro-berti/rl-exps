...
# Initial client meet and requirement gathering
root = StrictPartialOrder(nodes=[client_meet, requirement_gather])

# Modular drone design and component sourcing
...
# Test analysis and software integration
...
# Pilot training and regulatory compliance verification
root.order.add_edge(data_integration, pilot_train)
root.order.add_edge(pilot_train, compliance_check)

# Fleet deployment, remote monitoring, maintenance scheduling, and iterative performance optimization
...
# Adding dependencies for concurrent activities
