...
loop = OperatorPOWL(operator=Operator.LOOP, children=[structure_build, install_hydroponics, calibrate_sensors, select_crops, plant_seeding, manage_pests, schedule_harvest, package_produce, local_delivery, analyze_data])
xor = OperatorPOWL(operator=Operator.XOR, children=[skip])
root = StrictPartialOrder(nodes=[site_survey, zoning_check, design_layout, system_order, loop, xor])
