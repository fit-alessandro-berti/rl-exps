...
root = StrictPartialOrder(nodes=[artifact_intake, visual_inspection, material_testing, radiocarbon_dating, provenance_check, archive_research, expert_review, style_analysis, craftsmanship_eval, condition_check, restoration_plan, forgeries_risk, legal_review, report_drafting, catalog_entry])
...
root.order.add_edge(visual_inspection, expert_review)
...
root.order.add_edge(expert_review, condition_check)
root.order.add_edge(style_analysis, expert_review)
root.order.add_edge(craftsmanship_eval, expert_review)
root.order.add_edge(condition_check, expert_review)
root.order.add_edge(expert_review, forgeries_risk)
