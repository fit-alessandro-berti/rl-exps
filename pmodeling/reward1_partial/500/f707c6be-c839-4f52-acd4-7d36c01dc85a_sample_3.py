...
root.order.add_edge(expert_review, lab_collaboration)
...
root.order.add_edge(forgeries_detection, certification_issue)
root.order.add_edge(legal_drafting, certification_issue)
root.order.add_edge(certification_issue, client_briefing)
root.order.add_edge(certification_issue, archival_update)
