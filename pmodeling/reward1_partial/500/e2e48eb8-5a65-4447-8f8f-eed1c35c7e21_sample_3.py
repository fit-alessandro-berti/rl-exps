...
root = StrictPartialOrder(nodes=[
    ...
    irrigation_setup, nutrient_mix, sensor_install, pest_monitor, data_analysis,
    regulation_review, community_meet, harvest_plan, packaging_design, distribution_map,
    feedback_loop, maintenance_schedule
])
...
root.order.add_edge(structural_check, irrigation_setup)
root.order.add_edge(climate_study, nutrient_mix)
