...
activities = ['Inquiry Review', 'Client Onboard', 'Concept Draft', 'Feedback Cycle', 'Contract Setup', 'Payment Schedule', 'Material Sourcing', 'Artwork Create', 'Quality Check', 'Frame Selection', 'Packaging Prep', 'Shipment Arrange', 'Delivery Confirm', 'Post-Sale Support', 'Revision Manage', 'Delay Mitigate']
