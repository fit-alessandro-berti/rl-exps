...
root = StrictPartialOrder(nodes=[
    Component_Sourcing, Sensor_Calibrate, Motor_Assembly, Frame_Build, Software_Install, Algorithm_Tune,
    Battery_Integrate, Signal_Test, Durability_Check, Flight_Simulate, Quality_Inspect, Compliance_Review,
