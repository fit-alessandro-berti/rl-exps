...
# Ensure concurrent activities are handled appropriately (e.g., by adding SilentTransitions)
# In this case, all activities are concurrent, so no additional transitions are needed.
