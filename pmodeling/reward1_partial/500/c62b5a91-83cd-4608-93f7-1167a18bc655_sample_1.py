...
# Sub-process for scientific testing and related activities
scientific_testing_subprocess = StrictPartialOrder(nodes=[scientific_testing, radiocarbon_dating, spectroscopy_scan])
scientific_testing_subprocess.order.add_edge(scientific_testing, radiocarbon_dating)
scientific_testing_subprocess.order.add_edge(radiocarbon_dating, spectroscopy_scan)

# Sub-process for legal clearance and heritage compliance
legal_compliance_subprocess = StrictPartialOrder(nodes=[legal_clearance, heritage_compliance])
legal_compliance_subprocess.order.add_edge(legal_clearance, heritage_compliance)
...
root = StrictPartialOrder(nodes=[
    ...
    condition_check,
    provenance_research,
    scientific_testing_subprocess,
    legal_compliance_subprocess,
    digital_archiving,
    expert_review,
    committee_vote,
...
root.order.add_edge(provenance_research, scientific_testing_subprocess)
root.order.add_edge(scientific_testing_subprocess, legal_compliance_subprocess)
root.order.add_edge(legal_compliance_subprocess, digital_archiving)
