...
loop_monitor_control = OperatorPOWL(operator=Operator.LOOP, children=[hive_monitor, pest_control])
...
root.order.add_edge(community_meet, loop_monitor_control)
root.order.add_edge(loop_monitor_control, data_logging)
