...
xor = OperatorPOWL(operator=Operator.XOR, children=[waste_manage, skip])

root = StrictPartialOrder(nodes=[
    site_analysis, impact_review, modular_design, system_integration,
    climate_setup, nutrient_mix, light_config, staff_training, pest_monitor,
    drone_deploy, health_scan, data_logging, supply_sync, maintenance_plan, xor
])
...
root.order.add_edge(maintenance_plan, xor)