...
risk_assessment = Transition(label='Risk Assess')
...
root = StrictPartialOrder(nodes=[
    ...
    legal_clearance, ethics_audit, insurance_quote, risk_assessment,
...
root.order.add_edge(material_testing, expert_panel)
...
root.order.add_edge(insurance_quote, risk_assessment)
root.order.add_edge(risk_assessment, digital_archive)
