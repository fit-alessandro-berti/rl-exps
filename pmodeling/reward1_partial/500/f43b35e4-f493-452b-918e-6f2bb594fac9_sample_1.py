...
feedback_loop_node = Transition(label='Feedback Loop')
root.order.add_edge(feedback_loop, feedback_loop_node)
root.order.add_edge(feedback_loop_node, feedback_loop)