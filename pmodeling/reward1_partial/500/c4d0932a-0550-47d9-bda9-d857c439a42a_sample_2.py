...
root = StrictPartialOrder(nodes=[milk_sourcing, quality_testing, starter_culture, coagulation, curd_cutting, whey_draining, molding_cheese, pressing_block, brining_bath, aging_control, flavor_profiling, packaging_design, demand_forecast, retail_outreach, customer_feedback])

# Define the dependencies between the activities (partial order edges)
