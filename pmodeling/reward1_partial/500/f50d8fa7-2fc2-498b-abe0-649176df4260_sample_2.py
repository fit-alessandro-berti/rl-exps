...
root.order.add_edge(design_plan, system_install)
root.order.add_edge(structural_retrofit, lighting_setup)
root.order.add_edge(structural_retrofit, sensor_deploy)
root.order.add_edge(system_install, lighting_setup)
root.order.add_edge(system_install, sensor_deploy)
root.order.add_edge(lighting_setup, seed_sourcing)
root.order.add_edge(lighting_setup, nutrient_prep)
