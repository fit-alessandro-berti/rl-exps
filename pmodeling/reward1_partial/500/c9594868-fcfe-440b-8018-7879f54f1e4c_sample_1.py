...
root.order.add_edge(permit_review, material_sourcing)
...
root.order.add_edge(community_meet, sensor_install)
root.order.add_edge(crop_select, water_testing)
...
root.order.add_edge(water_testing, growth_monitor)
