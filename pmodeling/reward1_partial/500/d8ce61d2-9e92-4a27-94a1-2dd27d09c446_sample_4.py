...
# Define a loop for the restoration process
restoration_loop = OperatorPOWL(operator=Operator.LOOP, children=[restoration_plan, restoration_track])

# Define a choice for the public showcase and archival preparation
public_showcase_or_archival_prep = OperatorPOWL(operator=Operator.XOR, children=[public_showcase, archival_prep])

# Define the root POWL model
root = StrictPartialOrder(nodes=[initial_audit, artist_review, material_check, condition_scan, ownership_verify, appraisal_update, restoration_loop, logistics_book, shipping_monitor, customs_clear, legal_compliance, ledger_update, exhibition_setup, public_showcase_or_archival_prep, final_report])
...
root.order.add_edge(restoration_loop, logistics_book)
...
root.order.add_edge(exhibition_setup, public_showcase_or_archival_prep)
root.order.add_edge(public_showcase_or_archival_prep, final_report)
