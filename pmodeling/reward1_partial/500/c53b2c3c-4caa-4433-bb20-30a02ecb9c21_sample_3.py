...
# Define loop node for image capture and material testing
loop = OperatorPOWL(operator=Operator.LOOP, children=[image_capture, material_testing])
root = StrictPartialOrder(nodes=[discover_item, document_find, initial_survey, loop, style_compare, expert_consult, provenance_check, ownership_verify, legal_review, risk_assess, conservation_plan, certification, secure_transfer, dispute_resolve, final_archive])
