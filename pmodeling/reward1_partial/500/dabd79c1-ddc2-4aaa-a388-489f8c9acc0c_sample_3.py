...
test_material = Transition(label='Material Testing')
...
root.order.add_edge(doc_review, test_material)
root.order.add_edge(test_material, radiocarbon)
root.order.add_edge(test_material, stylistic_eval)
