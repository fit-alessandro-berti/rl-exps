...
root = StrictPartialOrder(nodes=[
    Milk_Sourcing, Culture_Prep, Milk_Pasteurize, Milk_Inoculate, Curd_Formation, Curd_Cut, Whey_Drain, Mold_Inoculate, Press_Cheese,
    Aging_Setup, Humidity_Control, Temperature_Monitor, Quality_Test, Packaging, Order_Fulfill, Retail_Deliver, Feedback_Collect
])
