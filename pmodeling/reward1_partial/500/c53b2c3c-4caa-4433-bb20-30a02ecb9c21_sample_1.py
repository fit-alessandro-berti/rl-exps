...
root = StrictPartialOrder(nodes=[
    DiscoverItem, DocumentFind, InitialSurvey, ImageCapture, MaterialTesting,
    StyleCompare, ExpertConsult, ProvenanceCheck, OwnershipVerify, LegalReview,
    RiskAssess, ConservationPlan, Certification, SecureTransfer, DisputeResolve,
    FinalArchive
])
...
for activity in root.nodes:
    root.order.add_edge(activity, activity)  # Self-loop to ensure all activities are connected
