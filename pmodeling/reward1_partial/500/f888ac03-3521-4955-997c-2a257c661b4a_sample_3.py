...
root = StrictPartialOrder(nodes=[order_validate, route_optimize, drone_assign, preflight_check, load_package, flight_launch, traffic_monitor, weather_assess, obstacle_avoid, battery_check, delivery_verify, biometric_scan, package_release, return_flight, post_flight, data_analyze, feedback_collect])
