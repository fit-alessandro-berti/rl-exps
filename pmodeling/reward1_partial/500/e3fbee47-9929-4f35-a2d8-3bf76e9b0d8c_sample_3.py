...
# Optionally, you can add more dependencies as needed based on the specific process flow.

# Now, 'root' contains the POWL model for the described supply chain process.