...
root.order.add_edge(archive_research, digital_imaging)
root.order.add_edge(archive_research, three_d_modeling)
...
# Print the root node to confirm it has been defined correctly
print(root)