...
# Define the loop for the cleaning and structural reinforce phases
cleaning_and_reinforce = OperatorPOWL(operator=Operator.LOOP, children=[cleaning_phase, structural_reinforce])

# Define the exclusive choice for minor repair and surface restore phases
minor_repair_or_surface_restore = OperatorPOWL(operator=Operator.XOR, children=[minor_repair, surface_restore])
...
root = StrictPartialOrder(nodes=[
    ...
    condition_map,
    material_test,
    cleaning_and_reinforce,
    minor_repair_or_surface_restore,
    ethics_review,
    provenance_verify,
    client_update,
    final_report,
...
root.order.add_edge(minor_repair, surface_restore)
