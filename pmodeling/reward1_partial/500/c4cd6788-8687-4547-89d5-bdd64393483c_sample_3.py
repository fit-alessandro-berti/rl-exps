...
root = StrictPartialOrder(nodes=[
    ...
    condition_report, transport_plan, insurance_setup, customs_clear, secure_packaging,
    shipping_monitor, community_brief, arrival_inspect, exhibit_prepare, public_release
])
