...
root.order.add_edge(material_scan, document_audit)
root.order.add_edge(material_scan, legal_verify)
root.order.add_edge(radiocarbon_test, stylistic_review)
root.order.add_edge(radiocarbon_test, expert_consult)
root.order.add_edge(radiocarbon_test, document_audit)
root.order.add_edge(radiocarbon_test, legal_verify)
root.order.add_edge(stylistic_review, expert_consult)
root.order.add_edge(stylistic_review, document_audit)
root.order.add_edge(stylistic_review, legal_verify)
...
root.order.add_edge(discrepancy_flag, alternative_source)
root.order.add_edge(re_examination, acquisition_vote)
