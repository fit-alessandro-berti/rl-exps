...
loop = OperatorPOWL(operator=Operator.LOOP, children=[drone_assembly, software_setup, test_flight, data_integration, compliance_audit, emergency_plan, launch_prep, feedback_loop, performance_tune, scale_strategy])

# Define the root model
root = StrictPartialOrder(nodes=[site_survey, fleet_design, permit_request, xor, loop])
