...
xor = OperatorPOWL(operator=Operator.XOR, children=[token_minting, legal_review, compliance_check, insurance_valuation, risk_assessment, packaging_prep, climate_control, transport_setup])
root = StrictPartialOrder(nodes=[artifact_intake, preliminary_check, loop, xor, final_approval])
