...
root = StrictPartialOrder(nodes=[
    SiteSurvey, EnvAnalysis, ModuleDesign, SeedSelection, NutrientMix,
    ClimateSetup, LEDInstall, SensorDeploy, PestControl, WasteRecycle,
    HydroTest, StaffTrain, YieldForecast, MarketPlan, DataReview
])
