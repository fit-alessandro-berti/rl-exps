...
root.order.add_edge(structure_check, seed_sourcing)
root.order.add_edge(soil_test, design_layout)
root.order.add_edge(soil_test, seed_sourcing)
root.order.add_edge(climate_eval, design_layout)
root.order.add_edge(climate_eval, seed_sourcing)
root.order.add_edge(permit_obtain, design_layout)
root.order.add_edge(permit_obtain, seed_sourcing)
root.order.add_edge(design_layout, irrigation_set)
...
root.order.add_edge(seed_sourcing, sensor_install)
root.order.add_edge(seed_sourcing, staff_train)
