...
root.order.add_edge(payload_assess, flight_simulate)
root.order.add_edge(drone_configure, regulation_check)
root.order.add_edge(drone_configure, flight_simulate)
root.order.add_edge(regulation_check, route_optimize)
root.order.add_edge(regulation_check, pre_flight_inspect)
root.order.add_edge(flight_simulate, route_optimize)
root.order.add_edge(flight_simulate, pre_flight_inspect)
root.order.add_edge(route_optimize, weather_monitor)
root.order.add_edge(route_optimize, launch_drone)
