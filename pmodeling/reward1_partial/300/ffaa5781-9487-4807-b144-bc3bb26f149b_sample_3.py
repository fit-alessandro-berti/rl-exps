...
xor1 = OperatorPOWL(operator=Operator.XOR, children=[context_validation, legal_audit, export_verify])
...
xor3 = OperatorPOWL(operator=Operator.XOR, children=[catalog_entry, virtual_setup, archival_backup])

# Construct the root POWL model
root = StrictPartialOrder(nodes=[provenance_check, loop1, xor1, xor2, loop2, xor3])
