...
root = StrictPartialOrder(nodes=[
    site_survey, design_layout, select_crops, install_modules, setup_sensors,
    calibrate_climate, configure_lighting, integrate_iot, train_staff, run_trials,
    analyze_data, optimize_yield, check_compliance, plan_marketing, launch_facility
])
