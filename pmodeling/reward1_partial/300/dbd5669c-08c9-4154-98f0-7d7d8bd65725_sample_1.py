...
xor = OperatorPOWL(operator=Operator.XOR, children=[pest_management, compliance_check])
root = StrictPartialOrder(nodes=[site_survey, design_layout, material_sourcing, unit_assembly, system_wiring, sensor_install, water_testing, nutrient_mix, seed_selection, planting_setup, climate_control, data_calibration, yield_analysis, community_meet, xor, expansion_plan])
...
root.order.add_edge(xor, expansion_plan)
