...
root.order.add_edge(crop_select, stakeholder_meet)
root.order.add_edge(permit_obtain, bed_construction)
root.order.add_edge(permit_obtain, seed_planting)
...
root.order.add_edge(seed_planting, irrigation_plan)
root.order.add_edge(seed_planting, energy_setup)
root.order.add_edge(seed_planting, pest_control)
root.order.add_edge(seed_planting, permit_obtain)
root.order.add_edge(seed_planting, stakeholder_meet)
root.order.add_edge(irrigation_plan, water_schedule)
root.order.add_edge(energy_setup, water_schedule)
root.order.add_edge(pest_control, water_schedule)
root.order.add_edge(permit_obtain, water_schedule)
root.order.add_edge(stakeholder_meet, water_schedule)
