...
root = StrictPartialOrder(nodes=[
    artifact_intake, provenance_check, archive_search, expert_interview, material_scan, age_analysis, stylistic_review, context_mapping,
    legal_clearance, data_compilation, report_drafting, peer_review, final_assessment, acquisition_plan, restoration_prep, documentation, data_backup
])
...
root.order.add_edge(provenance_check, age_analysis)
root.order.add_edge(provenance_check, stylistic_review)
root.order.add_edge(provenance_check, context_mapping)
