...
loop = OperatorPOWL(operator=Operator.LOOP, children=[material_scout, supplier_vetting, skill_audit, order_forecast, custom_scheduling, impact_review, product_inspect, eco_packaging, multi_transport, route_optimize, feedback_loop, craft_refine, inventory_balance, story_marketing, heritage_share, demand_adjust, community_sync])

# Define the partial order
root = StrictPartialOrder(nodes=[loop])
root.order.add_edge(loop, material_scout)
