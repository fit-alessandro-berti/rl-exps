...
root = StrictPartialOrder(nodes=[
    ...
    hydroponic_setup, climate_config, ai_integration, nutrient_sourcing,
    waste_planning, staff_training, crop_seeding, growth_monitoring,
    quality_testing, harvest_scheduling, distribution_plan, data_analysis
])

# Define dependencies (dependencies between activities)
