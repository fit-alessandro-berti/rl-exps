...
restorations_map = Transition(label='Restoration Map')
...
root = StrictPartialOrder(nodes=[
    initial_inspect, material_test, imaging_scan, historical_check, expert_consult, provenance_trace, forgeries_detect, restorations_map, market_analyze, auction_review, value_assess, report_draft, board_review, certification, release_artifact, chain_custody
])
...
root.order.add_edge(provenance_trace, forgeries_detect)
root.order.add_edge(forgeries_detect, restorations_map)
root.order.add_edge(restorations_map, market_analyze)
