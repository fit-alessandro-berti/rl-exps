...
root = StrictPartialOrder(nodes=[
    ConceptApprove, BudgetAlign, DesignReview, StructureSimulate, MaterialProcure, VendorSelect, PermitApply, SafetyCheck, SitePrep, LogisticsPlan, FabricateParts, AssembleOnsite, QualityInspect, WeatherMonitor, PublicUnveil, MaintenancePlan, StakeholderMeet
])
