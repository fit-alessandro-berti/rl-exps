...
# Define loop for waste recycling and energy optimization
...
root.order.add_edge(compliance_check, waste_energy_loop)
root.order.add_edge(waste_energy_loop, market_strategy)
