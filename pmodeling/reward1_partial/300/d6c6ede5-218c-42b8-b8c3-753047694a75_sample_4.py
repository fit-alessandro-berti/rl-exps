...
root.nodes.extend([site_survey, load_test, climate_study, permit_check, system_design, equipment_buy, sensor_setup, irrigation_fit, solar_install, staff_train, pilot_plant, data_monitor, crop_harvest, maintenance_plan, community_meet])
...
# The POWL model for the process is now defined in the 'root' variable.