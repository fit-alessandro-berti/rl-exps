...
root.order.add_edge(alert_dispatch, command_setup)
root.order.add_edge(resource_check, command_setup)
root.order.add_edge(command_setup, intel_gather)
root.order.add_edge(command_setup, priority_set)
root.order.add_edge(intel_gather, field_deploy)
...
root.order.add_edge(comm_sync, supply_manage)
