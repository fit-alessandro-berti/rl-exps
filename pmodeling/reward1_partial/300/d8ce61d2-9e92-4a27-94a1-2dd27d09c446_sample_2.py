...
# Initial audit -> Artist review -> Material check -> Condition scan -> Ownership verify -> Appraisal update -> Restoration plan -> Restoration track
# -> Logistics book -> Shipping monitor -> Customs clear -> Legal compliance -> Ledger update -> Exhibition setup
# -> Public showcase -> Archival prep -> Final report
