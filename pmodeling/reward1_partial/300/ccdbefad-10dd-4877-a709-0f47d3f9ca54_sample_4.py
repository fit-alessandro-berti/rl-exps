...
root = StrictPartialOrder(nodes=[material_scout_choice, supplier_vetting_choice, skill_audit_choice, order_forecast_choice, custom_scheduling_choice, impact_review_choice, product_inspect_choice, eco_packaging_choice, multi_transport_choice, route_optimize_choice, feedback_loop_choice, craft_refine_choice, inventory_balance_choice, story_marketing_choice, heritage_share_choice, demand_adjust_choice, community_sync_choice])
