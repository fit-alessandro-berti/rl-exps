...
root = StrictPartialOrder(nodes=[
    ...
    stakeholder_meet, route_mapping, traffic_sync, drone_assembly,
    software_setup, test_flight, data_integration, compliance_audit,
    emergency_plan, launch_prep, feedback_loop, performance_tune,
    scale_strategy
])
...
root.order.add_edge(fleet_design, traffic_sync)
