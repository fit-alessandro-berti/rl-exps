...
xor3 = OperatorPOWL(operator=Operator.XOR, children=[conservation_plan, style_compare])
...
xor6 = OperatorPOWL(operator=Operator.XOR, children=[final_approval, exhibit_setup])
