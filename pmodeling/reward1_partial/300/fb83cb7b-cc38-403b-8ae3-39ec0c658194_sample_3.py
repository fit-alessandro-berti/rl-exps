...
# Define the loop for ongoing activities
ongoing_activities = OperatorPOWL(operator=Operator.LOOP, children=[
    PestMonitor,
    NutrientCalibrate
])
...
root.order.add_edge(CropPlan, ongoing_activities)
root.order.add_edge(ongoing_activities, HarvestSchedule)
