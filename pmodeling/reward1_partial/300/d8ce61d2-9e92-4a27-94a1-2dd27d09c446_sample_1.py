...
xor1 = OperatorPOWL(operator=Operator.XOR, children=[material_check, condition_scan, ownership_verify, appraisal_update, restoration_plan, restoration_track, logistics_book, shipping_monitor, customs_clearance, legal_compliance])
xor2 = OperatorPOWL(operator=Operator.XOR, children=[ledger_update, exhibition_setup, public_showcase, archival_prep, final_report])

loop = OperatorPOWL(operator=Operator.LOOP, children=[initial_audit, artist_review, xor1, xor2])
