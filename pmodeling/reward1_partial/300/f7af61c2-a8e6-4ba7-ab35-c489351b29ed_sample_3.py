...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[sensor_setup, microclimate_mon, health_monitor, light_adjust, irrigation_mod, waste_recycle, energy_optimize])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[quality_check, crop_harvest, distribution_plan])
