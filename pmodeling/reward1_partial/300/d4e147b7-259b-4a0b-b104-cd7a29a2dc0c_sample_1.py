...
root.order.add_edge(provenance_search, expert_consult)
...
root.order.add_edge(expert_consult, digital_catalog)
root.order.add_edge(expert_consult, ownership_audit)
root.order.add_edge(expert_consult, restoration_plan)
root.order.add_edge(expert_consult, final_approval)
root.order.add_edge(expert_consult, authentication_cert)
