...
root.order.add_edge(scientific_testing, heritage_compliance)
root.order.add_edge(scientific_testing, digital_archiving)
root.order.add_edge(scientific_testing, expert_review)
root.order.add_edge(scientific_testing, committee_vote)
root.order.add_edge(scientific_testing, acquisition_approval)
