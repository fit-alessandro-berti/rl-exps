...
loop = OperatorPOWL(operator=Operator.LOOP, children=[provenance_check, radiocarbon_test, material_analysis, microscopic_scan, expert_review, context_validation, legal_audit, export_verify, digital_imaging, three_d_modeling])
choice = OperatorPOWL(operator=Operator.XOR, children=[consensus_meeting, final_approval, catalog_entry, virtual_setup, archival_backup])
