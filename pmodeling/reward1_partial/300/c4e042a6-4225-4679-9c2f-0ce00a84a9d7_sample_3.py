...
root = StrictPartialOrder(nodes=[material_sourcing, supplier_audit, credential_verify, exclusive_choice, loop])
root.order.add_edge(material_sourcing, supplier_audit)
root.order.add_edge(supplier_audit, credential_verify)
root.order.add_edge(credential_verify, exclusive_choice)
root.order.add_edge(exclusive_choice, artisan_assign)
...
root.order.add_edge(customer_engage, loop)
