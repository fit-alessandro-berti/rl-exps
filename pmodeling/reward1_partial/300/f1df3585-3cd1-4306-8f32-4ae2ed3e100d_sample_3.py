...
root = StrictPartialOrder(nodes=[
    ...
    apply_biocontrols, maintain_systems, analyze_data, harvest_crops,
...
root.order.add_edge(plan_layout, monitor_germinate)
...
root.order.add_edge(setup_lighting, apply_biocontrols)
root.order.add_edge(setup_lighting, maintain_systems)
root.order.add_edge(setup_lighting, analyze_data)
root.order.add_edge(configure_climate, apply_biocontrols)
root.order.add_edge(configure_climate, maintain_systems)
root.order.add_edge(configure_climate, analyze_data)
root.order.add_edge(select_seeds, monitor_germinate)
root.order.add_edge(monitor_germinate, apply_biocontrols)
root.order.add_edge(monitor_germinate, maintain_systems)
root.order.add_edge(monitor_germinate, analyze_data)
root.order.add_edge(apply_biocontrols, maintain_systems)
root.order.add_edge(apply_biocontrols, analyze_data)
