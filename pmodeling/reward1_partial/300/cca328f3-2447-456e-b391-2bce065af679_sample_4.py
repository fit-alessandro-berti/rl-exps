...
xor = OperatorPOWL(operator=Operator.XOR, children=[display_approve, lender_notify, investigation_flag])
root = StrictPartialOrder(nodes=[artifact_intake, provenance_check, material_scan, style_compare, digital_capture, expert_review, database_search, legal_audit, cultural_assess, data_synthesis, report_draft, archival_store, xor])
...
root.order.add_edge(archival_store, xor)