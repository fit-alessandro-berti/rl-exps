...
xor = OperatorPOWL(operator=Operator.XOR, children=[quality_check, crop_harvest, distribution_plan])

# Define the root
root = StrictPartialOrder(nodes=[site_analysis, structure_check, farm_design, env_control, nutrient_prep, seed_selection, automated_plant, loop, xor])
