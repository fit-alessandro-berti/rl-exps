...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[germinate_seeds, seed_select])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[pest_control, monitor_growth])
loop3 = OperatorPOWL(operator=Operator.LOOP, children=[data_analyze, climate_setup])
loop4 = OperatorPOWL(operator=Operator.LOOP, children=[package_goods, ship_products])
...
root.order.add_edge(ship_products, skip)
