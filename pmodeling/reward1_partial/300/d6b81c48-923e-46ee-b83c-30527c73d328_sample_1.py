...
root.order.add_edge(flight_launch, data_upload)
root.order.add_edge(telemetry_monitor, postflight_review)
root.order.add_edge(anomaly_detect, postflight_review)
root.order.add_edge(collision_assess, postflight_review)
root.order.add_edge(data_upload, battery_optimize)
