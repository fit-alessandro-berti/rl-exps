...
root = StrictPartialOrder(nodes=[site_survey_to_design_layout, design_layout_to_material_sourcing, material_sourcing_to_unit_assembly, unit_assembly_to_system_wiring, system_wiring_to_sensor_install, sensor_install_to_water_testing, water_testing_to_nutrient_mix, nutrient_mix_to_seed_selection, seed_selection_to_planting_setup, planting_setup_to_climate_control, climate_control_to_pest_management, pest_management_to_data_calibration, data_calibration_to_yield_analysis, yield_analysis_to_community_meet, community_meet_to_compliance_check, compliance_check_to_expansion_plan])
