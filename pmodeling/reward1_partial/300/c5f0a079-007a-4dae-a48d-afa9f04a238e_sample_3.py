...
xor2 = OperatorPOWL(operator=Operator.XOR, children=[ethics_review, skip])
xor3 = OperatorPOWL(operator=Operator.XOR, children=[condition_monitor, skip])
xor4 = OperatorPOWL(operator=Operator.XOR, children=[final_certification, skip])
...
root.order.add_edge(xor, ownership_verify)
root.order.add_edge(ownership_verify, xor2)
...
root.order.add_edge(exhibit_approve, xor3)
root.order.add_edge(xor3, final_certification)