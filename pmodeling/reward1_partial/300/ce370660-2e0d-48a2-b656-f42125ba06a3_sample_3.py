...
xor = OperatorPOWL(operator=Operator.XOR, children=[community_meet, staff_train])
loop = OperatorPOWL(operator=Operator.LOOP, children=[plant_crop, maintenance_plan])

# Create the root POWL model
root = StrictPartialOrder(nodes=[structural_check, permit_apply, design_layout, soil_prep, bed_install, irrigation_setup, sensor_mount, solar_connect, seed_order, nutrient_mix, xor, loop, waste_manage])
