...
root = StrictPartialOrder(nodes=[
    opportunity_scan, idea_workshop, concept_merge, resource_align,
    prototype_build, feasibility_test, pilot_launch, feedback_gather,
    design_adapt, compliance_check, scaling_plan, ip_management,
