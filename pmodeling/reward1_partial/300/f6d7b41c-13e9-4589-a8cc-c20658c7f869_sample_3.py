...
root.nodes = [client_consult, needs_assess, art_selection, inventory_check, legal_draft, contract_sign, insurance_setup, transport_plan, secure_transit, art_install, condition_check, appraisal_log, lease_renew, payment_process, deinstall_art, return_inspect, purchase_option]
