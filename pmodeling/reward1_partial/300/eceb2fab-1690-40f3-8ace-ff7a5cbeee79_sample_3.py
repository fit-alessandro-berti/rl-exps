...
root = StrictPartialOrder(nodes=[provenance_check, condition_scan, material_test, disassembly, surface_clean, loop, xor, documentation, client_feedback, delivery_prep])
...
root.order.add_edge(loop, reconstruction)
