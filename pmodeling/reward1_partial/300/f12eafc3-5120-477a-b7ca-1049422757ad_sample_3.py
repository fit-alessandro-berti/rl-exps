...
control_aging = OperatorPOWL(operator=Operator.LOOP, children=[controlled_aging, sensory_review, custom_packaging])
custom_documentation = OperatorPOWL(operator=Operator.LOOP, children=[export_licensing, documentation_prep, customs_clearance, cold_shipping, delivery_tracking])
post_shipment = OperatorPOWL(operator=Operator.LOOP, children=[feedback_review, market_analysis])

# Define the partial order
root = StrictPartialOrder(nodes=[milk_selection, quality_testing, milk_pasteurize, cheese_crafting, control_aging, custom_documentation, post_shipment])
