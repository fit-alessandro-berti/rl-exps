...
root = StrictPartialOrder(
    nodes=[
        intake_review, condition_scan, material_test, style_match, provenance_log, forger_risk, legal_audit,
        expert_panel, data_crosscheck, report_draft, blockchain_tag, certification, client_feedback, final_approval, release_prep
    ],
    order=[
        (intake_review, condition_scan),
        (condition_scan, material_test),
        (material_test, style_match),
        (style_match, provenance_log),
        (provenance_log, forger_risk),
