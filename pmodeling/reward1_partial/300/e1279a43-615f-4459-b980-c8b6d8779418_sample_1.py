...
root.order.add_edge(site_analysis, climate_adjust)
root.order.add_edge(site_analysis, growth_monitor)
root.order.add_edge(site_analysis, pest_control)
root.order.add_edge(site_analysis, harvesting_mode)
root.order.add_edge(site_analysis, quality_check)
root.order.add_edge(site_analysis, packaging_phase)
root.order.add_edge(site_analysis, cold_storage)
root.order.add_edge(site_analysis, order_dispatch)
root.order.add_edge(site_analysis, waste_recycling)
root.order.add_edge(site_analysis, system_maintain)
root.order.add_edge(infrastructure_setup, seed_selection)
root.order.add_edge(infrastructure_setup, nutrient_mix)
