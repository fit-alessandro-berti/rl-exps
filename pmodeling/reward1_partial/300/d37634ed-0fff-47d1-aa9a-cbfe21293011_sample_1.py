...
root = StrictPartialOrder(nodes=[
    seed_selection, nutrient_mix, env_check, planting_setup, growth_monitor, pest_control,
    harvest, quality_inspect, packaging_prep, order_fulfill, local_delivery, waste_collect,
...
root.order.add_edge(harvest, quality_inspect)
