...
root = StrictPartialOrder(nodes=[site_survey_to_climate_study, climate_study_to_system_design, system_design_to_seed_selection, seed_selection_to_unit_install, unit_install_to_sensor_setup, sensor_setup_to_nutrient_mix, nutrient_mix_to_energy_audit, energy_audit_to_pest_control, pest_control_to_crop_plan, crop_plan_to_quality_check, quality_check_to_yield_forecast, yield_forecast_to_supply_sync, supply_sync_to_staff_train, staff_train_to_data_review])
root.order.add_edge(site_survey_to_climate_study, climate_study_to_system_design)
root.order.add_edge(climate_study_to_system_design, system_design_to_seed_selection)
root.order.add_edge(system_design_to_seed_selection, seed_selection_to_unit_install)
root.order.add_edge(seed_selection_to_unit_install, unit_install_to_sensor_setup)
root.order.add_edge(unit_install_to_sensor_setup, sensor_setup_to_nutrient_mix)
root.order.add_edge(sensor_setup_to_nutrient_mix, nutrient_mix_to_energy_audit)
root.order.add_edge(nutrient_mix_to_energy_audit, energy_audit_to_pest_control)
root.order.add_edge(energy_audit_to_pest_control, pest_control_to_crop_plan)
root.order.add_edge(pest_control_to_crop_plan, crop_plan_to_quality_check)
root.order.add_edge(crop_plan_to_quality_check, quality_check_to_yield_forecast)
root.order.add_edge(quality_check_to_yield_forecast, yield_forecast_to_supply_sync)
root.order.add_edge(yield_forecast_to_supply_sync, supply_sync_to_staff_train)
root.order.add_edge(supply_sync_to_staff_train, staff_train_to_data_review)
