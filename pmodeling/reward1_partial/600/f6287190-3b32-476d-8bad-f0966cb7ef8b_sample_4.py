...
# Define the loop for the entire process cycle
loop = OperatorPOWL(operator=Operator.LOOP, children=[
    seed_select, climate_map, iot_setup, nutrient_mix, sensor_check, light_adjust, water_cycle,
    pest_scan, growth_audit, harvest_plan, demand_sync, quality_grade, pack_items, waste_compost,
    data_review, cycle_reset
])

# Define the partial order with the loop as the root
