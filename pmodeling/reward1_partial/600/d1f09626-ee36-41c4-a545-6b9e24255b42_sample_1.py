...
root.order.add_edge(climate_check, irrigation_plan)
...
root.order.add_edge(irrigation_plan, bed_construction)
...
root.order.add_edge(bed_construction, growth_monitor)
