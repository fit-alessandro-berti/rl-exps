...
root.nodes.append(seed_selection)
root.nodes.append(ai_prediction)
root.nodes.append(automated_planting)
root.nodes.append(sensor_calibration)
root.nodes.append(environment_adjust)
root.nodes.append(nutrient_dosing)
root.nodes.append(hydroponic_flow)
root.nodes.append(robotic_pruning)
root.nodes.append(health_monitor)
root.nodes.append(harvesting_ops)
root.nodes.append(data_analysis)
root.nodes.append(predictive_check)
root.nodes.append(waste_composting)
root.nodes.append(water_recycling)
root.nodes.append(eco_packaging)
root.nodes.append(carbon_tracking)
root.nodes.append(logistics_dispatch)
