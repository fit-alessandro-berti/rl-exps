...
root = StrictPartialOrder(nodes=[
    site_assess, structure_check, permit_obtain, material_source, soil_prepare, waterproof_roof, irrigation_setup, bed_assemble, crop_plan, pest_monitor, nutrient_calibrate, harvest_schedule, community_train, yield_record, impact_review
])
