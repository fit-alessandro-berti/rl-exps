...
xor = OperatorPOWL(operator=Operator.XOR, children=[crop_cycle, skip])

root = StrictPartialOrder(nodes=[
    site_survey, permit_acquire, rack_design, seed_selection, nutrient_mix, lighting_setup, sensor_install, 
    system_test, staff_hire, training_lead, waste_manage, supply_chain, data_monitor, harvest_plan, distribution
])
