...
root = StrictPartialOrder(nodes=[
    ...
    press_cheese, salt_brine, age_monitor, quality_test, packaging_prep, label_design,
    order_allocation, transport_arrange, retail_sync, customer_review, feedback_analyze
])
