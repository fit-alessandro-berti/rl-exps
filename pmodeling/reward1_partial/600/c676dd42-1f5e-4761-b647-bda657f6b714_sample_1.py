...
root = StrictPartialOrder(nodes=[
    ...
    data_integration, growth_monitoring, pest_control, waste_sorting,
    harvest_plan, produce_pack, energy_audit, community_setup
])

# Define the dependencies between activities (edges in the partial order)
