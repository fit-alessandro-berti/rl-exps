...
root.order.add_edge(material_scan, aging_verify)
root.order.add_edge(style_compare, aging_verify)
root.order.add_edge(aging_verify, record_match)
root.order.add_edge(aging_verify, database_query)
root.order.add_edge(record_match, panel_review)
