...
# Define the POWL edges and operators
root = StrictPartialOrder(nodes=[
    artifact_intake, condition_check, material_test, style_compare, carbon_dating,
    document_review, provenance_check, digital_imaging, forge_scan, expert_consult,
...
root.order.add_edge(digital_imaging, forge_scan)
root.order.add_edge(forge_scan, expert_consult)
