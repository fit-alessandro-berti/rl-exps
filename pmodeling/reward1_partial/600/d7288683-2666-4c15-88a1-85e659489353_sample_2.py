...
root = StrictPartialOrder(nodes=[sourcing, frame_assembly, motor_installation, sensor_mounting, wiring_setup, firmware_upload, ai_module, calibration, stress_testing, flight_simulation, pattern_adjustment, quality_inspect, compliance_check, packaging, delivery_setup])
...
root.order.add_edge(calibration, stress_testing)
...
root.order.add_edge(packaging, delivery_setup)
