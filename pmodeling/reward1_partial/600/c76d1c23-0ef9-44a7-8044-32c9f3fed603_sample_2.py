...
# Define the loop for crop selection and management
crop_selection_loop = OperatorPOWL(operator=Operator.LOOP, children=[select_crops, plant_seeding, monitor_growth, manage_pests])
...
root.order.add_edge(crop_selection_loop, schedule_harvest)
