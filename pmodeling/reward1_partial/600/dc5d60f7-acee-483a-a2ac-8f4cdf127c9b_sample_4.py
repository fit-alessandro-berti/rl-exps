...
xor6 = OperatorPOWL(operator=Operator.XOR, children=[release_prep, release_prep])

# Define the POWL partial order
root = StrictPartialOrder(nodes=[intake_review, condition_scan, material_test, xor1, xor2, xor3, xor4, xor5, xor6])
...
root.order.add_edge(xor6, release_prep)
