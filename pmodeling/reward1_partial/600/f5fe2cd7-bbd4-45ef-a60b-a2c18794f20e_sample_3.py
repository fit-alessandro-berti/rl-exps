...
acquisition_vote_to_final_approval = OperatorPOWL(operator=Operator.XOR, children=[acquisition_vote, final_approval])
discrepancy_flag_to_final_approval = OperatorPOWL(operator=Operator.XOR, children=[discrepancy_flag, final_approval])
...
root = StrictPartialOrder(nodes=[
    ...
    acquisition_vote_to_final_approval,
    discrepancy_flag_to_final_approval,
...
root.order.add_edge(alternative_source_to_acquisition_vote, acquisition_vote_to_final_approval)
root.order.add_edge(acquisition_vote_to_final_approval, discrepancy_flag_to_final_approval)
root.order.add_edge(discrepancy_flag_to_final_approval, final_approval_to_catalog_entry)
root.order.add_edge(final_approval_to_catalog_entry, catalog_entry_to_exhibit_plan)
