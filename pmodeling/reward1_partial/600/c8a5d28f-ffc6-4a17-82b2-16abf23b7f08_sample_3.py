...
# Define the loop for the cheese production
...
# Define the xor for the logistics and export process
logistics_export_xor = OperatorPOWL(operator=Operator.XOR, children=[
    health_certify,
    custom_labeling,
    cold_packaging,
    logistics_setup,
...
root = StrictPartialOrder(nodes=[production_loop, logistics_export_xor])

# Add the dependencies between nodes
root.order.add_edge(production_loop, logistics_export_xor)
