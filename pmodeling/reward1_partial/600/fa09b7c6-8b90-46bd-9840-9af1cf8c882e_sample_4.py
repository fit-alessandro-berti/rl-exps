...
root.order.add_edge(site_survey, setup_hydroponics)
...
root.order.add_edge(install_lighting, select_crops)
root.order.add_edge(setup_hydroponics, calibrate_sensors)
root.order.add_edge(setup_hydroponics, select_crops)
root.order.add_edge(calibrate_sensors, mix_nutrients)
root.order.add_edge(calibrate_sensors, deploy_iot)
root.order.add_edge(select_crops, mix_nutrients)
root.order.add_edge(select_crops, deploy_iot)
