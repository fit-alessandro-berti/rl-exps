...
root = StrictPartialOrder(
    ...
    order=[
        ...
        (culture_selection, milk_testing),
        (milk_testing, fermentation_start),
        (fermentation_start, temperature_control),
        (temperature_control, pH_monitoring),
        (pH_monitoring, curd_cutting),
        (curd_cutting, whey_draining),
        (whey_draining, molding_cheese),
        (molding_cheese, salting_process),
        (salting_process, aging_setup),
        (aging_setup, quality_check),
        (quality_check, packaging_prep),
        (packaging_prep, label_design),
        (label_design, distribution_plan),
        (distribution_plan, retail_delivery),
