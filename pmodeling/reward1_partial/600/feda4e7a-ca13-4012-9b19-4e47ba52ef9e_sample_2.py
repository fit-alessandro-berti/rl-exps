...
loop = OperatorPOWL(operator=Operator.LOOP, children=[env_scanning, farm_design, nutrient_mix, seed_automation, growth_monitor, pest_control, ai_diagnostics, harvest_plan, rob_sort, packaging_line])
xor = OperatorPOWL(operator=Operator.XOR, children=[community_input, data_aggregation, waste_recycle])
