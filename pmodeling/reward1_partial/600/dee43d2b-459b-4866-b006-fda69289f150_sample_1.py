...
root.order.add_edge(climate_control, water_cycling_loop)
root.order.add_edge(water_cycling_loop, growth_monitoring)
root.order.add_edge(growth_monitoring, pest_detection)
root.order.add_edge(pest_detection, light_adjustment)
root.order.add_edge(light_adjustment, data_analysis_loop)
root.order.add_edge(data_analysis_loop, harvest_planning)
