...
xor = OperatorPOWL(operator=Operator.XOR, children=[stakeholder_meet, compliance_check])

root = StrictPartialOrder(nodes=[site_survey, modular_design, system_build, env_control, seed_selection, nutrient_mix, planting_setup, growth_monitor, pest_control, water_cycle, data_capture, yield_forecast, waste_reuse, xor])
...
root.order.add_edge(waste_reuse, xor)
root.order.add_edge(xor, supply_sync)