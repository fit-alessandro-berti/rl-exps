...
root = StrictPartialOrder(nodes=[
    site_survey_choice, design_layout_choice, material_sourcing_choice,
    system_assembly_choice, sensor_install_choice, nutrient_prep_choice,
    water_testing_choice, climate_setup_choice, data_integration_choice,
    growth_monitoring_choice, pest_control_choice, waste_sorting_choice,
    harvest_plan_choice, produce_pack_choice, energy_audit_choice,
