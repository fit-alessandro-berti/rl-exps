...
root = StrictPartialOrder(nodes=[
    trend_scan, idea_sprint, feasibility_check, risk_review,
    tech_prototype, market_simulate, stakeholder_align,
    budget_adjust, talent_source, pilot_launch, data_refine,
    scale_analysis, integration_plan, change_manage, knowledge_transfer
])

# Define the dependencies (order) in the process
