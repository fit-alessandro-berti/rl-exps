...
xor = OperatorPOWL(operator=Operator.XOR, children=[storage_allocation, order_processing])
...
root = StrictPartialOrder(nodes=[seed_sourcing, farm_scheduling, sensor_monitoring, nutrient_cycling, crop_forecasting, pest_inspection, harvest_timing, quality_check, eco_packaging, xor, xor2, xor3, xor4])
