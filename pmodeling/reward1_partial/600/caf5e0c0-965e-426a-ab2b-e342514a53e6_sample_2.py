...
# Site Survey -> System Design -> Climate Sim -> Seed Select -> Module Setup -> Nutrient Mix -> Water Cycle -> Energy Link -> Sensor Install -> Pest Detect -> Growth Scan -> Data Sync -> Community Meet -> Reg Compliance -> System Test -> Maintenance Plan
root = StrictPartialOrder(nodes=[site_survey, system_design, climate_sim, seed_select, module_setup, nutrient_mix, water_cycle, energy_link, sensor_install, pest_detect, growth_scan, data_sync, community_meet, reg_compliance, system_test, maintenance_plan])
