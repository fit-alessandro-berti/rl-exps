...
xor1 = OperatorPOWL(operator=Operator.XOR, children=[field_testing, test_analysis])
xor2 = OperatorPOWL(operator=Operator.XOR, children=[software_setup, data_integration])
xor3 = OperatorPOWL(operator=Operator.XOR, children=[pilot_train, compliance_check])
xor4 = OperatorPOWL(operator=Operator.XOR, children=[fleet_deploy, remote_monitor])
xor5 = OperatorPOWL(operator=Operator.XOR, children=[maintenance_plan, performance_tune])

root = StrictPartialOrder(nodes=[client_meet, requirement_gather, module_design, supplier_vetting, component_order, prototype_build, xor1, xor2, xor3, xor4, xor5])
