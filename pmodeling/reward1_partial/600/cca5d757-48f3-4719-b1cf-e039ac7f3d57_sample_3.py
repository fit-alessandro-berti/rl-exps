...
root = StrictPartialOrder(
    nodes=[site_assess, load_testing, climate_study, medium_prep, bed_install, irrigation_setup, crop_select, pest_control, community_meet, monitor_deploy, waste_cycle, yield_forecast, market_link, workshop_plan, tech_integrate],
    order=[
        (site_assess, load_testing),
        (site_assess, climate_study),
        (load_testing, medium_prep),
        (climate_study, medium_prep),
        (medium_prep, bed_install),
        (bed_install, irrigation_setup),
        (irrigation_setup, crop_select),
        (crop_select, pest_control),
        (pest_control, community_meet),
        (community_meet, monitor_deploy),
        (monitor_deploy, waste_cycle),
        (waste_cycle, yield_forecast),
        (yield_forecast, market_link),
        (market_link, workshop_plan),
        (workshop_plan, tech_integrate)
    ]
)

# Add the edges to the partial order structure
