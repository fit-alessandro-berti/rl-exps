...
root.order.add_edge(site_review, design_plan)
...
root.order.add_edge(staff_train, packaging_dev)
root.order.add_edge(staff_train, logistics_plan)
root.order.add_edge(compliance_audit, packaging_dev)
root.order.add_edge(compliance_audit, logistics_plan)
root.order.add_edge(logistics_plan, community_engage)
root.order.add_edge(community_engage, sustainability_check)
root.order.add_edge(sustainability_check, packaging_dev)
root.order.add_edge(sustainability_check, logistics_plan)