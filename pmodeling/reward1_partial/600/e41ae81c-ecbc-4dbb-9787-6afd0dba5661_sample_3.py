...
continuous_optimization = OperatorPOWL(operator=Operator.LOOP, children=[data_analysis])

# Define the partial order
root = StrictPartialOrder(nodes=[site_survey, structure_reinforce, hydroponic_setup, climate_install, ai_integration, seed_sourcing, nutrient_prep, system_testing, staff_training, crop_planting, growth_monitor, pest_control, harvest_schedule, quality_check, market_dispatch, waste_recycle, continuous_optimization])
...
root.order.add_edge(waste_recycle, continuous_optimization)
