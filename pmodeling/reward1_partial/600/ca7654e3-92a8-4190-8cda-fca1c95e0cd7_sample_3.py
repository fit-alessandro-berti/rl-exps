...
aging_loop = OperatorPOWL(operator=Operator.LOOP, children=[aging_process, microbial_test])

# Define partial order
root = StrictPartialOrder(nodes=[milk_sourcing, curd_preparation, starter_culture, temperature_control, pressing_cheese, salting_stage, aging_loop, quality_check, eco_packaging, label_printing, inventory_audit, order_processing, retail_shipping, customer_feedback, recipe_update, market_analysis])
