...
# Note: In this simplified model, activities are not explicitly looped or XORed, but the process could be extended with these operators to represent more complex scenarios.