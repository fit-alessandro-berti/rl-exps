...
# Define the loop for recipe refinement and stability check
loop = OperatorPOWL(operator=Operator.LOOP, children=[chemical_analysis, stability_check])

# Define the partial order
root = StrictPartialOrder(nodes=[ingredient_sourcing, botanical_extraction, initial_blending, sensory_testing, loop, custom_packaging, label_design, hand_labeling, regulatory_audit, batch_documentation, limited_release, market_launch])
...
root.order.add_edge(sensory_testing, loop)
