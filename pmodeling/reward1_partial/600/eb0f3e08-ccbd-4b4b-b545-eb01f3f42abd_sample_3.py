...
loop = OperatorPOWL(operator=Operator.LOOP, children=[crop_selection, community_poll, schedule_update, harvest_plan, waste_sort, yield_report])
root = StrictPartialOrder(nodes=[sensor_setup, data_collection, weather_check, soil_testing, resource_assign, irrigation_adjust, pest_scan, nutrient_mix, growth_monitor, loop])
