...
root.order.add_edge(seed_select, climate_setup)
root.order.add_edge(nutrient_mix, light_adjust)
root.order.add_edge(nutrient_mix, co2_control)
root.order.add_edge(nutrient_mix, humidity_tune)
root.order.add_edge(climate_setup, light_adjust)
root.order.add_edge(climate_setup, co2_control)
root.order.add_edge(climate_setup, humidity_tune)
root.order.add_edge(light_adjust, growth_monitor)
root.order.add_edge(co2_control, growth_monitor)
