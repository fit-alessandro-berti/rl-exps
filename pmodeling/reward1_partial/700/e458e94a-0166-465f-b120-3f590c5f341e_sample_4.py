...
feedback_cycle = OperatorPOWL(operator=Operator.XOR, children=[Transition(label='Feedback'), SilentTransition()])
...
# Define the loop for the feedback cycle
...
# Define the dependencies in the root POWL model
