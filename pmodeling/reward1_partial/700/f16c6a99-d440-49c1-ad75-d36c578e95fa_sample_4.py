...
root = StrictPartialOrder(nodes=[
    ...
    regulatory_check, staff_training, data_configure, supply_plan, 
    harvest_schedule, quality_audit, market_launch, feedback_loop
])
...
# Print the root to see the full model
print(root)