...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[usage_track, maintenance_plan, incident_manage])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[billing_process, performance_report])

# Define the partial order
root = StrictPartialOrder(nodes=[client_onboard, needs_assess, drone_config, route_program, compliance_check, insurance_verify, lease_contract, fleet_deploy, monitor_setup, loop1, loop2, price_adjust, feedback_collect])
