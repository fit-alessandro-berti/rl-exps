...
root.order.add_edge(archive_search, age_analysis)
root.order.add_edge(archive_search, stylistic_review)
root.order.add_edge(archive_search, context_mapping)
...
root.order.add_edge(expert_interview, age_analysis)
root.order.add_edge(expert_interview, stylistic_review)
root.order.add_edge(expert_interview, context_mapping)
