...
root = StrictPartialOrder(
    nodes=[site_survey, permit_filing, structure_prep, system_install, nutrient_mix, sensor_setup, ai_calibration, 
           seed_sourcing, staff_training, energy_connect, water_cycle, growth_monitor, waste_audit, community_meet, 
           data_review, yield_forecast],
    order={
        site_survey: permit_filing,
        permit_filing: structure_prep,
        structure_prep: system_install,
        system_install: nutrient_mix,
        nutrient_mix: sensor_setup,
        sensor_setup: ai_calibration,
        ai_calibration: seed_sourcing,
        seed_sourcing: staff_training,
        staff_training: energy_connect,
        energy_connect: water_cycle,
        water_cycle: growth_monitor,
        growth_monitor: waste_audit,
        waste_audit: community_meet,
        community_meet: data_review,
        data_review: yield_forecast
    }
)
