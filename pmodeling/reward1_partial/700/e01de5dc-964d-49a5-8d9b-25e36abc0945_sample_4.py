...
root = StrictPartialOrder(
    ...
    order={
        ...
        transplant_seedlings: [mix_nutrients, adjust_pH],
        mix_nutrients: [control_humidity, co2_regulation],
        adjust_pH: [control_humidity, co2_regulation],
        control_humidity: [co2_regulation],
        co2_regulation: [detect_pests, deploy_biocontrols],
        detect_pests: [deploy_biocontrols],
        deploy_biocontrols: [schedule_harvest],
        schedule_harvest: [automate_picking],
        automate_picking: [package_produce, compost_waste],
        package_produce: [recycle_water],
