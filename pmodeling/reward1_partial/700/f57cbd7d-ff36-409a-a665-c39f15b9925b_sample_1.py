...
root = StrictPartialOrder(nodes=[
    Trend_Scan, Idea_Sprint, Feasibility_Check, Risk_Review, Tech_Prototype, Market_Simulate, Stakeholder_Align, Budget_Adjust, Talent_Source, Pilot_Launch, Data_Refine, Scale_Analysis, Integration_Plan, Change_Manage, Knowledge_Transfer
])
