...
# Define the activities as transitions with labels
...
root = StrictPartialOrder(nodes=[idea_solicitation, ai_filtering, community_voting, expert_review, prototype_build, user_testing, iterate_feedback, risk_assess, compliance_check, pilot_launch, performance_track, impact_analyze, insight_gather, cycle_adjust, final_report])

# Define the dependencies (order of execution)
