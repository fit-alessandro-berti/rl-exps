...
loop = OperatorPOWL(operator=Operator.LOOP, children=[artifact_research, ownership_verify, stakeholder_meet, legal_review, diplomatic_contact, condition_report, transport_plan, insurance_setup, customs_clear, secure_packaging, shipping_monitor])
xor = OperatorPOWL(operator=Operator.XOR, children=[community_brief, arrival_inspect, exhibit_prepare, public_release])
