...
root = StrictPartialOrder(nodes=[artifact_intake, condition_check, material_test, archival_search, style_compare, loop, xor])
...
root.order.add_edge(sales_report, loop)