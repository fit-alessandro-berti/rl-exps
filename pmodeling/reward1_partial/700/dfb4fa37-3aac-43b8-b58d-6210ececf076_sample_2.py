...
root = StrictPartialOrder(nodes=[site_analysis, permit_secutring, unit_designing, led_sourcing, hydroponic_setup, staff_hiring, pilot_cultivation, data_integration, waste_recycling, local_distribution, subscription_setup, iot_deployment, sustainability_audit, market_testing, process_refinement])

# Define the dependencies between activities
root.order.add_edge(site_analysis, permit_secutring)
root.order.add_edge(permit_secutring, unit_designing)
