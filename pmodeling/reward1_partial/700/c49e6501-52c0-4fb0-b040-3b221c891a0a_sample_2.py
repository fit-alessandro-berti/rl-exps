...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[firmware_load, calibration_run])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[stress_test])
loop3 = OperatorPOWL(operator=Operator.LOOP, children=[software_patch])
loop4 = OperatorPOWL(operator=Operator.LOOP, children=[algorithm_tune])
loop5 = OperatorPOWL(operator=Operator.LOOP, children=[comms_setup])
loop6 = OperatorPOWL(operator=Operator.LOOP, children=[validation_pass])
loop7 = OperatorPOWL(operator=Operator.LOOP, children=[data_link])
loop8 = OperatorPOWL(operator=Operator.LOOP, children=[onsite_deploy])
loop9 = OperatorPOWL(operator=Operator.LOOP, children=[live_monitor])
loop10 = OperatorPOWL(operator=Operator.LOOP, children=[update_push])
loop11 = OperatorPOWL(operator=Operator.LOOP, children=[recovery_plan])
loop12 = OperatorPOWL(operator=Operator.LOOP, children=[maintenance_log])
