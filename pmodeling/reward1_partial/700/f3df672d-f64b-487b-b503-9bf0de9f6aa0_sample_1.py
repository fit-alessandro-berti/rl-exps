...
# Define the workflow
xor1 = OperatorPOWL(operator=Operator.XOR, children=[blockchain_verify, oral_history])
xor2 = OperatorPOWL(operator=Operator.XOR, children=[historical_review, expert_panel])
...
xor5 = OperatorPOWL(operator=Operator.XOR, children=[insurance_setup, archival_update])
xor6 = OperatorPOWL(operator=Operator.XOR, children=[exhibition_prep, iot_monitoring])
xor7 = OperatorPOWL(operator=Operator.XOR, children=[re_validation, None])

root = StrictPartialOrder(nodes=[data_collection, provenance_check, xor1, xor2, xor3, xor4, xor5, xor6, xor7])
