...
root = StrictPartialOrder(
    ...
    order=[
        # Define the order dependencies here, for example:
        # (seed_selection, nutrient_mix), (nutrient_mix, planting_setup), etc.
    ]
)

# Add dependencies to the order
...
# Now, 'root' contains the POWL model for the vertical urban farm process.