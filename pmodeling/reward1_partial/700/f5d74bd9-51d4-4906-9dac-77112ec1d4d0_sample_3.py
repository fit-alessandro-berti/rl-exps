...
root = StrictPartialOrder(nodes=[
    ...
    crop_select, nutrient_mix, pest_control, sensor_install, staff_train,
    compliance_audit, packaging_dev, logistics_plan, community_engage,
...
# Optionally, you can add loops or other control flow operators as needed
# For example, a loop for the sustainability check:
# root.order.add_edge(sustainability_check, root)
