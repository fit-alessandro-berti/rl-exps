...
root = StrictPartialOrder(nodes=[
    RegulatoryCheck, PathDesign, WeatherSync, TrafficAlign, PackageSecure, CustomerAlert,
    DroneAssemble, FlightTest, DataMonitor, SafetyAudit, EmergencyPlan, MaintenancePlan,
    BatteryCycle, RouteUpdate, PerformanceReview, ImpactStudy, ComplianceReview
])
