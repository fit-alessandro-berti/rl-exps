...
root = StrictPartialOrder(nodes=[
    SiteSelect, EnvAssess, DesignModules, HydroponicsSetup, SoftwareDev, SeedChoose, LEDInstall,
    TrainStaff, ComplianceCheck, EngageCommunity, PlantCrops, MonitorGrowth, OptimizeYields, WasteManage,
