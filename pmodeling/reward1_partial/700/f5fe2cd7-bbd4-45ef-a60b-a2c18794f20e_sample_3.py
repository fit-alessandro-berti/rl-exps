...
# Define silent transitions for 'skip' and 'loop'
skip = SilentTransition()
loop = OperatorPOWL(operator=Operator.LOOP, children=[discrepancy_flag, alternative_source])

# Define the process model
root = StrictPartialOrder(nodes=[provenance_check, material_scan, radiocarbon_test, stylistic_review, expert_consult, document_audit, legal_verify, condition_report, loop, acquisition_vote, catalog_entry, exhibit_plan, final_approval])
...
root.order.add_edge(condition_report, loop)
