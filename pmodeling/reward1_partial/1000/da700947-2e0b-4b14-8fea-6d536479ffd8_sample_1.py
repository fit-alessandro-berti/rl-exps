...
# Define exclusive choice (XOR) for the following activities
xor = OperatorPOWL(operator=Operator.XOR, children=[yield_review, feedback_loop])

# Define the partial order
root = StrictPartialOrder(nodes=[site_survey, structural_audit, climate_design, lighting_setup, irrigation_plan, nutrient_mix, sensor_install, ai_calibration, pest_scan, energy_audit, renewable_sync, data_modeling, staff_briefing, compliance_check, community_meet, xor])
...
root.order.add_edge(community_meet, xor)