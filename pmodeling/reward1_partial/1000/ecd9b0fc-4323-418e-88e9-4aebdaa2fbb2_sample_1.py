...
root = StrictPartialOrder(nodes=[
    ...
    seed_selection, nutrient_mix, water_recycling, sensor_deploy, pest_control, growth_monitor, 
    harvest_plan, packaging_prep, delivery_route, data_analysis, yield_forecast
])
