...
root = StrictPartialOrder(
    nodes=[seed_selection, nutrient_mix, environment_setup, sensor_deployment, growth_monitoring, pest_detection,
           automated_harvest, quality_check, packaging_prep, biodegradable_pack, inventory_sync, demand_forecast,
           micro_fulfillment, local_dispatch, consumer_feedback, crop_adjustment],
    order={
        seed_selection: [nutrient_mix],
        nutrient_mix: [environment_setup],
        environment_setup: [sensor_deployment],
        sensor_deployment: [growth_monitoring],
        growth_monitoring: [pest_detection],
        pest_detection: [automated_harvest],
        automated_harvest: [quality_check],
        quality_check: [packaging_prep],
        packaging_prep: [biodegradable_pack],
        biodegradable_pack: [inventory_sync],
        inventory_sync: [demand_forecast],
        demand_forecast: [micro_fulfillment],
        micro_fulfillment: [local_dispatch],
        local_dispatch: [consumer_feedback],
        consumer_feedback: [crop_adjustment]
    }
)