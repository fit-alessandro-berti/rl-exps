...
# Define the XOR for the fermentation and aging processes
fermentation_aging_xor = OperatorPOWL(operator=Operator.XOR, children=[
    fermentation_start,
    aging_loop
])
...
root.order.add_edge(pH_monitoring, texture_check)
