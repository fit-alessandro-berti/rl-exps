...
root = StrictPartialOrder(
    nodes=[AssessArtifact, VerifyProvenance, AnalyzeCondition, PlanConservation,
           CleanSurface, StabilizeStructure, SourceMaterials, FabricateParts,
           PerformRepairs, ApplyPatina, MatchColors, DocumentProcess, ReviewQuality,
           ObtainApproval, PackageSecurely, ArrangeTransport]
)
