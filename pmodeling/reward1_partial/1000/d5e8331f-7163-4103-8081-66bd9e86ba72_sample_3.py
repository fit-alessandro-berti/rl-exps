...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[site_prep, seed_select, nutrient_mix, planting_rows, env_monitor, water_adjust, pest_control, growth_check, light_calibrate, energy_manage])
xor1 = OperatorPOWL(operator=Operator.XOR, children=[harvest_crop, quality_sort, pack_goods, cold_store, market_ship, data_analyze])
