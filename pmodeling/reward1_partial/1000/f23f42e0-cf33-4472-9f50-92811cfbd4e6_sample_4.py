...
# If you want to add a loop for aging, you can do it like this:
# aging_loop = OperatorPOWL(operator=Operator.LOOP, children=[aging_setup, climate_control])
# root.order.add_edge(aging_setup, climate_control)
# root.order.add_edge(climate_control, aging_setup)
# root.order.add_edge(climate_control, aging_loop)
