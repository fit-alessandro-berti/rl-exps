...
root = StrictPartialOrder(nodes=[
    SiteAssess, PlanLayout, InstallRacks, MixNutrients, CalibrateSensors,
    SetupLighting, ConfigureClimate, SelectSeeds, MonitorGerminate, ApplyBiocontrols,
    MaintainSystems, AnalyzeData, HarvestCrops, QualityCheck, PackageProduce, DistributeGoods
])
