...
root = StrictPartialOrder(nodes=[
    site_analyze, soil_enhance, seed_select, plant_precise, sensor_deploy, climate_monitor, irrigate_adjust,
    nutrient_feed, pest_control, community_engage, feedback_collect, yield_harvest, waste_sort, compost_create,
...
root.order.add_edge(soil_enhance, plant_precise)
...
root.order.add_edge(climate_monitor, pest_control)
root.order.add_edge(climate_monitor, community_engage)
root.order.add_edge(climate_monitor, feedback_collect)
root.order.add_edge(plant_precise, yield_harvest)
