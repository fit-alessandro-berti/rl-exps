...
# Create a loop for the restoration process
loop = OperatorPOWL(operator=Operator.LOOP, children=[disassembly, surface_clean, structural_repair, reconstruction, finish_match, stabilize_parts, documentation])

# Create an exclusive choice for quality validation and market analysis
xor = OperatorPOWL(operator=Operator.XOR, children=[quality_audit, market_analysis])
