...
root.order.add_edge(material_testing, expert_interview)
...
root.order.add_edge(condition_audit, forgery_detection)
...
root.order.add_edge(forgery_detection, restoration_plan)
