...
root.nodes.append(structural_check)
root.nodes.append(system_design)
root.nodes.append(hydroponics_setup)
root.nodes.append(lighting_install)
root.nodes.append(sensor_install)
root.nodes.append(climate_control)
root.nodes.append(nutrient_monitor)
root.nodes.append(seed_selection)
root.nodes.append(germination_start)
root.nodes.append(auto_planting)
root.nodes.append(growth_monitoring)
root.nodes.append(ai_analytics)
root.nodes.append(robotic_harvest)
root.nodes.append(packaging)
root.nodes.append(trace_labeling)
