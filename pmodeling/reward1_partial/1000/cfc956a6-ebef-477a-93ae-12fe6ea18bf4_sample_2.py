...
offer = Transition(label='Fractional Offer')
secondary = Transition(label='Secondary Sale')

# Define the partial order
root = StrictPartialOrder(nodes=[onboard, verify, check, deploy, monitor, adjust, link, submit, close, transfer, release, review, update, offer, secondary])
...
root.order.add_edge(update, offer)
root.order.add_edge(offer, secondary)
