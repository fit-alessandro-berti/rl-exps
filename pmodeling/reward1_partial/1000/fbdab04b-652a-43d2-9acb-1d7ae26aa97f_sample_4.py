...
root = StrictPartialOrder(nodes=[client_consult_to_spec_analysis, spec_analysis_to_module_select, module_select_to_component_order, component_order_to_parts_inspect, parts_inspect_to_frame_assemble, frame_assemble_to_sensor_install, sensor_install_to_motor_attach, motor_attach_to_wiring_connect, wiring_connect_to_software_upload, software_upload_to_calibration_test, calibration_test_to_flight_simulate, flight_simulate_to_quality_review, quality_review_to_user_train, user_train_to_remote_setup, remote_setup_to_feedback_collect, feedback_collect_to_support_schedule])
