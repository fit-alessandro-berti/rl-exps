...
xor = OperatorPOWL(operator=Operator.XOR, children=[quality_approve, skip])

# Define partial order
root = StrictPartialOrder(nodes=[farm_select, milk_test, milk_pasteurize, curd_form, whey_drain, cheese_press, salt_rub, aging_set, flavor_check, texture_scan, xor, custom_pack, cold_ship, retail_train, feedback_log, batch_adjust])
