...
root = StrictPartialOrder(nodes=[ThreatAssess, AlertDispatch, ResourceCheck, TeamMobilize, CommandSetup, IntelGather, RiskEvaluate, PrioritySet, FieldDeploy, CommSync, PublicUpdate, SupplyManage, SafetyMonitor, IncidentLog, xor])
...
root.order.add_edge(IncidentLog, xor)