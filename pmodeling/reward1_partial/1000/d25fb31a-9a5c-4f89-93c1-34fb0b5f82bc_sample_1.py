...
root.nodes.append(assess_structure)
root.nodes.append(analyze_environment)
root.nodes.append(design_modules)
root.nodes.append(procure_materials)
root.nodes.append(install_irrigation)
root.nodes.append(set_sensors)
root.nodes.append(select_seeds)
root.nodes.append(schedule_planting)
root.nodes.append(monitor_growth)
root.nodes.append(collect_data)
root.nodes.append(manage_pests)
root.nodes.append(harvest_crops)
root.nodes.append(coordinate_sales)
root.nodes.append(compost_waste)
root.nodes.append(review_feedback)
