...
flavor_loop = OperatorPOWL(operator=Operator.LOOP, children=[flavor_profiling, sensory_review, texture_inspect])

# Define partial order
root = StrictPartialOrder(nodes=[milk_sourcing, culture_prep, milk_pasteurize, coagulation, curd_cutting, whey_draining, hand_molding, pressing, salting, rind_treatment, aging_loop, flavor_loop, eco_packaging, batch_labeling, blockchain_log, niche_shipping])
...
root.order.add_edge(flavor_loop, eco_packaging)
