...
# Define the loop for the ideation process
ideation_loop = OperatorPOWL(operator=Operator.LOOP, children=[idea_workshop, concept_merge])
...
root.order.add_edge(opportunity_scan, ideation_loop)
root.order.add_edge(ideation_loop, resource_align)
