...
# Optionally, you can add loops for more complex scenarios
# For example, a loop for bottling and distribution could be added here
# root.order.add_edge(packaging_final, market_launch, loop=True)
