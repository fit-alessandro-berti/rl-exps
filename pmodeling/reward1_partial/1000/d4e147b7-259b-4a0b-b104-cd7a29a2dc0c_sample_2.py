...
root = StrictPartialOrder(nodes=[
    artifact_intake, visual_scan, material_test, radiocarbon_check, provenance_search,
    archive_review, expert_consult, microscope_exam, infrared_scan, legal_verify,
    condition_report, digital_catalog, ownership_audit, restoration_plan, final_approval,
    authentication_cert
])
...
root.order.add_edge(visual_scan, microscope_exam)
root.order.add_edge(material_test, microscope_exam)
root.order.add_edge(radiocarbon_check, microscope_exam)
