...
xor6 = OperatorPOWL(operator=Operator.XOR, children=[condition_report, SilentTransition()])

# Define the partial order
root = StrictPartialOrder(nodes=[provenance_check, material_testing, stylistic_review, expert_panel, xor1, xor2, xor3, xor4, xor5, xor6])
...
root.order.add_edge(expert_panel, xor1)
root.order.add_edge(legal_clearance, xor2)
root.order.add_edge(ethics_audit, xor2)
root.order.add_edge(xor2, xor3)
root.order.add_edge(insurance_quote, xor3)
root.order.add_edge(risk_assess, xor3)
root.order.add_edge(xor3, xor4)
root.order.add_edge(digital_archive, xor4)
root.order.add_edge(replica_build, xor4)
root.order.add_edge(xor4, xor5)
root.order.add_edge(transport_prep, xor5)
root.order.add_edge(final_review, xor5)
root.order.add_edge(xor5, xor6)
root.order.add_edge(catalog_entry, xor6)
root.order.add_edge(public_notice, xor6)
root.order.add_edge(condition_report, xor6)