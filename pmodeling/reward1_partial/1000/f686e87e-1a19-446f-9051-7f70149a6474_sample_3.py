...
# Define the partial order for the certification audit
certification_audit_loop = OperatorPOWL(operator=Operator.LOOP, children=[certification_audit, recipe_adjustment])
root.order.add_edge(certification_audit, certification_audit_loop)
root.order.add_edge(certification_audit_loop, recipe_adjustment)
