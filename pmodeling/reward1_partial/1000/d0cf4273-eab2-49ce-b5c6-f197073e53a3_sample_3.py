...
root = StrictPartialOrder(nodes=[
    sourcing, verify, transport, storytelling, crafting, creation, catalog, marketing, targeting,
    package, cooperation, audit, logistics, shipping, feedback
])
...
root.order.add_edge(package, cooperation)
root.order.add_edge(cooperation, audit)
