...
root = StrictPartialOrder(nodes=[
    ProvenanceCheck, MaterialScan, WearAnalysis, ImageCapture, PatternMatch, OwnershipVerify, EthicsReview, 
    CarbonDating, RestorationEval, ReportDraft, StakeholderReview, ArchiveData, ExhibitApprove, ConditionMonitor, FinalCertification
])

# Define the dependencies
root.order.add_edge(ProvenanceCheck, MaterialScan)
root.order.add_edge(ProvenanceCheck, WearAnalysis)
root.order.add_edge(MaterialScan, ImageCapture)
root.order.add_edge(WearAnalysis, PatternMatch)
