...
hydro_install = Transition(label='Install Hydro')
...
root = StrictPartialOrder(nodes=[site_survey, climate_plan, system_design, ai_setup, seed_sourcing, nutrient_mix, hydro_install, energy_audit, staff_training, trial_growth, yield_measure, waste_cycle, compliance_check, market_study, community_meet, optimize_environment])
...
root.order.add_edge(nutrient_mix, hydro_install)
root.order.add_edge(hydro_install, energy_audit)
