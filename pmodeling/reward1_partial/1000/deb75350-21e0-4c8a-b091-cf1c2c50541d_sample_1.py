...
root = StrictPartialOrder(nodes=[intake_review, visual_inspect, material_test, provenance_check, archival_search, expert_consult, digital_scan, condition_report, forger_assess, legal_review, risk_analysis, acquisition_vote, catalog_entry, storage_prep, final_approval])
...
root.order.add_edge(expert_consult, forger_assess)
root.order.add_edge(digital_scan, condition_report)
root.order.add_edge(digital_scan, forger_assess)
root.order.add_edge(condition_report, legal_review)
root.order.add_edge(condition_report, risk_analysis)
root.order.add_edge(forger_assess, legal_review)
root.order.add_edge(forger_assess, risk_analysis)
root.order.add_edge(legal_review, acquisition_vote)
...
root.order.add_edge(final_approval, None)  # Assuming final approval is the end of the process
