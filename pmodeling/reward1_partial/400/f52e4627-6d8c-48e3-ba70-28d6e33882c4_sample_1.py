...
partial_order = OperatorPOWL(operator=Operator.PARTIAL_ORDER, children=[
    farm_visit,
    quality_cupping,
...
# Add the partial order to the root
root.nodes.append(partial_order)
...
root.order.add_edge(quality_cupping, price_negotiate)
root.order.add_edge(sustainability_audit, contract_draft)
root.order.add_edge(contract_draft, sample_testing)
