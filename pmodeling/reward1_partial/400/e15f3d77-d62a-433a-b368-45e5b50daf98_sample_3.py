...
root = StrictPartialOrder(nodes=[GatherSpecs, AdaptDesign, SourceParts, ComponentTest, AssembleFrame, InstallFirmware, CalibrateSensors, StressTest, FlightSimulate, ValidateBattery, CheckAccuracy, PackageUnits, CreateManuals, ShipDrones, CollectFeedback])
