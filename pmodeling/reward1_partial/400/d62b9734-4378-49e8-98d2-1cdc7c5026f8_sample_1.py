...
root = StrictPartialOrder(nodes=[provenance_check_to_image_capture, image_capture_to_material_scan, material_scan_to_expert_review, expert_review_to_historical_cross, historical_cross_to_legal_verify, legal_verify_to_registry_search, registry_search_to_customs_clear, customs_clear_to_condition_assess, condition_assess_to_data_log, data_log_to_chain_custody, chain_custody_to_report_draft, report_draft_to_certification, certification_to_secure_archive, secure_archive_to_auction_prep])
