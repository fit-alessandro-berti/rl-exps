...
root.order.add_edge(climate_check, design_layout)
...
root.order.add_edge(hydro_setup, stakeholder_meet)
root.order.add_edge(hydro_setup, community_train)
root.order.add_edge(nutrient_mix, plant_seed)
root.order.add_edge(nutrient_mix, monitor_growth)
root.order.add_edge(nutrient_mix, adjust_controls)
root.order.add_edge(sensor_install, monitor_growth)
root.order.add_edge(sensor_install, adjust_controls)
root.order.add_edge(monitor_growth, harvest_plan)
root.order.add_edge(monitor_growth, waste_recycle)
root.order.add_edge(monitor_growth, feedback_loop)
root.order.add_edge(adjust_controls, harvest_plan)
root.order.add_edge(adjust_controls, waste_recycle)
root.order.add_edge(adjust_controls, feedback_loop)
