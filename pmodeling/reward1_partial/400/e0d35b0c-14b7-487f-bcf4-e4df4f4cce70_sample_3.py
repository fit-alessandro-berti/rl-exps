...
# Partial order
root = StrictPartialOrder(nodes=[site_survey, structural_check, resource_sourcing, system_install, lighting_setup, irrigation_setup, stakeholder_activities, regulation_activities, planting_phase, climate_control, growth_monitor, data_logging, harvest_event, waste_manage, feedback_collect])
...
root.order.add_edge(irrigation_setup, stakeholder_activities)
root.order.add_edge(stakeholder_activities, regulation_activities)
