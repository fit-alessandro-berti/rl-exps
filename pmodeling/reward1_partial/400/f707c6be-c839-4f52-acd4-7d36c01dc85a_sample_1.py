...
# Define the dependencies (POW) between the activities
...
root.order.add_edge(multi_spectral_scan, database_match)
root.order.add_edge(multi_spectral_scan, provenance_check)
