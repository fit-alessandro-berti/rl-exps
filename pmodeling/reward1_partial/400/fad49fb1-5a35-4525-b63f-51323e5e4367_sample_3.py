...
root = StrictPartialOrder(nodes=[
    site_survey, design_modules, source_materials, install_framework,
    setup_irrigation, integrate_sensors, configure_ai, select_crops,
    calibrate_climate, plant_seeds, monitor_growth, manage_pests,
    recycle_waste, engage_community, ensure_compliance, distribute_produce
])

# Define the dependencies between activities
root.order.add_edge(site_survey, design_modules)
root.order.add_edge(site_survey, source_materials)
root.order.add_edge(design_modules, install_framework)
root.order.add_edge(design_modules, setup_irrigation)
root.order.add_edge(source_materials, integrate_sensors)
root.order.add_edge(source_materials, configure_ai)
root.order.add_edge(install_framework, select_crops)
root.order.add_edge(setup_irrigation, calibrate_climate)
root.order.add_edge(select_crops, plant_seeds)
