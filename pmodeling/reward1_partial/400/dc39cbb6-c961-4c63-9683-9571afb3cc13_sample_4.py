...
root = StrictPartialOrder(nodes=[
    client_inquiry, req_gather, concept_sketch, client_feedback, rev_cycle,
    final_approval, art_creation, progress_update, quality_check, final_adjust,
    invoice_issue, shipment_prep, delivery_confirm, post_support, license_setup,
    frame_arrange
])
...
root.order.add_edge(client_feedback, rev_cycle)
root.order.add_edge(rev_cycle, final_approval)
