...
root.order.add_edge(condition_check, forgeries_scan)
...
root.order.add_edge(material_test, forgeries_scan)
...
root.order.add_edge(style_compare, forgeries_scan)
...
root.order.add_edge(carbon_dating, forgeries_scan)
...
root.order.add_edge(document_review, forgeries_scan)
...
root.order.add_edge(forgeries_scan, historical_research)
root.order.add_edge(forgeries_scan, panel_review)
root.order.add_edge(forgeries_scan, report_draft)
root.order.add_edge(forgeries_scan, final_approval)
root.order.add_edge(forgeries_scan, catalog_entry)
