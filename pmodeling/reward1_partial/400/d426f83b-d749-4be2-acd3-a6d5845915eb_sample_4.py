...
root.order.add_edge(material_sampling, peer_review)
root.order.add_edge(radiocarbon_test, peer_review)
root.order.add_edge(style_compare, peer_review)
root.order.add_edge(historical_search, peer_review)
root.order.add_edge(expert_consult, peer_review)
root.order.add_edge(condition_review, peer_review)
