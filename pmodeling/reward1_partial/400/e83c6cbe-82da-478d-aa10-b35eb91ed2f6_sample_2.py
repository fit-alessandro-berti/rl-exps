...
root.order.add_edge(material_testing, replica_build)
root.order.add_edge(material_testing, transport_prep)
root.order.add_edge(material_testing, final_review)
root.order.add_edge(material_testing, catalog_entry)
root.order.add_edge(material_testing, public_notice)
root.order.add_edge(material_testing, condition_report)
root.order.add_edge(stylistic_review, digital_archive)
root.order.add_edge(stylistic_review, replica_build)
root.order.add_edge(stylistic_review, transport_prep)
root.order.add_edge(stylistic_review, final_review)
root.order.add_edge(stylistic_review, catalog_entry)
root.order.add_edge(stylistic_review, public_notice)
root.order.add_edge(stylistic_review, condition_report)
root.order.add_edge(expert_panel, digital_archive)
root.order.add_edge(expert_panel, replica_build)
root.order.add_edge(expert_panel, transport_prep)
root.order.add_edge(expert_panel, final_review)
root.order.add_edge(expert_panel, catalog_entry)
root.order.add_edge(expert_panel, public_notice)
root.order.add_edge(expert_panel, condition_report)
root.order.add_edge(legal_clearance, digital_archive)
root.order.add_edge(legal_clearance, replica_build)
root.order.add_edge(legal_clearance, transport_prep)
root.order.add_edge(legal_clearance, final_review)
root.order.add_edge(legal_clearance, catalog_entry)
root.order.add_edge(legal_clearance, public_notice)
root.order.add_edge(legal_clearance, condition_report)
root.order.add_edge(ethics_audit, digital_archive)
root.order.add_edge(ethics_audit, replica_build)
root.order.add_edge(ethics_audit, transport_prep)
root.order.add_edge(ethics_audit, final_review)
root.order.add_edge(ethics_audit, catalog_entry)
root.order.add_edge(ethics_audit, public_notice)
root.order.add_edge(ethics_audit, condition_report)
root.order.add_edge(insurance_quote, digital_archive)
root.order.add_edge(insurance_quote, replica_build)
root.order.add_edge(insurance_quote, transport_prep)
root.order.add_edge(insurance_quote, final_review)
root.order.add_edge(insurance_quote, catalog_entry)
root.order.add_edge(insurance_quote, public_notice)
root.order.add_edge(insurance_quote, condition_report)
root.order.add_edge(risk_assess, digital_archive)
root.order.add_edge(risk_assess, replica_build)
...
root.order.add_edge(replica_build, catalog_entry)
root.order.add_edge(replica_build, public_notice)
root.order.add_edge(replica_build, condition_report)
