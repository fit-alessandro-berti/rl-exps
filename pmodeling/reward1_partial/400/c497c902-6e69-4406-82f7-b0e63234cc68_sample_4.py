...
xor = OperatorPOWL(operator=Operator.XOR, children=[customs_liaison, insurance_setup])
root = StrictPartialOrder(nodes=[artist_check, provenance_scan, document_review, material_test, pigment_analysis, pattern_detect, fraud_screening, legal_compliance, xor, transport_plan, condition_report, exhibition_prep, final_certify, stakeholder_notify])
...
root.order.add_edge(xor, transport_plan)
