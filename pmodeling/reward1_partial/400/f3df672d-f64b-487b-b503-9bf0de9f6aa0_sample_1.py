...
# Define operators
xor = OperatorPOWL(operator=Operator.XOR, children=[archival_update, insurance_setup])
loop = OperatorPOWL(operator=Operator.LOOP, children=[exhibition_prep, iot_monitoring, re_validation])

# Create the root POWL model
root = StrictPartialOrder(nodes=[data_collection, provenance_check, material_scan, historical_review, expert_panel, blockchain_verify, oral_history, condition_report, legal_review, certification, xor, loop])
...
root.order.add_edge(certification, xor)
