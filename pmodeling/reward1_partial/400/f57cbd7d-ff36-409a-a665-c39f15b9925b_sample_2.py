...
root = StrictPartialOrder(nodes=[
    activities['Trend Scan'],
    activities['Idea Sprint'],
    activities['Feasibility Check'],
    activities['Risk Review'],
    activities['Tech Prototype'],
    activities['Market Simulate'],
    activities['Stakeholder Align'],
    activities['Budget Adjust'],
    activities['Talent Source'],
    activities['Pilot Launch'],
    activities['Data Refine'],
    activities['Scale Analysis'],
    activities['Integration Plan'],
    activities['Change Manage'],
