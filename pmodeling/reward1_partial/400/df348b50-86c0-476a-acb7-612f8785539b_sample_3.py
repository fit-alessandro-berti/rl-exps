...
# Define the process flow using POWL model
root = StrictPartialOrder(nodes=[
    material_sourcing, botanical_harvest, extraction_phase, accord_blending, olfactory_testing,
    aging_process, stability_check, sensory_panel, label_design, bottle_crafting, batch_mixing,
    quality_review, packaging_final, market_launch
])
...
root.order.add_edge(packaging_final, market_launch)
