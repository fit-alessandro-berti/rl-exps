...
# Define the root POWL model with its dependencies
root = StrictPartialOrder(nodes=[
    material_sourcing, supplier_vetting, design_review, prototype_build, quality_audit,
    batch_scheduling, handcrafting, packaging_design, custom_labeling, sustainability_check,
    inventory_sync, market_analysis, order_aggregation, distribution_plan, customer_feedback
])

# Define the dependencies between the activities (in a real-world scenario, this would be more complex)
# For simplicity, let's assume a linear flow for now
