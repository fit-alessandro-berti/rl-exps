...
root = StrictPartialOrder(nodes=[milk_sourcing, culture_blending, milk_pasteurize, curd_cutting, whey_drain, mold_inoculate, press_cheese, salt_brine, age_monitor, quality_test, packaging_prep, label_design, order_allocation, transport_arrange, retail_sync, customer_review, feedback_analyze])

# Define the dependencies
root.order.add_edge(milk_sourcing, culture_blending)
root.order.add_edge(milk_sourcing, milk_pasteurize)
root.order.add_edge(culture_blending, curd_cutting)
