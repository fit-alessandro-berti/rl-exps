...
xor = OperatorPOWL(operator=Operator.XOR, children=[investigation_flag, skip])

root = StrictPartialOrder(nodes=[artifact_intake, provenance_check, material_scan, style_compare, digital_capture, expert_review, database_search, legal_audit, cultural_assess, data_synthesis, report_draft, archival_store, display_approve, lender_notify, xor])
...
root.order.add_edge(lender_notify, xor)
