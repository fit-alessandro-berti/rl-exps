...
feedback_loop = OperatorPOWL(operator=Operator.LOOP, children=[initial_testing, flight_calibrate, payload_mount, stress_testing])
...
root.order.add_edge(feedback_loop, stress_testing)
