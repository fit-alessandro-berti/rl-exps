...
root = StrictPartialOrder(nodes=[
    BrandAudit, EquityReview, MarketAnalysis, LegalClearance, TrademarkCheck,
    PortfolioMerge, CustomerSync, CulturalAlign, InternalBrief, CampaignDesign,
    ResourcePlan, StakeholderMeet, LaunchPrep, FeedbackLoop, PerformanceTrack
])
