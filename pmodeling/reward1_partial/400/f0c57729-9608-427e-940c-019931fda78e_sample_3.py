...
root = StrictPartialOrder(nodes=[
    inquiry, consultation, concept_draft, feedback, contract, artist_match, material_sourcing, ethics, progress,
    milestone, quality, copyright, packaging, shipping, post_delivery, survey
])
