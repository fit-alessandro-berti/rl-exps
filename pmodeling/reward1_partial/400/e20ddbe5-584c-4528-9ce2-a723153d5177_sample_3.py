...
root = StrictPartialOrder(nodes=[
    ...
    pest_control, monitor_growth, adjust_systems, harvest_crops, package_produce,
...
root.order.add_edge(create_schedule, monitor_growth)
root.order.add_edge(create_schedule, adjust_systems)
...
root.order.add_edge(monitor_growth, package_produce)
root.order.add_edge(adjust_systems, harvest_crops)
root.order.add_edge(adjust_systems, package_produce)
