...
xor = OperatorPOWL(operator=Operator.XOR, children=[recycle_waste, audit_systems])

root = StrictPartialOrder(nodes=[site_assess, zoning_check, design_farm, procure_gear, install_systems, setup_sensors, select_crops, prepare_seeds, mix_nutrients, monitor_growth, adjust_climate, robotic_harvest, grade_quality, pack_produce, manage_logistics, market_products, xor])
...
root.order.add_edge(market_products, xor)