...
root = StrictPartialOrder(
    nodes=[patent_scouting, technical_review, legal_audit, market_analysis,
           valuation_modeling, risk_assessment, license_targeting,
           buyer_outreach, negotiation_phase, contract_drafting,
           approval_process, portfolio_tracking, revenue_monitoring,
           compliance_check, innovation_scan, renewal_management],
    order={patent_scouting: technical_review, technical_review: legal_audit,
           legal_audit: market_analysis, market_analysis: valuation_modeling,
           valuation_modeling: risk_assessment, risk_assessment: license_targeting,
           license_targeting: buyer_outreach, buyer_outreach: negotiation_phase,
           negotiation_phase: contract_drafting, contract_drafting: approval_process,
           approval_process: portfolio_tracking, portfolio_tracking: revenue_monitoring,
           revenue_monitoring: compliance_check, compliance_check: innovation_scan,
