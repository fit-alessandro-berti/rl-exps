...
ingredient_sourcing_to_botanical_extraction = OperatorPOWL(operator=Operator.XOR, children=[ingredient_sourcing, botanical_extraction])
botanical_extraction_to_initial_blending = OperatorPOWL(operator=Operator.XOR, children=[botanical_extraction, initial_blending])
initial_blending_to_sensory_testing = OperatorPOWL(operator=Operator.XOR, children=[initial_blending, sensory_testing])
sensory_testing_to_chemical_analysis = OperatorPOWL(operator=Operator.XOR, children=[sensory_testing, chemical_analysis])
chemical_analysis_to_recipe_refinement = OperatorPOWL(operator=Operator.XOR, children=[chemical_analysis, recipe_refinement])
recipe_refinement_to_stability_check = OperatorPOWL(operator=Operator.XOR, children=[recipe_refinement, stability_check])
stability_check_to_client_sampling = OperatorPOWL(operator=Operator.XOR, children=[stability_check, client_sampling])
client_sampling_to_feedback_review = OperatorPOWL(operator=Operator.XOR, children=[client_sampling, feedback_review])
feedback_review_to_final_adjustment = OperatorPOWL(operator=Operator.XOR, children=[feedback_review, final_adjustment])
final_adjustment_to_custom_packaging = OperatorPOWL(operator=Operator.XOR, children=[final_adjustment, custom_packaging])
custom_packaging_to_label_design = OperatorPOWL(operator=Operator.XOR, children=[custom_packaging, label_design])
label_design_to_hand_labeling = OperatorPOWL(operator=Operator.XOR, children=[label_design, hand_labeling])
hand_labeling_to_regulatory_audit = OperatorPOWL(operator=Operator.XOR, children=[hand_labeling, regulatory_audit])
regulatory_audit_to_batch_documentation = OperatorPOWL(operator=Operator.XOR, children=[regulatory_audit, batch_documentation])
batch_documentation_to_limited_release = OperatorPOWL(operator=Operator.XOR, children=[batch_documentation, limited_release])
limited_release_to_market_launch = OperatorPOWL(operator=Operator.XOR, children=[limited_release, market_launch])
