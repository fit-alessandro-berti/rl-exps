...
root.order.add_edge(ReceiveArtifact, RadiocarbonTest)
root.order.add_edge(ReceiveArtifact, SpectroscopyScan)
root.order.add_edge(ConditionLog, ExpertConsult)
root.order.add_edge(ConditionLog, ArchiveSearch)
...
root.order.add_edge(ArchiveSearch, ProvenanceCheck)
