...
root = StrictPartialOrder(nodes=[
    SiteSurvey, ImpactStudy, StructureCheck, SoilTesting, SystemDesign, SeedSelection, IrrigationSetup, LightingInstall, PestControl, CommunityMeet, RegulationReview, WastePlan, CropMonitor, HarvestPrep, MarketLaunch
])
