...
xor = OperatorPOWL(operator=Operator.XOR, children=[optimize_environment, SilentTransition()])

root = StrictPartialOrder(nodes=[site_survey, climate_plan, system_design, ai_setup, seed_sourcing, nutrient_mix, install_hydro, energy_audit, staff_training, trial_growth, yield_measure, waste_cycle, compliance_check, market_study, community_meet, xor])
