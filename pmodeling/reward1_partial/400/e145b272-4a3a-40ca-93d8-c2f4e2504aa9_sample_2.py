...
root = StrictPartialOrder(nodes=[site_survey_to_system_design, system_design_to_permit_filing, permit_filing_to_modular_build, modular_build_to_sensor_install, sensor_install_to_climate_setup, climate_setup_to_nutrient_mix, nutrient_mix_to_waste_setup, waste_setup_to_iot_deploy, iot_deploy_to_ai_scheduling, ai_scheduling_to_energy_audit, energy_audit_to_compliance_check, compliance_check_to_crop_planting, crop_planting_to_yield_monitor, yield_monitor_to_data_analysis, data_analysis_to_system_upgrade])
