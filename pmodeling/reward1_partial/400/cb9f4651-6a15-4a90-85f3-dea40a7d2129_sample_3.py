...
aging_loop = OperatorPOWL(operator=Operator.LOOP, children=[aging_setup, humidity_control, temperature_monitor, quality_test])
feedback_choice = OperatorPOWL(operator=Operator.XOR, children=[packaging, order_fulfill])

# Define the root POWL model
root = StrictPartialOrder(nodes=[milk_sourcing, culture_prep, milk_pasturize, milk_inoculate, curd_formation, curd_cut, whey_drain, mold_inoculate, press_cheese, aging_loop, feedback_choice])
...
root.order.add_edge(aging_loop, feedback_choice)
