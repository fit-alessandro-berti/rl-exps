...
roast_profile = Transition(label='Roast Profiling')
...
root = StrictPartialOrder(nodes=[farm_sourcing, lot_selection, bean_sorting, fermentation, drying_process, quality_control, chemical_testing, sensory_analysis, roast_profile, eco_packaging, traceability_qr, cold_transport, env_monitoring, customer_feedback, subscription_adjust])
...
root.order.add_edge(sensory_analysis, roast_profile)
root.order.add_edge(roast_profile, eco_packaging)
