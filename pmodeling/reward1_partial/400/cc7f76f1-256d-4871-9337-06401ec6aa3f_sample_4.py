...
# For example, to represent a decision point without an activity
# silent_decision = SilentTransition()
# root.order.add_edge(risk_assess, silent_decision)
# root.order.add_edge(silent_decision, behavior_scan)
# root.order.add_edge(silent_decision, network_monitor)