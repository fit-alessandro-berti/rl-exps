...
nodes = [LoadAssess, PermitReview, SiteSurvey, DesignLayout, SoilMix, InstallBeds, IrrigationSet, ClimateTest, SensorDeploy, EnergySetup, CropSelect, PlantSeeding, CommunityMeet, ComplianceCheck, GrowthMonitor, HarvestPlan, WasteRecycle]
