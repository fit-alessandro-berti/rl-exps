...
root.order.add_edge(soil_enhance, climate_monitor)
root.order.add_edge(soil_enhance, irrigate_adjust)
root.order.add_edge(soil_enhance, nutrient_feed)
root.order.add_edge(soil_enhance, pest_control)
...
root.order.add_edge(pest_control, feedback_collect)
...
root.order.add_edge(yield_harvest, compost_create)
