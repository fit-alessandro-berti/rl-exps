...
loop = OperatorPOWL(operator=Operator.LOOP, children=[climate_control, water_cycling, growth_monitoring])
data_loop = OperatorPOWL(operator=Operator.LOOP, children=[data_analysis, xor])
harvest_loop = OperatorPOWL(operator=Operator.LOOP, children=[harvest_planning, crop_harvest, yield_sorting])
distribution_loop = OperatorPOWL(operator=Operator.LOOP, children=[packaging_prep, distribution_plan])
regulation_loop = OperatorPOWL(operator=Operator.LOOP, children=[waste_recycling, system_maintenance])
...
root.order.add_edge(growth_monitoring, harvest_planning)
