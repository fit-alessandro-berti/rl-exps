...
root = StrictPartialOrder(nodes=[
    site_survey, structure_assess, system_design, crop_select, permit_obtain, enviro_setup, irrigation_plan,
    sensor_install, ai_calibration, staff_train, nutrient_mix, pest_monitor, yield_analyze, market_align, launch_farm
])
