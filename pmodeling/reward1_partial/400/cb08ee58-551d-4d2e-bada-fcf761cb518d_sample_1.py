...
system_testing_loop = OperatorPOWL(operator=Operator.LOOP, children=[system_testing, yield_analysis, resource_audit])

# Define the root partial order
root = StrictPartialOrder(nodes=[site_survey_loop, module_design_loop, climate_control_loop, energy_audit_loop, system_testing_loop, community_meet, impact_review])
...
root.order.add_edge(energy_audit_loop, system_testing_loop)
root.order.add_edge(system_testing_loop, community_meet)
