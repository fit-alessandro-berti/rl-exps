...
# Define the transitions (activities) as nodes
...
# Define the transitions as children of other transitions
# For example, 'Material Sampling' can be a child of 'Artifact Intake'
# and 'Radiocarbon Test' can be a child of 'Material Sampling'
# and so on...

# Define the partial order structure
root = StrictPartialOrder(nodes=[artifact_intake, condition_check, material_sampling, radiocarbon_test, provenance_review, imaging_capture, chemical_analysis, historical_match, expert_consult, forgery_scan, market_survey, value_estimate, certification, digital_archive, final_storage])
...
root.order.add_edge(expert_consult, forgery_scan)
root.order.add_edge(forgery_scan, market_survey)
