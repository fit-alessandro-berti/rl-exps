...
# Define the exclusive choice for regulatory audit
regulatory_audit_choice = OperatorPOWL(operator=Operator.XOR, children=[regulatory_audit, SilentTransition()])
...
root.order.add_edge(event_coordination, regulatory_audit_choice)
