...
xor = OperatorPOWL(operator=Operator.XOR, children=[seasonal_review])
root = StrictPartialOrder(nodes=[material_sourcing, forager_dispatch, authenticity_check, batch_scheduling, artisan_allocation, craft_assembly, quality_inspection, blockchain_update, demand_forecast, price_adjustment, compliance_review, logistics_planning, distributor_sync, customer_feedback, product_refinement, reputation_audit, xor])
...
root.order.add_edge(forager_dispatch, artisan_allocation)
root.order.add_edge(authenticity_check, blockchain_update)
...
root.order.add_edge(seasonal_review, xor)