...
root = StrictPartialOrder(nodes=[initial_review, provenance_check, material_test, expert_consult, database_search, condition_report, risk_assess, market_analysis, stakeholder_meet, legal_review, insurance_quote, price_negotiation, contract_draft, final_approval, asset_registration])
...
root.order.add_edge(database_search, market_analysis)
root.order.add_edge(condition_report, market_analysis)
