...
# Add the dependencies (edges) between nodes
...
root.order.add_edge(archive_search, law_consult)
root.order.add_edge(archive_search, forgeries_detect)
root.order.add_edge(expert_review, database_cross)
root.order.add_edge(expert_review, law_consult)
root.order.add_edge(expert_review, forgeries_detect)
root.order.add_edge(three_d_scanning, database_cross)
root.order.add_edge(three_d_scanning, forgeries_detect)
root.order.add_edge(wear_analysis, database_cross)
root.order.add_edge(wear_analysis, forgeries_detect)
root.order.add_edge(database_cross, certification)
root.order.add_edge(database_cross, document_prep)
root.order.add_edge(database_cross, client_brief)
root.order.add_edge(law_consult, certification)
root.order.add_edge(law_consult, document_prep)
root.order.add_edge(law_consult, client_brief)
root.order.add_edge(forgeries_detect, certification)
root.order.add_edge(forgeries_detect, document_prep)
root.order.add_edge(forgeries_detect, client_brief)
root.order.add_edge(certification, secure_storage)
root.order.add_edge(certification, risk_assessment)
root.order.add_edge(document_prep, secure_storage)
root.order.add_edge(document_prep, risk_assessment)
root.order.add_edge(client_brief, secure_storage)
root.order.add_edge(client_brief, risk_assessment)
