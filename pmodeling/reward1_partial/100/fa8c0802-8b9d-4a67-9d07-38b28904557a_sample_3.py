...
root = StrictPartialOrder(
    ...
    order={
        ...
        anomaly_detect: [risk_assess],
        risk_assess: [demand_model],
        demand_model: [stakeholder_sync],
        stakeholder_sync: [auto_negotiate],
        auto_negotiate: [inventory_optimize],
        inventory_optimize: [contingency_plan],
        contingency_plan: [resource_allocate],
        resource_allocate: [sustainability_check],
        sustainability_check: [compliance_verify],
