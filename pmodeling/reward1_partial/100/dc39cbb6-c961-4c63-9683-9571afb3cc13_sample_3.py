...
loop_revision = OperatorPOWL(operator=Operator.LOOP, children=[concept_sketch, client_feedback, revision_cycle])
xor_post_support = OperatorPOWL(operator=Operator.XOR, children=[post_support, license_setup, frame_arrange])
...
root.order.add_edge(revision_cycle, concept_sketch)
root.order.add_edge(concept_sketch, final_approval)
...
root.order.add_edge(delivery_confirm, xor_post_support)
