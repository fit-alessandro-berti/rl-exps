...
root = StrictPartialOrder(nodes=[milk_sourcing, quality_testing, starter_culture, coagulation, curd_cutting, whey_draining, molding_cheese, pressing_block, brining_bath, aging_loop, demand_forecast, marketing_choice])
...
root.order.add_edge(aging_loop, demand_forecast)
root.order.add_edge(demand_forecast, marketing_choice)
root.order.add_edge(marketing_choice, retail_outreach)
root.order.add_edge(marketing_choice, customer_feedback)