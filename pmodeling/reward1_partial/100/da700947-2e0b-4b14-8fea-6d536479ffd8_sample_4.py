...
root = StrictPartialOrder(nodes=[
    ...
    nutrient_mix, sensor_install, ai_calibration, pest_scan, energy_audit,
    renewable_sync, data_modeling, staff_briefing, compliance_check, community_meet,
    yield_review, feedback_loop
])
