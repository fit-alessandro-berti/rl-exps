...
# Define the partial order (workflow) with transitions and dependencies
...
# Add the dependencies between transitions (workflow)
root.order.add_edge(site_survey, design_layout)
root.order.add_edge(site_survey, material_sourcing)
root.order.add_edge(design_layout, unit_assembly)
...
# Print the final root of the POWL model
print(root)