...
root.order.add_edge(supplier_audit, quality_review)
root.order.add_edge(credential_verify, artisan_assign)
root.order.add_edge(artisan_assign, batch_scheduling)
root.order.add_edge(batch_scheduling, production_sync)
root.order.add_edge(production_sync, shipping_plan)
root.order.add_edge(production_sync, compliance_check)
root.order.add_edge(production_sync, feedback_loop)
