...
root = StrictPartialOrder(
    nodes=[SiteAssess, LoadTesting, ClimateStudy, MediumPrep, BedInstall, IrrigationSetup, CropSelect, PestControl, CommunityMeet, MonitorDeploy, WasteCycle, YieldForecast, MarketLink, WorkshopPlan, TechIntegrate],
    order={
        SiteAssess: LoadTesting,
        SiteAssess: ClimateStudy,
        ClimateStudy: MediumPrep,
        ClimateStudy: IrrigationSetup,
        MediumPrep: CropSelect,
        MediumPrep: PestControl,
        IrrigationSetup: CropSelect,
        IrrigationSetup: PestControl,
        CropSelect: PestControl,
        PestControl: CommunityMeet,
        PestControl: MonitorDeploy,
        CommunityMeet: MonitorDeploy,
        CommunityMeet: WorkshopPlan,
        MonitorDeploy: WasteCycle,
        MonitorDeploy: YieldForecast,
        MonitorDeploy: TechIntegrate,
        WasteCycle: YieldForecast,
        WasteCycle: TechIntegrate,
        YieldForecast: MarketLink,
        YieldForecast: TechIntegrate,
        TechIntegrate: MarketLink
    }
)
...
root.order.add_edge(ClimateStudy, IrrigationSetup)
root.order.add_edge(MediumPrep, CropSelect)
root.order.add_edge(MediumPrep, PestControl)
...
root.order.add_edge(PestControl, MonitorDeploy)
root.order.add_edge(CommunityMeet, MonitorDeploy)
root.order.add_edge(CommunityMeet, WorkshopPlan)
root.order.add_edge(MonitorDeploy, WasteCycle)
root.order.add_edge(MonitorDeploy, YieldForecast)
root.order.add_edge(MonitorDeploy, TechIntegrate)
root.order.add_edge(WasteCycle, YieldForecast)
root.order.add_edge(WasteCycle, TechIntegrate)
root.order.add_edge(YieldForecast, MarketLink)
root.order.add_edge(YieldForecast, TechIntegrate)
