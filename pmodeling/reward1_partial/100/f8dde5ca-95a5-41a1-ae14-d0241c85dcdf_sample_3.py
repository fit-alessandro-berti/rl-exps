...
# Define the process using OperatorPOWL instances
...
xor6 = OperatorPOWL(operator=Operator.XOR, children=[final_approval, SilentTransition()])  # Silent transition for final approval

root = StrictPartialOrder(nodes=[provenance_check, material_scan, radiocarbon_test, style_compare, xor1, xor2, xor3, xor4, xor5, xor6])
