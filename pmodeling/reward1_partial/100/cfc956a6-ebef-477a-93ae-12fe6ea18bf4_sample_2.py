...
loop = OperatorPOWL(operator=Operator.LOOP, children=[artist_onboard, asset_verify, identity_check, smart_deploy, bid_monitor, price_adjust, wallet_link, bid_submit])
xor = OperatorPOWL(operator=Operator.XOR, children=[auction_close, ownership_transfer, fund_release, dispute_review, reputation_update, fractional_offer, secondary_sale])
