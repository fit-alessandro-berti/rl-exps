...
root = StrictPartialOrder(nodes=[site_analysis, zoning_approval, structural_check, building_retrofit,
                                 hydroponic_setup, climate_control, nutrient_design, staff_hiring,
                                 staff_training, software_install, system_testing, crop_planting,
                                 growth_monitor, pest_control, harvest_plan])
...
root.order.add_edge(structural_check, hydroponic_setup)
root.order.add_edge(building_retrofit, hydroponic_setup)
root.order.add_edge(hydroponic_setup, climate_control)
root.order.add_edge(hydroponic_setup, nutrient_design)
root.order.add_edge(climate_control, staff_hiring)
root.order.add_edge(climate_control, staff_training)
root.order.add_edge(climate_control, software_install)
...
root.order.add_edge(system_testing, harvest_plan)