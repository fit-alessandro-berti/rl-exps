...
root = StrictPartialOrder(
    ...
    order={
        ...
        (quality_testing, starter_culture): None,
        (starter_culture, coagulation): None,
        (coagulation, curd_cutting): None,
        (curd_cutting, whey_draining): None,
        (whey_draining, molding_cheese): None,
        (molding_cheese, pressing_block): None,
        (pressing_block, brining_bath): None,
        (brining_bath, aging_control): None,
        (aging_control, flavor_profiling): None,
        (flavor_profiling, packaging_design): None,
        (packaging_design, demand_forecast): None,
        (demand_forecast, retail_outreach): None,
        (retail_outreach, customer_feedback): None
    }
)
