...
feedback_loop = OperatorPOWL(operator=Operator.LOOP, children=[initial_testing, flight_calibrate, payload_mount])
...
root = StrictPartialOrder(nodes=[client_brief, design_draft, part_sourcing, component_fabric, circuit_assembly, software_upload, feedback_loop, quality_check, certification, packaging, delivery_plan, post_support])
root.order.add_edge(client_brief, design_draft)
root.order.add_edge(client_brief, part_sourcing)
root.order.add_edge(design_draft, component_fabric)
...
root.order.add_edge(initial_testing, payload_mount)
root.order.add_edge(flight_calibrate, payload_mount)
root.order.add_edge(payload_mount, feedback_loop)
root.order.add_edge(feedback_loop, initial_testing)
root.order.add_edge(feedback_loop, flight_calibrate)
root.order.add_edge(feedback_loop, payload_mount)
