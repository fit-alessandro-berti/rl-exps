...
loop = OperatorPOWL(operator=Operator.LOOP, children=[intake_check, condition_log, provenance_review, material_test, spectrometry_scan, stylistic_analysis, expert_consult, archive_search, ledger_verification])
xor = OperatorPOWL(operator=Operator.XOR, children=[secondary_review, cross_check])
xor2 = OperatorPOWL(operator=Operator.XOR, children=[conservation_prep, documentation, report_creation, database_update])
