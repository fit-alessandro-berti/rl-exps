...
root = StrictPartialOrder(nodes=[loop, launch_pilots, monitor_trends, ai_analytics, pivot_plans, cycle_renewal])
root.order.add_edge(loop, launch_pilots)
root.order.add_edge(loop, monitor_trends)
root.order.add_edge(loop, ai_analytics)
root.order.add_edge(loop, pivot_plans)
