...
root = StrictPartialOrder(nodes=[provenance_check_to_material_scan, material_scan_to_radiocarbon_test, radiocarbon_test_to_stylistic_review, stylistic_review_to_expert_consult, expert_consult_to_document_audit, document_audit_to_legal_verify, legal_verify_to_condition_report, condition_report_to_discrepancy_flag, discrepancy_flag_to_re_examination, re_examination_to_alternative_source, alternative_source_to_acquisition_vote, acquisition_vote_to_catalog_entry, catalog_entry_to_exhibit_plan, exhibit_plan_to_final_approval])
