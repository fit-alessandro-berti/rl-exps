...
# Material Sourcing -> Supplier Vetting
# Supplier Vetting -> Design Review
# Design Review -> Prototype Build
# Prototype Build -> Quality Audit
# Quality Audit -> Batch Scheduling
# Batch Scheduling -> Handcrafting
# Handcrafting -> Packaging Design
# Packaging Design -> Custom Labeling
# Custom Labeling -> Sustainability Check
# Sustainability Check -> Inventory Sync
# Inventory Sync -> Market Analysis
# Market Analysis -> Order Aggregation
# Order Aggregation -> Distribution Plan
# Distribution Plan -> Customer Feedback

# Create the StrictPartialOrder model
root = StrictPartialOrder(nodes=[material_sourcing, supplier_vetting, design_review, prototype_build, quality_audit, batch_scheduling, handcrafting, packaging_design, custom_labeling, sustainability_check, inventory_sync, market_analysis, order_aggregation, distribution_plan, customer_feedback])
