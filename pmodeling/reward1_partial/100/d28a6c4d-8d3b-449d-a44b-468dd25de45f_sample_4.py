...
# Define the operators and partial orders
xor = OperatorPOWL(operator=Operator.XOR, children=[expert_review, field_testing, ip_analysis, compliance_check, partner_setup])
loop = OperatorPOWL(operator=Operator.LOOP, children=[user_profiling, launch_prep, feedback_loop, scale_planning, risk_assess, demand_scan, agile_adjust])

# Define the root of the POWL model
root = StrictPartialOrder(nodes=[trend_sensing, idea_fusion, prototype_build, xor, loop])
