...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[Quality_Check, Frame_Selection, Packaging_Prep, Shipment_Arrange, Delivery_Confirm, Post_Sale_Support])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[Revision_Manage, Delay_Mitigate])

root = StrictPartialOrder(nodes=[Inquiry_Review, Client_Onboard, Concept_Draft, Feedback_Cycle, Contract_Setup, Payment_Schedule, Material_Sourcing, Artwork_Create, loop1, loop2])
