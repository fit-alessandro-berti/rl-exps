...
root = StrictPartialOrder(nodes=[
    SiteSelect, DesignLayout, SensorIntegrate, CropChoose, SoilPrepare, IrrigationSetup, PestControl,
    LightingInstall, StaffTrain, ComplianceCheck, MarketAnalyze, PackageDesign, LogisticsPlan, DataAnalyze, FeedbackLoop
])
