...
# Milk Sourcing -> Diet Monitoring
# Diet Monitoring -> Culture Selection
# Culture Selection -> Milk Pasteurize
# Milk Pasteurize -> Curd Cutting
# Curd Cutting -> Whey Draining
# Whey Draining -> Mold Inoculate
# Mold Inoculate -> Press Forming
# Press Forming -> Salt Application
# Salt Application -> Aging Setup
...
# Order Processing -> Retail Delivery
# Retail Delivery -> Event Coordination
# Event Coordination -> Feedback Review

# Create the partial order graph
root = StrictPartialOrder(nodes=[
    milk_sourcing, diet_monitoring, culture_selection, milk_pasteurize, curd_cutting,
    whey_draining, mold_inoculate, press_forming, salt_application, aging_setup,
    humidity_control, flavor_testing, packaging_design, order_processing, retail_delivery,
