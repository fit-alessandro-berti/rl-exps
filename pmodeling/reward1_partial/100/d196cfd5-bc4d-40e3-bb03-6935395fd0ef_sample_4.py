...
xor2 = OperatorPOWL(operator=Operator.XOR, children=[participant_sign_up, team_formation])
...
xor8 = OperatorPOWL(operator=Operator.XOR, children=[post_analytics, winner_announcement])
