...
# Define transitions
xor1 = OperatorPOWL(operator=Operator.XOR, children=[ai_prediction, seed_selection])
...
xor9 = OperatorPOWL(operator=Operator.XOR, children=[logistics_dispatch, None])
...
loop5 = OperatorPOWL(operator=Operator.LOOP, children=[xor9, None])
