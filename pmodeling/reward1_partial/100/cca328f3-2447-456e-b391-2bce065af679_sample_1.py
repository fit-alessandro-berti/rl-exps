...
root = StrictPartialOrder(nodes=[
    artifact_intake, provenance_check, material_scan, style_compare, digital_capture,
    expert_review, database_search, legal_audit, cultural_assess, data_synthesis, report_draft,
    archival_store, display_approve, lender_notify, investigation_flag
])

# Define the partial order of the model
...
root.order.add_edge(investigation_flag, report_draft)
root.order.add_edge(investigation_flag, archival_store)
root.order.add_edge(investigation_flag, display_approve)
root.order.add_edge(investigation_flag, lender_notify)