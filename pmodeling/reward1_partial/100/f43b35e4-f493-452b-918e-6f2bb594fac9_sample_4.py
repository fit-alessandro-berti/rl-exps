...
loop_initial_testing = OperatorPOWL(operator=Operator.LOOP, children=[initial_testing, flight_calibrate])
loop_circuit_assembly = OperatorPOWL(operator=Operator.LOOP, children=[circuit_assembly, software_upload])
loop_part_sourcing = OperatorPOWL(operator=Operator.LOOP, children=[part_sourcing, component_fabric])
loop_feedback_loop = OperatorPOWL(operator=Operator.LOOP, children=[feedback_loop, quality_check])
loop_stress_testing = OperatorPOWL(operator=Operator.LOOP, children=[stress_testing, certification])
