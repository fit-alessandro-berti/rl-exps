...
root = StrictPartialOrder(nodes=[
    SoilAnalyze, SiteMapping, BedSetup, CropSelect, SensorDeploy, IrrigationAdjust, NutrientFeed, PestScouting, PestPredict, WorkshopHost, CropRotate, WasteCompost, WaterRecycle, DataAnalyze, CycleRefine, ResourceShare, YieldReport
])
