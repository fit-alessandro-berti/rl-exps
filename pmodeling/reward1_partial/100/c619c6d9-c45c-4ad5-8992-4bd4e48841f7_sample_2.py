...
xor_sensor_firmware = OperatorPOWL(operator=Operator.XOR, children=[sensor_calibrate, firmware_integrate])
xor_payload_flight = OperatorPOWL(operator=Operator.XOR, children=[payload_configure, flight_testing])
...
root.order.add_edge(component_sourcing, xor_sensor_firmware)
root.order.add_edge(xor_sensor_firmware, xor_payload_flight)
root.order.add_edge(xor_payload_flight, assembly_setup)
...
root.order.add_edge(software_load, data_analyze)
