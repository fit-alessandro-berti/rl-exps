...
# Define exclusive choice for different activities
...
# Define loop for the audit process
...
root = StrictPartialOrder(nodes=[audit_loop])
root.order.add_edge(audit_loop, exclusive_choice)
