...
loop_drone_assign = OperatorPOWL(operator=Operator.LOOP, children=[drone_assign, return_flight])
xor_traffic_monitor = OperatorPOWL(operator=Operator.XOR, children=[traffic_monitor, SilentTransition()])

# Define the partial order
root = StrictPartialOrder(nodes=[loop_drone_assign, xor_traffic_monitor, order_validate, route_optimize, preflight_check, load_package, flight_launch, weather_assess, obstacle_avoid, battery_check, delivery_verify, biometric_scan, package_release, post_flight, data_analyze, feedback_collect])
