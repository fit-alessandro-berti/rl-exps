...
loop = OperatorPOWL(operator=Operator.LOOP, children=[data_backup])
root = StrictPartialOrder(nodes=[site_survey, climate_scan, module_setup, crop_choice, nutrient_feed, pest_control, energy_audit, waste_cycle, growth_track, demand_plan, community_link, regulation_check, xor, loop])
...
root.order.add_edge(data_backup, loop)
