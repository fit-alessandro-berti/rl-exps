...
# Define the loop for the material order process
material_order_loop = OperatorPOWL(operator=Operator.LOOP, children=[material_order])
...
root.order.add_edge(stakeholder_meet, material_order_loop)
root.order.add_edge(material_order_loop, system_install)
