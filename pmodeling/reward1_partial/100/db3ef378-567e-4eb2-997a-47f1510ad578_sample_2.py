...
# Define operators
loop = OperatorPOWL(operator=Operator.LOOP, children=[Milk_Collection, Culture_Prep, Curd_Formation, Whey_Separation, Molding_Cheese, Salting_Process, Initial_Aging, Humidity_Control, Temperature_Check, Flavor_Testing, Final_Aging, Packaging_Artisanal, Label_Printing, Inventory_Audit, Order_Fulfillment, Subscription_Setup, Event_Marketing])
