...
loop = OperatorPOWL(operator=Operator.LOOP, children=[fabricate_gears])
xor = OperatorPOWL(operator=Operator.XOR, children=[inspect_components, loop])

# Construct the partial order
root = StrictPartialOrder(nodes=[
    initial_assess, disassemble_parts, ultrasonic_clean, inspect_components, fabricate_gears,
    dial_restoration, repaint_markers, reassemble_movement, lubricate_bearings, calibrate_timing,
    polish_case, re_case_watch, quality_testing, document_process, package_product
])
