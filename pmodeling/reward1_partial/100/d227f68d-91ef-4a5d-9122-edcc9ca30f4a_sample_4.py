...
root = StrictPartialOrder(nodes=[site_survey, design_layout, permits_check, foundation_prep, frame_assembly, hydro_setup, climate_setup, seed_selection, nutrient_mix, system_calibration, pest_control, automation_link, staff_training, yield_tracking, distribution_plan])
...
root.order.add_edge(design_layout, frame_assembly)
root.order.add_edge(foundation_prep, hydro_setup)
...
root.order.add_edge(seed_selection, system_calibration)
