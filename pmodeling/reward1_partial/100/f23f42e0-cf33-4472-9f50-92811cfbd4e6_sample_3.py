...
root.order.add_edge(culture_selection, mold_inoculation)
...
root.order.add_edge(mold_inoculation, whey_draining)
...
root.order.add_edge(aging_setup, quality_tasting)
