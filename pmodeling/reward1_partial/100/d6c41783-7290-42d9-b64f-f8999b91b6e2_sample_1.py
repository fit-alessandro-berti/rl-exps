...
xor2 = OperatorPOWL(operator=Operator.XOR, children=[entangle_nodes, risk_analysis])
xor3 = OperatorPOWL(operator=Operator.XOR, children=[demand_forecast, supplier_sync])
xor4 = OperatorPOWL(operator=Operator.XOR, children=[latency_check, inventory_scan])
