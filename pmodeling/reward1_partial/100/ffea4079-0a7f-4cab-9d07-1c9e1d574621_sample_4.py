...
root.order.add_edge(Transition(label='Scenario Setup'), Transition(label='Team Briefing'))
root.order.add_edge(Transition(label='Resource Mapping'), Transition(label='Tech Deployment'))
root.order.add_edge(Transition(label='Resource Mapping'), Transition(label='Data Sync'))
root.order.add_edge(Transition(label='Team Briefing'), Transition(label='Comm Setup'))
