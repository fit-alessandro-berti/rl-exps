...
root = StrictPartialOrder(nodes=[milk_sourcing, culture_blending, milk_pasturize, curd_cutting, whey_drain, mold_inoculate, press_cheese, salt_brine, age_monitor, quality_test, packaging_prep, label_design, order_allocation, transport_arrange, retail_sync, customer_review, feedback_analyze])
...
root.order.add_edge(milk_sourcing, mold_inoculate)
root.order.add_edge(milk_sourcing, press_cheese)
root.order.add_edge(milk_sourcing, salt_brine)
root.order.add_edge(milk_sourcing, age_monitor)
...
root.order.add_edge(milk_sourcing, order_allocation)
root.order.add_edge(milk_sourcing, transport_arrange)
root.order.add_edge(milk_sourcing, retail_sync)
root.order.add_edge(milk_sourcing, customer_review)
root.order.add_edge(milk_sourcing, feedback_analyze)
