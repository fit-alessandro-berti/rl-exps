...
refinement_loop = OperatorPOWL(operator=Operator.LOOP, children=[quality_check, blend_experiment, maturation_cycle])
...
root.order.add_edge(refinement_loop, quality_check)
