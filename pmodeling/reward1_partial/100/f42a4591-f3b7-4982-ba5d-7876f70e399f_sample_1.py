...
root = StrictPartialOrder(
    ...
    order={
        inspect_item: [verify_provenance],
        verify_provenance: [document_condition],
        document_condition: [disassemble_parts],
        disassemble_parts: [clean_components],
        clean_components: [analyze_damage],
        analyze_damage: [select_materials],
        select_materials: [perform_repairs],
        perform_repairs: [match_finishes],
        match_finishes: [apply_treatments],
        apply_treatments: [reassemble_item],
        reassemble_item: [quality_check],
        quality_check: [photograph_results],
        photograph_results: [update_archive],
        update_archive: [client_review],
