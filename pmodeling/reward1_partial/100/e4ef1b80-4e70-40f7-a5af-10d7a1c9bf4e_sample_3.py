...
root = StrictPartialOrder(
    ...
    order={
        (opportunity_scan, idea_workshop),
        (idea_workshop, concept_merge),
        (concept_merge, resource_align),
        (resource_align, prototype_build),
        (prototype_build, feasibility_test),
        (feasibility_test, pilot_launch),
        (pilot_launch, feedback_gather),
        (feedback_gather, design_adapt),
        (design_adapt, compliance_check),
        (compliance_check, scaling_plan),
        (scaling_plan, ip_management),
        (ip_management, market_sync),
        (market_sync, partner_review),
        (partner_review, exit_strategy)
    }
)
