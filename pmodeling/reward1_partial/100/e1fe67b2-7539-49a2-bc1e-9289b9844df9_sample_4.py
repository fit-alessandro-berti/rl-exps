...
loop = OperatorPOWL(operator=Operator.LOOP, children=[FlightCalibrate, EnviroTest, RemotePair, QualityCheck, PackageUnit])
xor = OperatorPOWL(operator=Operator.XOR, children=[RegisterDrone, ClientTrain])
root = StrictPartialOrder(nodes=[GatherSpecs, DesignCustom, SourceParts, FirmwareLoad, MechanicalFit, CableRouting, SensorAlign, ComponentTest, SoftwareSync, loop, xor])
