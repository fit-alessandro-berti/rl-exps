...
root.order.add_edge(quality_testing, milk_fermentation)
root.order.add_edge(starter_culture, milk_fermentation)
root.order.add_edge(milk_fermentation, curd_cutting)
root.order.add_edge(milk_fermentation, whey_draining)
root.order.add_edge(curd_cutting, pressing_cheese)
