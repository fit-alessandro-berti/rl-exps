...
exclusive_choice = OperatorPOWL(operator=Operator.XOR, children=[delay_monitor, shipment_reroute])
loop = OperatorPOWL(operator=Operator.LOOP, children=[risk_assess, supplier_audit, inventory_scan, route_optimize, order_prioritize, contract_review, delay_monitor, shipment_reroute, cost_analyze, compliance_check, alternative_engage, inventory_reallocate, performance_track, feedback_loop, strategy_update])

# Define the root of the POWL model
root = StrictPartialOrder(nodes=[exclusive_choice, loop])
