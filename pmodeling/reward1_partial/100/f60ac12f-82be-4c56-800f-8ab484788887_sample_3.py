...
# This is a simplified example, actual process may be more complex
...
root.order.add_edge(culture_blending, milk_pasture)
root.order.add_edge(milk_pasture, curd_cutting)
