...
root = StrictPartialOrder(nodes=[site_survey, design_layout, install_lighting, setup_hydroponics,
                                 calibrate_sensors, select_crops, mix_nutrients, deploy_iot, energy_audit,
                                 train_staff, pest_control, legal_review, market_analysis, plan_logistics,
                                 yield_review])

# Define the dependencies
root.order.add_edge(site_survey, design_layout)
root.order.add_edge(site_survey, install_lighting)
