...
root.order.add_edge(site_survey, procure_modules)
root.order.add_edge(design_layout, install_framework)
root.order.add_edge(design_layout, setup_sensors)
root.order.add_edge(install_framework, calibrate_nutrients)
root.order.add_edge(install_framework, configure_iot)
