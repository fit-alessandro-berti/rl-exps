...
# Optionally, if you want to define a loop for the growth monitor:
# root.order.add_edge(growth_monitor, growth_monitor)

# Optionally, if you want to define a choice for pest control:
# xor = OperatorPOWL(operator=Operator.XOR, children=[pest_control, water_recycle])
# root.order.add_edge(climate_adjust, xor)
