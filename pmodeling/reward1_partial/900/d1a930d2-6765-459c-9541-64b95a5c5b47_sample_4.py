...
root = StrictPartialOrder(nodes=[
    artifact_intake, condition_check, material_test, style_compare, carbon_dating, document_review,
    provenance_check, digital_imaging, forgeriescan, expert_consult, historical_research, panel_review,
...
root.order.add_edge(digital_imaging, forgeriescan)
