...
root.order.add_edge(condition_check, radiocarbon_test)
root.order.add_edge(condition_check, provenance_review)
root.order.add_edge(material_sampling, imaging_capture)
root.order.add_edge(material_sampling, chemical_analysis)
root.order.add_edge(imaging_capture, historical_match)
root.order.add_edge(imaging_capture, expert_consult)
root.order.add_edge(chemical_analysis, forgery_scan)
...
root.order.add_edge(expert_consult, market_survey)
