...
xor = OperatorPOWL(operator=Operator.XOR, children=[digital_capture, expert_review, database_search, legal_audit, cultural_assess])
root = StrictPartialOrder(nodes=[loop, xor, data_synthesis, report_draft, archival_store, display_approve, lender_notify, investigation_flag])
