...
loop = OperatorPOWL(operator=Operator.LOOP, children=[flight_calibrate, feedback_loop])
xor = OperatorPOWL(operator=Operator.XOR, children=[quality_check, packaging])
...
root.order.add_edge(packaging, certification)
root.order.add_edge(certification, delivery_plan)
