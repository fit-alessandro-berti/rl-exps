...
root.order.add_edge(scenario_setup, live_monitoring)
root.order.add_edge(scenario_setup, variable_adjust)
root.order.add_edge(scenario_setup, incident_injection)
root.order.add_edge(scenario_setup, response_tracking)
root.order.add_edge(scenario_setup, interlock_check)
root.order.add_edge(scenario_setup, real_time_feedback)
root.order.add_edge(scenario_setup, debrief_session)
root.order.add_edge(scenario_setup, outcome_analysis)
root.order.add_edge(scenario_setup, report_generation)
root.order.add_edge(scenario_setup, improvement_plan)
...
root.order.add_edge(resource_mapping, comm_setup)
...
root.order.add_edge(team_briefing, data_sync)
...
root.order.add_edge(tech_deployment, comm_setup)
