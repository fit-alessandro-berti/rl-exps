...
root.nodes = [return_request, authorization_check, pickup_schedule, transport_dispatch, receiving_goods, quality_inspect, sort_items, refurbish_prep, recycle_process, inventory_update, customer_notify, disposal_arrange, compliance_audit, cost_analysis, report_generate]
