...
loop = OperatorPOWL(operator=Operator.LOOP, children=[environment_setup, sensor_deployment, growth_monitoring, pest_detection, automated_harvest, quality_check, packaging_prep, biodegradable_pack, inventory_sync, micro_fulfillment, local_dispatch, consumer_feedback, crop_adjustment])

# Define the root POWL model
root = StrictPartialOrder(nodes=[seed_selection, nutrient_mix, loop, xor])
...
root.order.add_edge(inventory_sync, micro_fulfillment)
...
root.order.add_edge(crop_adjustment, demand_forecast)