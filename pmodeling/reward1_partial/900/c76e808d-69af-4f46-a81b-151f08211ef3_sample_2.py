...
flavor_loop = OperatorPOWL(operator=Operator.LOOP, children=[flavor_profiling, packaging_design])
...
root.order.add_edge(env_monitoring, aging_setup)
root.order.add_edge(flavor_profiling, packaging_design)
root.order.add_edge(packaging_design, flavor_profiling)
