...
root.order.add_edge(artifact_intake, radiocarbon_test)
root.order.add_edge(artifact_intake, spectroscopy_scan)
root.order.add_edge(artifact_intake, material_analysis)
root.order.add_edge(artifact_intake, style_assessment)
root.order.add_edge(artifact_intake, context_review)
root.order.add_edge(artifact_intake, expert_panel)
root.order.add_edge(artifact_intake, report_draft)
root.order.add_edge(document_check, quality_review)
root.order.add_edge(provenance_search, ownership_validate)
root.order.add_edge(radiocarbon_test, quality_review)
root.order.add_edge(spectroscopy_scan, quality_review)
root.order.add_edge(material_analysis, quality_review)
root.order.add_edge(style_assessment, quality_review)
root.order.add_edge(context_review, quality_review)
root.order.add_edge(expert_panel, quality_review)
