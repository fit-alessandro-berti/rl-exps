...
root.order.add_edge(load_test, bed_install)
root.order.add_edge(soil_sample, bed_install)
root.order.add_edge(crop_select, bed_install)
root.order.add_edge(irrigation_plan, bed_install)
root.order.add_edge(permit_apply, material_order)
root.order.add_edge(material_order, bed_install)
root.order.add_edge(solar_setup, bed_install)
root.order.add_edge(pest_control, bed_install)
root.order.add_edge(staff_train, bed_install)
root.order.add_edge(market_outreach, bed_install)
root.order.add_edge(system_setup, bed_install)
root.order.add_edge(supplier_contact, bed_install)
root.order.add_edge(health_monitor, bed_install)
