...
root = StrictPartialOrder(
    nodes=[user_signup, preference_set, meal_select, schedule_delivery, supplier_match, inventory_check,
           ingredient_order, quality_inspect, meal_pack, route_plan, dispatch_kit, delivery_track, feedback_collect,
           data_analyze, plan_optimize],
    order={
        (user_signup, preference_set): None,
        (preference_set, meal_select): None,
        (meal_select, schedule_delivery): None,
        (schedule_delivery, supplier_match): None,
        (supplier_match, inventory_check): None,
        (inventory_check, ingredient_order): None,
        (ingredient_order, quality_inspect): None,
        (quality_inspect, meal_pack): None,
        (meal_pack, route_plan): None,
        (route_plan, dispatch_kit): None,
        (dispatch_kit, delivery_track): None,
        (delivery_track, feedback_collect): None,
        (feedback_collect, data_analyze): None,
        (data_analyze, plan_optimize): None
    }
)
