...
# Define loop nodes
flight_testing_loop = OperatorPOWL(operator=Operator.LOOP, children=[flight_testing])
...
root.order.add_edge(flight_testing_loop, data_analyze)
root.order.add_edge(data_analyze, regulation_check_choice)
root.order.add_edge(regulation_check_choice, quality_inspect)
