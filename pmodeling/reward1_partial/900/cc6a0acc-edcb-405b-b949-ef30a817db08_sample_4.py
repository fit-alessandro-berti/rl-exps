...
# Add a loop for the maintenance phase
maintenance_loop = OperatorPOWL(operator=Operator.LOOP, children=[community_meet, waste_manage, yield_report])
root.order.add_edge(yield_report, maintenance_loop)

# Add an exclusive choice for the end of the process
end_choice = OperatorPOWL(operator=Operator.XOR, children=[maintenance_loop, skip])
root.order.add_edge(maintenance_loop, end_choice)
