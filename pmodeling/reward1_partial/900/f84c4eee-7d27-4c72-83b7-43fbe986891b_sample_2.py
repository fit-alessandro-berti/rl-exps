...
root = StrictPartialOrder(nodes=[sourcing, assembly, mounting, wiring, testing, loading, initial_calibration, integration, flight_testing, data_logging, tuning, packaging_prep, labeling, documentation, quality_review, client_training, monitoring, update])
...
root.order.add_edge(client_training, monitoring)
root.order.add_edge(monitoring, update)
