...
root = StrictPartialOrder(
    nodes=[ReceiveArtifact, ConditionLog, RadiocarbonTest, SpectroscopyScan, ExpertConsult, ProvenanceCheck, ArchiveSearch, RiskAssess, ThreeDScan, LegalReview, InsuranceSetup, CertificateDraft, CertificateApprove, ClimatePack, ConservationPlan, MonitoringSchedule]
)
