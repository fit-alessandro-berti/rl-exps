...
# Define the exclusive choice for staff training and pest control
xor = OperatorPOWL(operator=Operator.XOR, children=[staff_train, pest_control])

# Define the root POWL model
root = StrictPartialOrder(nodes=[site_analysis, structure_check, enviro_design, hydro_setup, aeroponics_add, lighting_procure, water_recycle, rack_install, seed_select, germinate_seeds, nutrient_mix, xor, loop])
