...
# Loop for community meet and yield adjust
community_meet_loop = OperatorPOWL(operator=Operator.LOOP, children=[community_meet, yield_adjust])

# Define the partial order
root = StrictPartialOrder(nodes=[site_survey, energy_partner, permit_filing, hydro_unit, ai_setup, nutrient_plan, system_install, crop_testing, data_analysis, community_meet_loop, logistics_plan, quality_check, scale_review])
...
root.order.add_edge(data_analysis, community_meet_loop)
root.order.add_edge(community_meet_loop, logistics_plan)
