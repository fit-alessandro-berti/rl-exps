...
root = StrictPartialOrder(nodes=[brand_audit, equity_review, market_analysis, legal_clearance, trademark_check, portfolio_merge, customer_sync, cultural_align, internal_brief, campaign_design, resource_plan, stakeholder_meet, launch_prep, feedback_loop, performance_track])

# Define dependencies
root.order.add_edge(brand_audit, equity_review)
root.order.add_edge(brand_audit, market_analysis)
root.order.add_edge(equity_review, legal_clearance)
root.order.add_edge(equity_review, trademark_check)
