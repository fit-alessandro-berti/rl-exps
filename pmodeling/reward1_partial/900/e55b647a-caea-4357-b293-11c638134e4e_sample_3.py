...
data_loop = OperatorPOWL(operator=Operator.LOOP, children=[data_documentation, interim_report, department_review, consensus_meeting])
consensus_loop = OperatorPOWL(operator=Operator.LOOP, children=[final_approval, artifact_release])

root = StrictPartialOrder(nodes=[artifact_intake, provenance_loop, archive_loop, data_loop, consensus_loop])
