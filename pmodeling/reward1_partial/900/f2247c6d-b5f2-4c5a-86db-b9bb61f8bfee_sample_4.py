...
loop_refurbish = OperatorPOWL(operator=Operator.LOOP, children=[refurbish_units, test_quality])
xor_inspection = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_segregation = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_data_wiping = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_part_harvesting = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_recycling = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_disposing = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_updating = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_resale = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_refunds = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_analyzing = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_improving = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
xor_reporting = OperatorPOWL(operator=Operator.XOR, children=[skip, skip])
...
root.order.add_edge(harvest_parts, loop_refurbish)
root.order.add_edge(loop_refurbish, test_quality)
