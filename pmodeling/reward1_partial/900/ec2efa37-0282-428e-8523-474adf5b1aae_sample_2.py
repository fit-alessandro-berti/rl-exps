...
root = StrictPartialOrder(nodes=[
    ...
    iot_monitor, risk_assess, maintenance_alert,
    quantum_compute, feedback_loop, schedule_adjust,
    demand_update, delivery_track, compliance_check
])

# Define the order dependencies (control flow) between activities
