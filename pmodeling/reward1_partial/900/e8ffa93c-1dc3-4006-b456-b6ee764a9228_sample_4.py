...
root.order.add_edge(crop_select, waste_recycle)
root.order.add_edge(pest_control, community_meet)
root.order.add_edge(growth_monitor, supply_sync)
root.order.add_edge(harvest_plan, data_review)
...
root.order.add_edge(supply_sync, community_meet)