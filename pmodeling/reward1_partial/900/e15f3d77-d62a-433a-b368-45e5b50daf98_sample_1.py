...
gather_specs_to_adapt_design = OperatorPOWL(operator=Operator.LOOP, children=[gather_specs, adapt_design])
adapt_design_to_source_parts = OperatorPOWL(operator=Operator.LOOP, children=[adapt_design, source_parts])
source_parts_to_component_test = OperatorPOWL(operator=Operator.LOOP, children=[source_parts, component_test])
component_test_to_assemble_frame = OperatorPOWL(operator=Operator.LOOP, children=[component_test, assemble_frame])
assemble_frame_to_install_firmware = OperatorPOWL(operator=Operator.LOOP, children=[assemble_frame, install_firmware])
install_firmware_to_calibrate_sensors = OperatorPOWL(operator=Operator.LOOP, children=[install_firmware, calibrate_sensors])
calibrate_sensors_to_stress_test = OperatorPOWL(operator=Operator.LOOP, children=[calibrate_sensors, stress_test])
stress_test_to_flight_simulate = OperatorPOWL(operator=Operator.LOOP, children=[stress_test, flight_simulate])
flight_simulate_to_validate_battery = OperatorPOWL(operator=Operator.LOOP, children=[flight_simulate, validate_battery])
validate_battery_to_check_accuracy = OperatorPOWL(operator=Operator.LOOP, children=[validate_battery, check_accuracy])
check_accuracy_to_package_units = OperatorPOWL(operator=Operator.LOOP, children=[check_accuracy, package_units])
package_units_to_create_manuals = OperatorPOWL(operator=Operator.LOOP, children=[package_units, create_manuals])
create_manuals_to_ship_drones = OperatorPOWL(operator=Operator.LOOP, children=[create_manuals, ship_drones])
ship_drones_to_collect_feedback = OperatorPOWL(operator=Operator.LOOP, children=[ship_drones, collect_feedback])
