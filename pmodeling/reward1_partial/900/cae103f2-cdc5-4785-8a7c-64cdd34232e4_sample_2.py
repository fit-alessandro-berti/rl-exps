...
# Define the process
root = StrictPartialOrder(nodes=[site_acquisition, impact_assessment, modular_setup, crop_planting, nutrient_control, pest_control, growth_monitor, community_engage, yield_forecast, supply_coordinate, compliance_check, waste_recycle, energy_optimize, market_strategy, performance_review])
