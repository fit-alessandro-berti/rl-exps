...
root = StrictPartialOrder(nodes=[
    site_survey, energy_partner, permit_filing, hydro_unit, ai_setup, nutrient_plan, system_install,
    crop_testing, data_analysis, community_meet, yield_adjust, carbon_audit, logistics_plan, quality_check, scale_review
])
