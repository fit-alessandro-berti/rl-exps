...
root.nodes.append(initial_inspect)
root.nodes.append(material_test)
root.nodes.append(imaging_scan)
root.nodes.append(historical_check)
root.nodes.append(expert_consult)
root.nodes.append(provenance_trace)
root.nodes.append(forgery_detect)
root.nodes.append(restoration_map)
root.nodes.append(market_analyze)
root.nodes.append(auction_review)
root.nodes.append(value_assess)
root.nodes.append(report_draft)
root.nodes.append(board_review)
root.nodes.append(certification)
root.nodes.append(release_artifact)
root.nodes.append(chain_custody)
