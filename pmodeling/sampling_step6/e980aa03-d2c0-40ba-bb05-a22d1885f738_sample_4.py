...
root.order.add_edge(client_brief, component_vetting)
root.order.add_edge(client_brief, frame_assembly)
root.order.add_edge(client_brief, sensor_install)
root.order.add_edge(client_brief, propulsion_setup)
root.order.add_edge(client_brief, calibration)
root.order.add_edge(client_brief, software_load)
root.order.add_edge(client_brief, flight_test)
root.order.add_edge(client_brief, ai_training)
root.order.add_edge(client_brief, qa_review)
root.order.add_edge(client_brief, mission_pack)
root.order.add_edge(client_brief, client_training)
root.order.add_edge(client_brief, deployment_support)
