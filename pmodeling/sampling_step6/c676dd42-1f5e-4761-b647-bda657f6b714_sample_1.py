...
# Optionally, you can add dependencies if there are any specific relationships between activities
# For example, if site survey must happen before design layout, you can add:
