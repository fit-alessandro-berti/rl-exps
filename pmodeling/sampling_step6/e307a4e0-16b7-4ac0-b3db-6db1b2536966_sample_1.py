...
# However, if there were dependencies, they could be added as follows:
...
# root.order.add_edge(initial_assess, cleaning_phase)
...
# root.order.add_edge(condition_map, ethics_review)
# root.order.add_edge(condition_map, provenance_verify)
# root.order.add_edge(material_test, ethics_review)
# root.order.add_edge(material_test, provenance_verify)
# root.order.add_edge(cleaning_phase, ethics_review)
# root.order.add_edge(cleaning_phase, provenance_verify)
# root.order.add_edge(stability_check, ethics_review)
# root.order.add_edge(stability_check, provenance_verify)
# root.order.add_edge(minor_repair, ethics_review)
# root.order.add_edge(minor_repair, provenance_verify)
# root.order.add_edge(structural_reinforce, ethics_review)
# root.order.add_edge(structural_reinforce, provenance_verify)
# root.order.add_edge(surface_restore, ethics_review)
# root.order.add_edge(surface_restore, provenance_verify)
# root.order.add_edge(coating_apply, ethics_review)
# root.order.add_edge(coating_apply, provenance_verify)
