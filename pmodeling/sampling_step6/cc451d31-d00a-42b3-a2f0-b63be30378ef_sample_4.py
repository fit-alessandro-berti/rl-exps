...
root = StrictPartialOrder(nodes=[
    ...
    prototype_build, user_testing, iterate_feedback, risk_assess,
    compliance_check, pilot_launch, performance_track, impact_analyze,
    insight_gather, cycle_adjust, final_report
])
...
root.order.add_edge(iterate_feedback, compliance_check)
...
# Save the root model
# No need to save the model in a variable 'root' as it is already defined