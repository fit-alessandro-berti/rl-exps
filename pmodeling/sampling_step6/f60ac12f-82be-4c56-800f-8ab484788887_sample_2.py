...
# Since the activities are independent, there are no explicit dependencies in the partial order
# If there were dependencies, they would be added here using the 'order.add_edge' method

# The root of the process is now defined as 'root'
print("POWL model for the artisan cheese supply chain process has been defined.")