...
# Since there are no dependencies mentioned in the problem, we can assume that the activities are concurrent
# If there were dependencies, we would define them as edges in the partial order
