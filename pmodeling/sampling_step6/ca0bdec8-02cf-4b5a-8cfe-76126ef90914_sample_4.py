...
# Define the root node as a StrictPartialOrder with the activities as children
...
# No dependencies defined in the process description, so no edges are added to the root node.