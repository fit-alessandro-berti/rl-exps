...
# The dependencies between activities can be defined if needed, but in this case, the order is already defined by the process description
...
# root.order.add_edge(milk_pasteurize, curd_cut)
# root.order.add_edge(milk_pasteurize, whey_drain)
# root.order.add_edge(milk_inoculate, mold_inoculate)
# root.order.add_edge(milk_inoculate, press_cheese)
# root.order.add_edge(press_cheese, aging_setup)
# root.order.add_edge(aging_setup, humidity_control)
# root.order.add_edge(aging_setup, temp_monitor)
...
# root.order.add_edge(order_fulfill, feedback_collect)
