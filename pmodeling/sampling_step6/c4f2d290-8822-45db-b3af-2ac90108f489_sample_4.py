...
# Add dependencies between transitions if needed (example: data_ingest depends on status_check)
# root.order.add_edge(status_check, data_ingest)

# The root of the POWL model is now defined