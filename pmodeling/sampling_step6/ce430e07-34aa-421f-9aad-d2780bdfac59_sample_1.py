...
# Define the order dependencies (if any, for this simple example, there might be none)
# In this case, we assume that all activities are concurrent and there are no dependencies
