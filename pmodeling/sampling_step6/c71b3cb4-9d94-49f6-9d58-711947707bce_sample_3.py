...
# Define dependencies
# For simplicity, we'll assume direct dependencies between activities
root.order.add_edge(seed_selection, germination_start)
root.order.add_edge(seed_selection, seedling_transplant)
root.order.add_edge(germination_start, nutrient_mix)
root.order.add_edge(germination_start, water_delivery)
root.order.add_edge(germination_start, light_adjustment)
root.order.add_edge(germination_start, climate_control)
root.order.add_edge(seedling_transplant, nutrient_mix)
root.order.add_edge(seedling_transplant, water_delivery)
root.order.add_edge(seedling_transplant, light_adjustment)
root.order.add_edge(seedling_transplant, climate_control)
root.order.add_edge(nutrient_mix, health_check)
root.order.add_edge(water_delivery, health_check)
root.order.add_edge(light_adjustment, health_check)
root.order.add_edge(climate_control, health_check)
