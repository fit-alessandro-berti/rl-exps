...
root.order.add_edge(inquiry_intake, concept_draft)
root.order.add_edge(inquiry_intake, contract_setup)
root.order.add_edge(inquiry_intake, artist_match)
root.order.add_edge(inquiry_intake, material_sourcing)
root.order.add_edge(inquiry_intake, ethics_review)
root.order.add_edge(inquiry_intake, progress_check)
root.order.add_edge(inquiry_intake, milestone_approve)
root.order.add_edge(inquiry_intake, quality_audit)
root.order.add_edge(inquiry_intake, copyright_transfer)
root.order.add_edge(inquiry_intake, packaging_plan)
root.order.add_edge(inquiry_intake, shipping_arrange)
root.order.add_edge(inquiry_intake, post_delivery)
root.order.add_edge(inquiry_intake, client_survey)
