...
# (In a real process, you would need to define the dependencies based on the process flow)
# For simplicity, we are assuming a linear process here
...
# root.order.add_edge(legal_clearance, digital_scan)
