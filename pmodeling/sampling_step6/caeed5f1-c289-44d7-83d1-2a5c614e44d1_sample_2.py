...
root = StrictPartialOrder(nodes=[
    client_meet, vision_capture, concept_draft, feedback_loop, material_sourcing,
    vendor_selection, artisan_assign, prototype_build, quality_review, technical_check,
    final_approval, packaging_prep, logistics_plan, secure_transport, installation_set,
    client_support, archival_record
])

# Define the dependencies
root.order.add_edge(client_meet, vision_capture)
root.order.add_edge(client_meet, concept_draft)
root.order.add_edge(vision_capture, feedback_loop)
...
root.order.add_edge(prototype_build, technical_check)
...
root.order.add_edge(final_approval, logistics_plan)
root.order.add_edge(logistics_plan, secure_transport)
root.order.add_edge(logistics_plan, installation_set)
root.order.add_edge(secure_transport, client_support)
root.order.add_edge(secure_transport, archival_record)
