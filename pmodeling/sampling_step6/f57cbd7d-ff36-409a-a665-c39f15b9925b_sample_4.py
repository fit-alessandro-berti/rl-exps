...
root.order.add_edge(trend_scan, feasibility_check)
root.order.add_edge(idea_sprint, feasibility_check)
root.order.add_edge(idea_sprint, risk_review)
root.order.add_edge(feasibility_check, tech_prototype)
root.order.add_edge(feasibility_check, market_simulate)
root.order.add_edge(feasibility_check, stakeholder_align)
root.order.add_edge(budget_adjust, talent_source)
root.order.add_edge(budget_adjust, pilot_launch)
root.order.add_edge(market_simulate, pilot_launch)
