...
root.order.add_edge(climate_map, sensor_check)
root.order.add_edge(iot_setup, sensor_check)
root.order.add_edge(nutrient_mix, sensor_check)
root.order.add_edge(sensor_check, light_adjust)
root.order.add_edge(sensor_check, water_cycle)
root.order.add_edge(sensor_check, pest_scan)
...
root.order.add_edge(harvest_plan, pack_items)
