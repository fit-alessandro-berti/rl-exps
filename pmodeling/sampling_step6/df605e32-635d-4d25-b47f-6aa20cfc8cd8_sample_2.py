...
# Optionally, you can add dependencies between activities if there are any
# For example, if 'Artifact Scan' must be done before 'Ownership Verify', you can add the following:
