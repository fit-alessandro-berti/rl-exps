...
root.order.add_edge(trend_scan, sector_match)
root.order.add_edge(idea_harvest, brainstorm_hub)
root.order.add_edge(idea_harvest, concept_filter)
root.order.add_edge(sector_match, brainstorm_hub)
root.order.add_edge(sector_match, concept_filter)
root.order.add_edge(brainstorm_hub, prototype_build)
root.order.add_edge(brainstorm_hub, hybrid_testing)
root.order.add_edge(concept_filter, prototype_build)
root.order.add_edge(concept_filter, hybrid_testing)
root.order.add_edge(hybrid_testing, stakeholder_sync)
root.order.add_edge(hybrid_testing, risk_assess)
root.order.add_edge(stakeholder_sync, scenario_map)
root.order.add_edge(stakeholder_sync, strategy_align)
root.order.add_edge(risk_assess, scenario_map)
root.order.add_edge(risk_assess, strategy_align)
root.order.add_edge(scenario_map, pilot_launch)
root.order.add_edge(scenario_map, data_capture)
root.order.add_edge(strategy_align, pilot_launch)
root.order.add_edge(strategy_align, data_capture)
root.order.add_edge(pilot_launch, market_sense)
root.order.add_edge(pilot_launch, scale_plan)
