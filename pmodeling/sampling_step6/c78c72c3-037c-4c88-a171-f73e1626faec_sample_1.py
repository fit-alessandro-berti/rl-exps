...
# Add dependencies if any (not explicitly mentioned in the problem statement, so we assume they are concurrent)
# For example, if 'site_survey' and 'design_layout' are concurrent:
# root.order.add_edge(site_survey, design_layout)

# If you want to add dependencies, uncomment and modify the above line accordingly.