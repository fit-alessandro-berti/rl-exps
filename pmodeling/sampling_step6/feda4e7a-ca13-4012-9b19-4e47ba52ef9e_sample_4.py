...
root.order.add_edge(site_analysis, seed_automation)
root.order.add_edge(site_analysis, growth_monitor)
root.order.add_edge(site_analysis, pest_control)
root.order.add_edge(site_analysis, ai_diagnostics)
root.order.add_edge(site_analysis, harvest_plan)
root.order.add_edge(site_analysis, robotic_sort)
root.order.add_edge(site_analysis, packaging_line)
root.order.add_edge(site_analysis, community_input)
root.order.add_edge(site_analysis, data_aggregation)
root.order.add_edge(site_analysis, waste_recycle)
root.order.add_edge(site_analysis, sustainability)

# Print the root node to confirm the model
print(root)