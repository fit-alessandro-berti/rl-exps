...
root = StrictPartialOrder(nodes=[
    site_survey, load_test, soil_sample, climate_check, crop_select, irrigation_plan,
    energy_setup, pest_control, permit_obtain, stakeholder_meet, bed_construction, seed_planting,
    water_schedule, growth_monitor, harvest_plan, waste_recycle, yield_report
])
...
root.order.add_edge(site_survey, permit_obtain)
root.order.add_edge(site_survey, stakeholder_meet)
root.order.add_edge(site_survey, bed_construction)
root.order.add_edge(site_survey, seed_planting)
root.order.add_edge(site_survey, water_schedule)
...
root.order.add_edge(site_survey, yield_report)
