...
root = StrictPartialOrder(nodes=[artifact_intake, condition_check, provenance_research, scientific_testing, radiocarbon_dating, spectroscopy_scan, legal_clearance, heritage_compliance, digital_archiving, expert_review, committee_vote, acquisition_approval, conservation_plan, storage_setup, stakeholder_update])

# Add dependencies to the root Partial Order
root.order.add_edge(artifact_intake, condition_check)
root.order.add_edge(artifact_intake, provenance_research)
root.order.add_edge(artifact_intake, scientific_testing)
...
root.order.add_edge(acquisition_approval, stakeholder_update)
