...
# Define the root POWL model as a strict partial order with defined transitions
...
# The order can be defined based on the dependencies between activities
# For example, assuming that the activities are dependent on each other in a specific order
# Here, we define the order as a set of source-->target dependencies
# In this example, we assume a linear sequence of activities
...
root.order.add_edge(forgery_risk, legal_audit)
...
# The final result is the root POWL model
print(root)