...
root.order.add_edge(risk_assess, recovery_plan)
root.order.add_edge(risk_assess, third_party_contact)
root.order.add_edge(recovery_plan, negotiation_setup)
root.order.add_edge(recovery_plan, secure_transport)
...
root.order.add_edge(restoration_begin, final_audit)
root.order.add_edge(heritage_archive, process_close)
