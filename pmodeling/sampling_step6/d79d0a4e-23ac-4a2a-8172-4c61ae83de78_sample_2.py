...
root.order.add_edge(spec_review, frame_build)
root.order.add_edge(spec_review, motor_mount)
root.order.add_edge(spec_review, sensor_fit)
root.order.add_edge(spec_review, wiring_setup)
root.order.add_edge(spec_review, software_load)
root.order.add_edge(spec_review, calibration_test)
root.order.add_edge(spec_review, stress_check)
root.order.add_edge(spec_review, firmware_flash)
root.order.add_edge(spec_review, feedback_loop)
root.order.add_edge(spec_review, package_prep)
root.order.add_edge(spec_review, doc_compile)
root.order.add_edge(spec_review, ship_arrange)
root.order.add_edge(spec_review, remote_setup)

print("POWL model for drone assembly process generated successfully.")