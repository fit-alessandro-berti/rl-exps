...
# For example, if the regulatory audit must happen after the batch documentation
# root.order.add_edge(batch_documentation, regulatory_audit)

# Now 'root' contains the complete POWL model for the perfume creation process