...
# Since there are no dependencies between the activities in the given process, no edges are needed to define the partial order.
# If there were dependencies, you would add them using root.order.add_edge(source, target)
