...
root = StrictPartialOrder(nodes=[
    ...
    forgery_risk, registry_crosscheck, legal_verify, ethics_review, report_draft, certificate_issue,
...
root.order.add_edge(registry_crosscheck, certificate_issue)
root.order.add_edge(registry_crosscheck, digital_archive)
root.order.add_edge(registry_crosscheck, transfer_setup)
root.order.add_edge(registry_crosscheck, final_approval)
