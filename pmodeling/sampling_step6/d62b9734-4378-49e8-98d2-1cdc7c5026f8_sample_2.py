...
root = StrictPartialOrder(nodes=[provenance_check, image_capture, material_scan, expert_review, historical_cross, legal_verify, registry_search, customs_clear, condition_assess, data_log, chain_custody, report_draft, certification, secure_archive, auction_prep])
...
root.order.add_edge(provenance_check, registry_search)
root.order.add_edge(provenance_check, customs_clear)
root.order.add_edge(provenance_check, condition_assess)
root.order.add_edge(provenance_check, data_log)
root.order.add_edge(provenance_check, chain_custody)
root.order.add_edge(provenance_check, report_draft)
root.order.add_edge(provenance_check, certification)
root.order.add_edge(provenance_check, secure_archive)
root.order.add_edge(provenance_check, auction_prep)
