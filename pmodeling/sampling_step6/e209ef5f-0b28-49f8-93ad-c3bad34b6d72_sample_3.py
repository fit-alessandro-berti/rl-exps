...
root = StrictPartialOrder(nodes=[
    soil_analyze, site_mapping, bed_setup, crop_select, sensor_deploy, irrigation_adjust, nutrient_feed,
    pest_scouting, pest_predict, workshop_host, crop_rotate, waste_compost, water_recycle, data_analyze,
...
root.order.add_edge(sensor_deploy, nutrient_feed)
root.order.add_edge(pest_scouting, workshop_host)
root.order.add_edge(pest_predict, workshop_host)
root.order.add_edge(workshop_host, crop_rotate)
root.order.add_edge(workshop_host, resource_share)
root.order.add_edge(waste_compost, water_recycle)
root.order.add_edge(data_analyze, cycle_refine)
root.order.add_edge(yield_report, cycle_refine)
