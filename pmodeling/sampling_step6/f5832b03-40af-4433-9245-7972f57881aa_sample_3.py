...
# Define the partial order (process) using the transitions
...
# Optionally, you can define the dependencies between activities
# For example, if the design layout must be done before legal review:
