...
# Add dependencies as needed (e.g., if some activities depend on others)
...
# root.order.add_edge(resource_sourcing, lighting_setup)
# root.order.add_edge(resource_sourcing, irrigation_setup)
...
# You can add more dependencies as per the actual process flow