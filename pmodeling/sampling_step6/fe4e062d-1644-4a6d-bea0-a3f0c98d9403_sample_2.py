...
# Define dependencies between activities if any (in this case, there are no dependencies)
# Since there are no dependencies specified, we leave the order as an empty set
