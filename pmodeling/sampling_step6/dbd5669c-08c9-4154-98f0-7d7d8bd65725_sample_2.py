...
# No additional dependencies in this simple process, so no need to add edges explicitly.
# The order of activities is assumed to be sequential unless specified otherwise.

# The root node is now defined, and it can be used to represent the entire process.