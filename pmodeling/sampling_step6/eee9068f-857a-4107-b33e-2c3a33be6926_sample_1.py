...
# Since there are no dependencies between activities, the partial order is already defined as a strict one.
# Therefore, we don't need to add any edges to the order attribute of root.