...
# The dependencies are implicit in the order of activities, as each activity follows the previous one in the list.
# In this case, the order is the same as the activities are listed, so no explicit edge definitions are needed.
