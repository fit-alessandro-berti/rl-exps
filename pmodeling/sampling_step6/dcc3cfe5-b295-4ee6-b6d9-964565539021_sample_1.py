...
# Add dependencies between activities (example: Demand Forecast depends on itself)
root.order.add_edge(demand_forecast, demand_forecast)
root.order.add_edge(courier_match, courier_match)
root.order.add_edge(credential_check, credential_check)
root.order.add_edge(route_design, route_design)
root.order.add_edge(load_assign, load_assign)
root.order.add_edge(traffic_scan, traffic_scan)
root.order.add_edge(package_secure, package_secure)
root.order.add_edge(dispatch_alert, dispatch_alert)
root.order.add_edge(real_time_track, real_time_track)
root.order.add_edge(incentive_issue, incentive_issue)
root.order.add_edge(dispute_review, dispute_review)
root.order.add_edge(customer_notify, customer_notify)
root.order.add_edge(feedback_collect, feedback_collect)
root.order.add_edge(performance_log, performance_log)
root.order.add_edge(ledger_update, ledger_update)
root.order.add_edge(hub_sync, hub_sync)
