...
root.order.add_edge(quality_testing, sensory_panel)
root.order.add_edge(scent_blending, formula_adjust)
root.order.add_edge(formula_adjust, safety_review)
root.order.add_edge(formula_adjust, sustainability_check)
root.order.add_edge(formula_adjust, packaging_design)
root.order.add_edge(formula_adjust, prototype_creation)
root.order.add_edge(safety_review, client_feedback)
root.order.add_edge(safety_review, label_approval)
...
root.order.add_edge(label_approval, sales_launch)
