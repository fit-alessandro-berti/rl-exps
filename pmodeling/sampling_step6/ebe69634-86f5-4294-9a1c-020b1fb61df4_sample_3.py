...
root.order.add_edge(client_intake, developer_match)
root.order.add_edge(needs_analysis, expert_vetting)
root.order.add_edge(needs_analysis, prototype_build)
root.order.add_edge(developer_match, expert_vetting)
root.order.add_edge(developer_match, prototype_build)
...
root.order.add_edge(final_review, compliance_check)
