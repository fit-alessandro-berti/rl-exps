...
# Define the root Partial Order with activities as nodes
...
# No dependencies between activities, so no need to add edges explicitly
# The activities are concurrent by default in the StrictPartialOrder model
