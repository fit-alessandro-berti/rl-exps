...
root.order.add_edge(intake_review, archival_research)
root.order.add_edge(intake_review, material_testing)
root.order.add_edge(intake_review, radiocarbon_date)
root.order.add_edge(intake_review, stylistic_assess)
root.order.add_edge(intake_review, expert_consult)
root.order.add_edge(preliminary_inspect, findings_compile)
root.order.add_edge(provenance_check, findings_compile)
root.order.add_edge(archival_research, findings_compile)
root.order.add_edge(material_testing, findings_compile)
root.order.add_edge(radiocarbon_date, findings_compile)
root.order.add_edge(stylistic_assess, findings_compile)
