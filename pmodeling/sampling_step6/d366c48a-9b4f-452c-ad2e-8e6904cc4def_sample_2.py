...
# Since the process is linear, we don't need to define any dependencies between nodes
# The root object already represents the entire process as a single node
