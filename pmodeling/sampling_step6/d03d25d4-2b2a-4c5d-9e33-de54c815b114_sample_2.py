...
# The order is already defined implicitly as each transition is connected to the next in sequence.
# If you want to explicitly define the order, you can do so by adding edges.
# For example, if we assume the order is straightforward and each transition follows the other:
