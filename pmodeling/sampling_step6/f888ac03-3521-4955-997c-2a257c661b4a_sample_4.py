...
# No additional dependencies in this simplified model
# The activities are defined in the order of the process steps
# The root Partial Order represents the overall flow of the process
