...
root = StrictPartialOrder(nodes=[
    data_capture, quantum_calc, demand_forecast, inventory_check,
    route_update, shipment_plan, supplier_sync, contract_mod,
    blockchain_verify, risk_assess, scenario_sim, feedback_loop,
    ai_adjust, waste_audit, report_generate, stakeholder_alert,
    compliance_review
])
...
root.order.add_edge(data_capture, inventory_check)
root.order.add_edge(quantum_calc, route_update)
root.order.add_edge(quantum_calc, shipment_plan)
root.order.add_edge(quantum_calc, supplier_sync)
root.order.add_edge(quantum_calc, contract_mod)
root.order.add_edge(blockchain_verify, risk_assess)
root.order.add_edge(blockchain_verify, scenario_sim)
root.order.add_edge(feedback_loop, ai_adjust)
root.order.add_edge(feedback_loop, waste_audit)
root.order.add_edge(feedback_loop, report_generate)
root.order.add_edge(feedback_loop, stakeholder_alert)
root.order.add_edge(feedback_loop, compliance_review)
