...
root.order.add_edge(Idea_Workshop, Resource_Align)
root.order.add_edge(Idea_Workshop, Prototype_Build)
root.order.add_edge(Concept_Merge, Resource_Align)
root.order.add_edge(Concept_Merge, Prototype_Build)
root.order.add_edge(Resource_Align, Feasibility_Test)
root.order.add_edge(Prototype_Build, Feasibility_Test)
root.order.add_edge(Feasibility_Test, Pilot_Launch)
root.order.add_edge(Feasibility_Test, Feedback_Gather)
root.order.add_edge(Pilot_Launch, Design_Adapt)
root.order.add_edge(Pilot_Launch, Compliance_Check)
root.order.add_edge(Feedback_Gather, Design_Adapt)
root.order.add_edge(Feedback_Gather, Compliance_Check)
root.order.add_edge(Design_Adapt, Scaling_Plan)
root.order.add_edge(Compliance_Check, Scaling_Plan)
root.order.add_edge(Scaling_Plan, IP_Management)
root.order.add_edge(Scaling_Plan, Market_Sync)
root.order.add_edge(Scaling_Plan, Partner_Review)
root.order.add_edge(IP_Management, Market_Sync)
root.order.add_edge(IP_Management, Partner_Review)
root.order.add_edge(Market_Sync, Exit_Strategy)
