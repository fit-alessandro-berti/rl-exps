...
root.order.add_edge(artifact_scan, cleaning_phase)
root.order.add_edge(condition_map, stability_check)
root.order.add_edge(condition_map, minor_repair)
root.order.add_edge(condition_map, structural_reinforce)
root.order.add_edge(condition_map, surface_restore)
root.order.add_edge(condition_map, coating_apply)
root.order.add_edge(coating_apply, ethics_review)
root.order.add_edge(coating_apply, provenance_verify)
root.order.add_edge(coating_apply, client_update)
root.order.add_edge(coating_apply, final_report)
root.order.add_edge(coating_apply, archive_store)