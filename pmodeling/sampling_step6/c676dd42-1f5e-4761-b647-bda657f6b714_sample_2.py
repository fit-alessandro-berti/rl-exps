...
# Optionally, if there are any dependencies between activities, you can add them to the order set
# For example, assuming the order is Site Survey --> Design Layout, you would add the edge as follows:
