...
# No dependencies needed for this simple process
# The root Partial Order already captures the dependencies implicitly through the order of activities

# Print the root Partial Order to verify
print(root)