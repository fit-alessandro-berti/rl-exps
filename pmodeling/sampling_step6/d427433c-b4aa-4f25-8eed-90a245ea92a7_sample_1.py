...
root.order.add_edge(milk_blending, fermentation_check)
root.order.add_edge(fermentation_check, curd_cutting)
root.order.add_edge(fermentation_check, whey_separation)
root.order.add_edge(curd_cutting, molding_press)
root.order.add_edge(curd_cutting, salting_stage)
