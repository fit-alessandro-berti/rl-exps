...
root.order.add_edge(staff_training, system_design)
root.order.add_edge(plant_seeding, iot_monitoring)
root.order.add_edge(plant_seeding, data_analytics)
root.order.add_edge(data_analytics, nutrient_adjust)
root.order.add_edge(data_analytics, pest_control)
root.order.add_edge(maintenance_check, system_design)
root.order.add_edge(market_launch, logistics_setup)
root.order.add_edge(market_launch, data_analytics)
