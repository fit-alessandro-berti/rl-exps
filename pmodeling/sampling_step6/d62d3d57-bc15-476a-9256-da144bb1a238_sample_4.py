...
# as it is assumed to be sequential based on the order of transitions defined.
# If you need to define dependencies, you can add them like this:
# root.order.add_edge(site_survey, structure_assess)
# root.order.add_edge(structure_assess, system_design)
# ...

# The 'root' variable now holds the complete POWL model for the urban vertical farming process.