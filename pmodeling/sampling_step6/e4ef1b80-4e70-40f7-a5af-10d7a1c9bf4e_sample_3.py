...
# The order of the activities is not explicitly defined in the problem statement, so we assume they are concurrent.
# If there were specific dependencies, they would be added here.

# The root variable now holds the POWL model representing the process.