...
# The order of activities can be defined if necessary
# For example, if 'Initial Assess' must happen before 'Resource Check', you can add the following line:
# root.order.add_edge(alert_trigger, initial_assess)
# root.order.add_edge(initial_assess, resource_check)
