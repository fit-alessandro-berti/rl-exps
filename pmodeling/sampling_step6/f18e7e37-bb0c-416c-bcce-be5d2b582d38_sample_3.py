...
root.order.add_edge(user_signup, meal_select)
root.order.add_edge(user_signup, schedule_delivery)
root.order.add_edge(preference_set, supplier_match)
root.order.add_edge(preference_set, inventory_check)
root.order.add_edge(meal_select, supplier_match)
root.order.add_edge(meal_select, inventory_check)
root.order.add_edge(supplier_match, ingredient_order)
...
# The final result is the 'root' object representing the complete POWL model.