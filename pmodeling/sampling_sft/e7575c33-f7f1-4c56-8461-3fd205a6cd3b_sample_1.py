...
# Loop for repeatable comparative stylistic evaluation
# Body A: Style Compare
# Body B: Repeat Style Compare
loop_style = OperatorPOWL(operator=Operator.LOOP, children=[style_compare, style_compare])
...
root.order.add_edge(provenance_trace, loop_style)
root.order.add_edge(loop_style, three_d_scanning)
...
# The process ends with either sale prep or archival, depending on the client's needs