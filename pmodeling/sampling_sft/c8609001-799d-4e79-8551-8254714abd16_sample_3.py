...
# Loop for repeated stakeholder meetings until consensus
skip = SilentTransition()
stakeholder_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[stakeholder_meet, skip]
)
...
root.order.add_edge(market_analysis, stakeholder_loop)
root.order.add_edge(stakeholder_loop, legal_review)
...
# Final approval must happen before asset registration
root.order.add_edge(final_approval, asset_registration)