...
# Loop for repeated fraud screening and legal compliance
loop_po = StrictPartialOrder(nodes=[fraud_screening, legal_compliance])
loop_po.order.add_edge(fraud_screening, legal_compliance)
loop = OperatorPOWL(operator=Operator.LOOP, children=[loop_po, fraud_screening])
...
root.order.add_edge(pattern_detect, loop)
