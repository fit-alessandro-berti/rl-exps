...
root = StrictPartialOrder(nodes=[
    ...
    climate_setup, nutrient_mix, seed_automation, pest_control,
    energy_audit, sensor_install, monitor_loop,
    waste_process, staff_train, community_link, yield_report
])
...
root.order.add_edge(monitor_loop, waste_process)
root.order.add_edge(waste_process, staff_train)
