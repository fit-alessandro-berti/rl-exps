...
# Loop: repeat aging with optional feedback-update at the end
aging_loop = OperatorPOWL(operator=Operator.LOOP, children=[aging_process, market_analysis])
...
root.order.add_edge(starter_culture,    temp_control)
root.order.add_edge(temp_control,       pressing_cheese)
...
root.order.add_edge(customer_feedback, market_analysis)