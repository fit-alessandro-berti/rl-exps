...
# Loop for seasonal adaptation: do Market Research, then either exit or do Recipe Adjust and repeat
seasonal_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[market_research, recipe_adjust]
)
...
root.order.add_edge(compliance_check,  seasonal_loop)
root.order.add_edge(seasonal_loop,     direct_shipping)
