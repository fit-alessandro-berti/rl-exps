...
# Loop for dynamic price adjustments
price_loop = OperatorPOWL(operator=Operator.LOOP, children=[price_adjust, price_adjust])
...
root.order.add_edge(bid_monitor, price_loop)
root.order.add_edge(price_loop, wallet_link)
