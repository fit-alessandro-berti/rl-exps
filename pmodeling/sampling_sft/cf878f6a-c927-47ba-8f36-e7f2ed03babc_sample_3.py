...
monitor_loop = OperatorPOWL(
    ...
    children=[monitor_growth, adjust_climate]
)
...
root.order.add_edge(mix_nutrients,    monitor_loop)
...
# Final audit must occur after all other activities
for activity in root.nodes:
    if activity != audit_systems:
        root.order.add_edge(activity, audit_systems)