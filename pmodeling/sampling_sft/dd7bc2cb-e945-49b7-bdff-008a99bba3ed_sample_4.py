...
# A = aging set, B = flavor/texture checks
aging_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[aging_set, FlavorCheckBranch]
)

# Define the XOR for flavor/texture checks
FlavorCheckBranch = StrictPartialOrder(nodes=[flavor_check, texture_scan])
# No explicit ordering in this branch; they can run concurrently
