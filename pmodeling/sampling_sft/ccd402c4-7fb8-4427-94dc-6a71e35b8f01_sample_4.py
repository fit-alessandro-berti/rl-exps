...
# Loop for continuous monitoring and yield forecasting
...
root.order.add_edge(climate_control, loop_monitoring)
root.order.add_edge(loop_monitoring, energy_plan)
