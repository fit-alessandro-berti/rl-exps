...
# Loop for continuous growth monitoring, pest inspection, and harvesting
loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[growth_monitor, pest_inspect, harvest_plan]
)
...
root = StrictPartialOrder(nodes=[
    ...
    loop, packaging_prep, distribution, sustainability
])
