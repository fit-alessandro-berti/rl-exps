...
# Loop for negotiation: do Initial Offer, then optionally Counter Offer then Initial Offer again
negotiation_loop = OperatorPOWL(operator=Operator.LOOP, children=[initial_offer, counter_offer])

# Build the partial order
root = StrictPartialOrder(nodes=[
    asset_id, value_assess, risk_scan, market_review,
    negotiation_loop,
    contract_draft, legal_review, digital_sign, royalty_setup,
    transfer_record, compliance_check, audit_schedule,
...
root.order.add_edge(market_review, negotiation_loop)
...
# Optional: add silent transitions for optional steps
# (e.g., if you want to skip compliance check or strategy update)
