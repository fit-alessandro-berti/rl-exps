...
root = StrictPartialOrder(nodes=[
    ...
    ai_integration, crop_monitor, growth_adjust,
    harvest_sort, packaging, distribution_plan,
...
root.order.add_edge(seed_select, ai_integration)
root.order.add_edge(nutrient_prep, ai_integration)
...
root.order.add_edge(harvest_sort, distribution_plan)
