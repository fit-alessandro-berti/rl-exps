...
root = StrictPartialOrder(nodes=[
    ...
    climate_setup, nutrient_mix, seed_automation,
    pest_control, energy_audit, sensor_install,
    growth_monitor, waste_process, data_analysis,
    staff_train, community_link, yield_report
])
...
monitor_loop = OperatorPOWL(operator=Operator.LOOP, children=[growth_monitor, data_analysis])

# Add the monitoring loop to the root
