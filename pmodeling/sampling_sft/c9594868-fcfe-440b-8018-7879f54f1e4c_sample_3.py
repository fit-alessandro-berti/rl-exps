...
# Loop for ongoing monitoring: Growth Monitor, Pest Control, Water Testing
monitor_loop = OperatorPOWL(operator=Operator.LOOP, children=[growth_monitor, pest_control, water_testing])

# Build the overall partial order
root = StrictPartialOrder(nodes=[
    site_survey, load_test, permit_review, design_layout, material_sourcing,
    soil_prep, hydroponic_setup, community_meet, crop_select,
    sensor_install, monitor_loop, harvest_plan, market_launch, feedback_collect
])
