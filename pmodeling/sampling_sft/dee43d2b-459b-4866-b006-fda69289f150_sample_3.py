...
monitor_loop = OperatorPOWL(
    ...
    children=[growth_monitoring, data_analysis]
)
...
root.order.add_edge(water_cycling,    monitor_loop)
root.order.add_edge(monitor_loop,     pest_detection)
root.order.add_edge(monitor_loop,     light_adjustment)
root.order.add_edge(pest_detection,   harvest_planning)
root.order.add_edge(light_adjustment, harvest_planning)
