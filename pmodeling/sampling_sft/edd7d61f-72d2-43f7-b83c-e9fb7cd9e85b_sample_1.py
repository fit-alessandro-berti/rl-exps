...
# Loop for expert consultations (can be repeated if needed)
expert_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[expert_consult, historical_match, forgery_detect]
)
...
root.order.add_edge(material_scan, imaging_capture)
root.order.add_edge(chemical_test, imaging_capture)
root.order.add_edge(imaging_capture, expert_loop)
root.order.add_edge(expert_loop, documentation_verify)
