...
design_loop = OperatorPOWL(operator=Operator.LOOP, children=[design_draft, aerodynamics_test, ai_integration])
...
root.order.add_edge(spec_finalize, design_loop)
root.order.add_edge(design_loop, material_sourcing)
root.order.add_edge(design_loop, component_order)
