...
# Loop for expert review and legal clearance (repeated until exit)
expert_loop = OperatorPOWL(operator=Operator.LOOP, children=[expert_review, legal_clearance])

# Build the partial order
root = StrictPartialOrder(nodes=[
    provenance_check, sample_collection, spectroscopy_test, carbon_dating,
    expert_loop, cultural_assessment, digital_scan, report_draft,
    stakeholder_meet, acquisition_vote, restoration_plan, condition_report,
...
root.order.add_edge(spectroscopy_test, expert_loop)
root.order.add_edge(carbon_dating, expert_loop)
root.order.add_edge(expert_loop, cultural_assessment)
