...
# Define the inner loop body (climate control -> pest management -> data calibration)
body = StrictPartialOrder(nodes=[climate_control, pest_management, data_calibration])
body.order.add_edge(climate_control, pest_management)
body.order.add_edge(pest_management, data_calibration)

# Define the loop: execute body, then optionally exit or repeat
...
# The final expansion plan can optionally follow any yield result
