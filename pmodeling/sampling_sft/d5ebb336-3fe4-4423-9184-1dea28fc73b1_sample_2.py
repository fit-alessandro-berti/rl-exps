...
# Loop for asynchronous updates: do Async Update, then optionally Rollback Trigger and repeat
async_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[async_update, rollback_trigger]
)
...
root.order.add_edge(behavior_analyze, async_loop)
root.order.add_edge(async_loop, compliance_check)
