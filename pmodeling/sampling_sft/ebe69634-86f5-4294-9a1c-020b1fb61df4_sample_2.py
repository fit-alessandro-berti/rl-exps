...
# Define the iterative refinement loop: Feedback Loop -> Model Refinement
loop_body = StrictPartialOrder(nodes=[feedback_loop, model_refinement])
loop_body.order.add_edge(feedback_loop, model_refinement)
...
root.order.add_edge(loop_body, license_draft)
