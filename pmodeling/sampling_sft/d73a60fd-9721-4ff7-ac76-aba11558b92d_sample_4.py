...
root = StrictPartialOrder(nodes=[
    ...
    permit_filing, foundation_prep, frame_build,
    irrigation_setup, lighting_install, climate_control,
    nutrient_mix, crop_planting, pest_scouting,
    data_monitoring, energy_audit, waste_sorting,
...
root.order.add_edge(frame_build,      lighting_install)
root.order.add_edge(frame_build,      climate_control)
...
root.order.add_edge(crop_planting,    waste_sorting)
root.order.add_edge(crop_planting,    community_meet)
root.order.add_edge(data_monitoring,  yield_analysis)
root.order.add_edge(energy_audit,     yield_analysis)
root.order.add_edge(waste_sorting,    yield_analysis)
root.order.add_edge(community_meet,   yield_analysis)
root.order.add_edge(yield_analysis,   yield_analysis)