...
# Build the loop for the testing and post-sale support
# A: Final Testing
# B: Client Training -> Diagnostics Setup
post_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[final_testing, client_training]
)
post_loop.children.append(diagnostics_setup)
