...
# Define the loop for ongoing monitoring and optimization
loop_body = StrictPartialOrder(nodes=[pest_control, data_gather, yield_optimize])
loop = OperatorPOWL(operator=Operator.LOOP, children=[pilot_crop, loop_body])
