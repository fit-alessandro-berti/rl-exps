...
root = StrictPartialOrder(nodes=[
    ...
    set_controls, test_modules, select_crops, configure_irrig,
    deploy_ai, monitor_pests, manage_energy, recycle_waste,
...
# No explicit loop here, all activities are executed in sequence