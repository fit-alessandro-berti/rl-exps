...
# Define the iterative growth monitoring loop:
# A = Monitor Growth
# B = Manage Pests
...
root = StrictPartialOrder(nodes=[
    site_survey, design_modules, source_materials,
    install_framework, setup_irrigation, integrate_sensors,
    configure_ai, select_crops, calibrate_climate,
    plant_seeds, loop, recycle_waste, engage_community,
...
root.order.add_edge(plant_seeds, loop)
root.order.add_edge(loop, recycle_waste)
