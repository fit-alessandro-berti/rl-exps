...
root.order.add_edge(module_assembly, sensor_install)
...
# Concurrent growth monitoring and pest control
root.order.add_edge(planting_phase, growth_monitor)
root.order.add_edge(planting_phase, pest_control)

# After growth and pest, concurrent harvest and yield audit
...
# Concurrent packaging and market delivery
root.order.add_edge(yield_audit, packaging_prep)
root.order.add_edge(yield_audit, market_delivery)

# Waste recycling is independent of all other activities
root.order.add_edge(site_analysis, waste_recycling)
root.order.add_edge(design_layout, waste_recycling)
root.order.add_edge(module_assembly, waste_recycling)
root.order.add_edge(climate_setup, waste_recycling)
root.order.add_edge(sensor_install, waste_recycling)
root.order.add_edge(water_testing, waste_recycling)
root.order.add_edge(nutrient_mix, waste_recycling)
root.order.add_edge(seed_selection, waste_recycling)
root.order.add_edge(planting_phase, waste_recycling)
root.order.add_edge(growth_monitor, waste_recycling)
root.order.add_edge(pest_control, waste_recycling)
root.order.add_edge(harvest_plan, waste_recycling)
root.order.add_edge(yield_audit, waste_recycling)
root.order.add_edge(packaging_prep, waste_recycling)
