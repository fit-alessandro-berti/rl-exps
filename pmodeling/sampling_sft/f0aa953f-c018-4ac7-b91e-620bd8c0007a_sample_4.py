...
root.order.add_edge(climate_setup, seedling_prep)
root.order.add_edge(light_calibration, seedling_prep)
...
root.order.add_edge(data_integration, regulation_check)
root.order.add_edge(energy_audit, operational_test)
