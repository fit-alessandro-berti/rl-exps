...
# Loop for continuous yield review and optimization
yield_loop = OperatorPOWL(operator=Operator.LOOP, children=[yield_review, yield_review])
...
root = StrictPartialOrder(nodes=[
    ...
    market_analysis, plan_logistics, yield_loop
])
...
root.order.add_edge(plan_logistics, yield_loop)