...
root = StrictPartialOrder(nodes=[
    ...
    crop_selection, material_order, planter_setup, irrigation_install,
    sensor_deploy, solar_setup, data_integration, community_meet,
    training_session, yield_monitor, adjust_plan
])
...
root.order.add_edge(irrigation_install, data_integration)
...
# The final node (adjust_plan) can optionally start the process again
root.order.add_edge(adjust_plan, site_survey)