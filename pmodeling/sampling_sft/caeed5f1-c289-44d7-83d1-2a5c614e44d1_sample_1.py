...
feedback_loop_body = StrictPartialOrder(nodes=[concept_draft, feedback_loop])
feedback_loop_body.order.add_edge(concept_draft, feedback_loop)
feedback_loop_body.order.add_edge(feedback_loop, concept_draft)
