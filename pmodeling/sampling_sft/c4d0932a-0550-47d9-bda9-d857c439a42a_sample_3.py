...
# Define the feedback collection loop: do Customer Feedback, then optionally do Demand Forecast and Retail Outreach, then repeat
feedback_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[customer_feedback, DemandForecastRetailLoop]
)

# Define the demand forecast and retail outreach sub‐process (optional)
demand_forecast_retail_loop = StrictPartialOrder(nodes=[demand_forecast, retail_outreach])
demand_forecast_retail_loop.order.add_edge(demand_forecast, retail_outreach)
