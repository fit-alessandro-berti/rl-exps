...
# Define the maintenance loop: Climate Control is repeated until exit
maintenance_loop = OperatorPOWL(operator=Operator.LOOP, children=[climate_control, climate_control])
