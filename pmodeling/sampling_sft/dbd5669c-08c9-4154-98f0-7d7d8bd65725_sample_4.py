...
# Loop for continuous yield analysis and community engagement
# A: Yield Analysis
# B: Community Meet
skip = SilentTransition()
loop = OperatorPOWL(operator=Operator.LOOP, children=[yield_analysis, community_meet])

# Build the partial‐order workflow
root = StrictPartialOrder(nodes=[
    site_survey, design_layout, material_sourcing, unit_assembly,
    system_wiring, sensor_install, water_testing, nutrient_mix,
    seed_selection, planting_setup, climate_control, pest_management,
    data_calibration, loop, compliance_check, expansion_plan
])
