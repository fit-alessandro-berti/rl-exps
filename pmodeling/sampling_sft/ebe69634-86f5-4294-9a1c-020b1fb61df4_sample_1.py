...
root = StrictPartialOrder(nodes=[
    client_intake, needs_analysis, developer_match, expert_vetting,
    prototype_build, feedback_loop, model_refinement,
    license_draft, ip_negotiation, contract_sign,
    deployment_prep, go_live, monitor_model, optimize_ai, support_handoff,
    compliance_check, final_review
])
...
# The final review must happen after all others
for activity in [monitor_model, optimize_ai, support_handoff, compliance_check]:
    root.order.add_edge(activity, final_review)
