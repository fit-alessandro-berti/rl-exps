...
# Loop for expert review and legal audit
# LOOP: Expert Review, then either exit or do Legal Audit and back to Expert Review
expert_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[expert_review, legal_audit]
)
...
root.order.add_edge(digital_capture, expert_loop)
root.order.add_edge(expert_loop, database_search)
