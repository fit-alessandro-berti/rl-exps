...
# Loop for seasonal aging under controlled conditions
aging_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[humidity_control, temperature_aging]
)
...
root.order.add_edge(aging_loop, rind_brushing)
...
# Ensure the feedback‐collection loop starts after certification
root.order.add_edge(certification_audit, customer_feedback)