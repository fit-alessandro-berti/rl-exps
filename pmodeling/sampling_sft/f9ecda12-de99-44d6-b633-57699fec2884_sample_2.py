...
# Loop for continuous weather monitoring and inspections
monitor_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[weather_monitor, quality_inspect]
)
...
root = StrictPartialOrder(nodes=[
    ...
    monitor_loop, public_unveil, maintenance_plan, stakeholder_meet
])
...
root.order.add_edge(assemble_onsite, monitor_loop)
root.order.add_edge(monitor_loop, public_unveil)
