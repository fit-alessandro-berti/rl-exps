...
# Define the monitoring loop: Growth Monitor then either exit or repeat Pest Control -> Growth Monitor
...
root = StrictPartialOrder(nodes=[
    ...
    hydro_install, lighting_setup, climate_ctrl,
    seed_select, nutrient_mix, water_recycle, sensor_deploy,
    monitor_loop,
    harvest_plan, packaging_prep, delivery_route,
...
root.order.add_edge(lighting_setup,  climate_ctrl)
root.order.add_edge(climate_ctrl,    seed_select)
...
# Follow-up activities after monitoring loop
