...
# Loop for continuous improvement: Data Review then either exit or do Data Review again
loop_improvement = OperatorPOWL(operator=Operator.LOOP, children=[data_review, data_review])
...
root = StrictPartialOrder(nodes=[
    ...
    supply_sync, staff_train, loop_improvement
])
...
root.order.add_edge(staff_train, loop_improvement)