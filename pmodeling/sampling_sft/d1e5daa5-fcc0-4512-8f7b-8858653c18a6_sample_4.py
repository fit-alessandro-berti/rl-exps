...
# Loop for continuous system monitoring
loop_monitor = OperatorPOWL(operator=Operator.LOOP, children=[monitor_systems, monitor_systems])

# Build the partial order
root = StrictPartialOrder(nodes=[
    site_survey, regulation_check, design_modules,
    install_hydroponics, integrate_sensors, calibrate_nutrients,
    program_climate, select_crops, optimize_lighting, train_staff,
...
root.order.add_edge(plan_logistics, loop_monitor)