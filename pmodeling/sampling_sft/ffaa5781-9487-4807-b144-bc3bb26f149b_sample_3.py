...
# Build the loop body: consensus_meeting -> final_approval
body = StrictPartialOrder(nodes=[consensus_meeting, final_approval])
body.order.add_edge(consensus_meeting, final_approval)

# Loop: do all activities first, then optionally run the body again
loop = OperatorPOWL(operator=Operator.LOOP, children=[provenance_check,
                                                      radiocarbon_test,
                                                      material_analysis,
                                                      microscopic_scan,
                                                      expert_review,
