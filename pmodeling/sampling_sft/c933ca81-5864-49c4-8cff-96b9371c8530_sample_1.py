...
# Define the loop for environmental testing and quality checking
loop_env_qual = OperatorPOWL(
    operator=Operator.LOOP,
    children=[environmental_test, quality_check]
)

# Build the top-level partial order
root = StrictPartialOrder(nodes=[
    client_consult, spec_finalize, design_draft,
...
root.order.add_edge(firmware_install, loop_env_qual)
root.order.add_edge(loop_env_qual, brand_packaging)
