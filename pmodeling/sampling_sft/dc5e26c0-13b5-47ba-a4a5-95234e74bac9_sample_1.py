...
# Loop for continuous monitoring and system improvements
monitoring_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[data_review, system_upgrade]
)

# Build the overall partial order
root = StrictPartialOrder(nodes=[
    site_survey, design_layout, climate_setup, sensor_install,
    nutrient_mix, automation_code, crop_planning, pest_control,
    energy_audit, waste_sort, planting_tier, harvest_prep,
    logistics_plan, community_meet, monitoring_loop
])
