...
monitor_loop = OperatorPOWL(operator=Operator.LOOP, children=[sensor_deploy, pest_control])

# Build the partial order
root = StrictPartialOrder(nodes=[
    site_survey, rack_design, system_setup, climate_calibrate, nutrient_prep,
    crop_select, seed_germinate, monitor_loop,
    harvest_automate, quality_check, pack_produce,
    data_analyze, engage_community, logistics_plan
])
...
root.order.add_edge(seed_germinate, monitor_loop)
