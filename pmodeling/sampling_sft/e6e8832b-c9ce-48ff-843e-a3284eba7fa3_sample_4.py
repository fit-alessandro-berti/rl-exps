...
# Build the loop for monitoring bids and fraud detection
bid_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[bid_monitoring, fraud_detection]
)
...
root.order.add_edge(bid_loop, ownership_transfer)
