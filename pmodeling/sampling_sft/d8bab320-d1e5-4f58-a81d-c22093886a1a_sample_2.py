...
# Build the loop body: Aging Setup -> Humidity Control -> Flavor Testing
aging_loop_body = StrictPartialOrder(nodes=[aging_setup, humidity_control, flavor_testing])
aging_loop_body.order.add_edge(aging_setup, humidity_control)
aging_loop_body.order.add_edge(humidity_control, flavor_testing)

# LOOP: repeat the aging_loop_body until exit
aging_loop = OperatorPOWL(operator=Operator.LOOP, children=[aging_loop_body, SilentTransition()])
