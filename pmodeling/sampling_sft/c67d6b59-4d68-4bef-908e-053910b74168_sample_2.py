...
# Loop for iterative feedback and design adjustments
...
root.order.add_edge(quality_test, feedback_loop)
root.order.add_edge(feedback_loop, quality_test)  # loop back
...
root.order.add_edge(skip, quality_test)  # loop back