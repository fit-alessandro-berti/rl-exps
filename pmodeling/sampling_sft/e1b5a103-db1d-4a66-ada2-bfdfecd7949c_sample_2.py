...
root = StrictPartialOrder(nodes=[
    ...
    health_monitor, pest_control, robotic_harvest,
    clean_packaging, distribution_plan, data_collection, cycle_feedback
])
...
# The loop: repeat data_collection -> cycle_feedback until exit
loop = OperatorPOWL(operator=Operator.LOOP, children=[data_collection, cycle_feedback])

# Finalize the root partial order with the loop
root.order.add_edge(robotic_harvest, loop)
