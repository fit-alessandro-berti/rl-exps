...
root = StrictPartialOrder(nodes=[
    seed_selection, germination_setup, nutrient_mix, water_control,
    climate_adjust, sensor_monitor, lighting_tune, airflow_manage,
    health_scan, pest_control, harvest_timing, cold_storage, package_prep,
    delivery_plan, feedback_loop
])
...
root.order.add_edge(sensor_monitor, airflow_manage)
root.order.add_edge(lighting_tune, health_scan)
...
# Close the feedback loop: exit the process after delivery
