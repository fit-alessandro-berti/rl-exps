...
# A: Growth Monitor -> Water Recirc
# B: Pest Inspection -> Bio Control
monitor_loop = OperatorPOWL(operator=Operator.LOOP, children=[growth_monitor, water_recirc])
pest_loop    = OperatorPOWL(operator=Operator.LOOP, children=[pest_inspection, bio_control])
...
root.order.add_edge(light_scheduling,  pest_loop)
root.order.add_edge(pest_loop,         monitor_loop)
