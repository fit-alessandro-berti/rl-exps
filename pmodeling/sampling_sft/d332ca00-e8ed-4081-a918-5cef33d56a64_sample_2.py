...
root = StrictPartialOrder(nodes=[
    intake, visual, imaging, material, database,
    provenance, expert, carbon, forensic,
    loop, report, insurance, storage, final
])

# Sequence edges
root.order.add_edge(intake, visual)
root.order.add_edge(intake, imaging)
root.order.add_edge(visual, material)
