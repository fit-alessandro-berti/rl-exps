...
root = StrictPartialOrder(nodes=[
    site_survey, permit_approval, design_layout, system_procure,
    nutrient_prep, structure_build, sensor_install, climate_setup,
    seed_select, germinate_seeds, loop_monitor,
    pest_control, harvest_crop, package_goods, ship_products
])
