...
# Define the loop body: aging control, flavor profiling, packaging prep, climate packing
body = StrictPartialOrder(nodes=[aging_control, flavor_profiling, packaging_prep, climate_packing])
# Body is concurrent (no order edges)

# Define the loop: do aging, then either exit or do the loop body and repeat
aging_loop = OperatorPOWL(operator=Operator.LOOP, children=[aging_control, body])
...
root.order.add_edge(aging_loop,        export_licensing)
