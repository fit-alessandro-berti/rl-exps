...
# Define the iterative feedback loop: do Data Analysis, then optionally Feedback Loop and repeat
feedback_loop_body = StrictPartialOrder(nodes=[data_analysis, feedback_loop])
feedback_loop_body.order.add_edge(data_analysis, feedback_loop)
feedback_loop_node = OperatorPOWL(operator=Operator.LOOP, children=[feedback_loop_body, feedback_loop])
...
root.order.add_edge(community_meet, feedback_loop_node)
root.order.add_edge(feedback_loop_node, yield_forecast)
