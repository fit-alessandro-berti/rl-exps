...
# Loop for repeated risk assessment and digital archiving
risk_loop = OperatorPOWL(operator=Operator.LOOP, children=[risk_assess, digital_archive])
...
root.order.add_edge(insurance_quote, risk_loop)
root.order.add_edge(risk_loop, replica_build)
