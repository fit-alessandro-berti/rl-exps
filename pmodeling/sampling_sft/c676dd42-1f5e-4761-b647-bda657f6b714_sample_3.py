...
loop_growth = OperatorPOWL(operator=Operator.LOOP, children=[growth_monitoring, pest_control])
...
root = StrictPartialOrder(nodes=[
    ...
    data_integration, loop_growth,
    waste_sorting, harvest_plan, produce_pack,
    energy_audit, community_setup
])
...
root.order.add_edge(data_integration, loop_growth)
root.order.add_edge(loop_growth, waste_sorting)
root.order.add_edge(loop_growth, harvest_plan)
root.order.add_edge(waste_sorting, produce_pack)
