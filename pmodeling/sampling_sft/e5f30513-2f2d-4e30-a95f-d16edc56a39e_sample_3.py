...
prelim_inspect     = Transition(label='Preliminary Inspect')
...
# Loop for parallel expert consultations and stylistic assessments
expert_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[expert_consult, stylistic_assess]
)
...
root.order.add_edge(intake_review, prelim_inspect)
root.order.add_edge(prelim_inspect, provenance_check)
...
root.order.add_edge(radiocarbon_date, expert_loop)
