...
# Loop: monitor weather, then either exit or repeat
loop_weather = OperatorPOWL(operator=Operator.LOOP, children=[weather_monitor, skip])
...
root = StrictPartialOrder(nodes=[
    ...
    quality_inspect, loop_weather, public_unveil, maintenance_plan,
    stakeholder_meet
])
...
root.order.add_edge(quality_inspect, loop_weather)
root.order.add_edge(loop_weather, quality_inspect)  # loop condition
root.order.add_edge(loop_weather, public_unveil)    # loop exit
