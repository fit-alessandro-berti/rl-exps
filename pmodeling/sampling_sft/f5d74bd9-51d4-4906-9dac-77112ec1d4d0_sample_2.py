...
# Loop for continuous sustainability evaluation: do Sustainability Check, then optionally repeat
loop_sustainability = OperatorPOWL(
    operator=Operator.LOOP,
    children=[sustainability_check, sustainability_check]
)
...
root.order.add_edge(community_engage, loop_sustainability)

# Final edge from sustainability loop back to itself (optional exit)
root.order.add_edge(loop_sustainability, loop_sustainability)