...
# Loop for continuous growth monitoring and climate adjustments
growth_loop = OperatorPOWL(operator=Operator.LOOP, children=[monitor_growth, adjust_climate])

# Build the overall partial order
root = StrictPartialOrder(nodes=[
    site_assess, zoning_check, design_farm, procure_gear,
    install_systems, setup_sensors, select_crops, prepare_seeds,
    mix_nutrients, growth_loop, robotic_harvest, grade_quality,
    pack_produce, manage_logistics, market_products, recycle_waste,
    audit_systems
])
...
root.order.add_edge(mix_nutrients,    growth_loop)
root.order.add_edge(growth_loop,      robotic_harvest)
