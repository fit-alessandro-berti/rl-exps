...
root = StrictPartialOrder(nodes=[
    site_assess, permit_obtain, soil_testing, crop_select,
    irrigation_setup, drainage_install, energy_integrate,
    staff_train, pest_control, logistics_plan, supply_coordinate,
    distribution_map, community_engage, monitoring_setup, yield_optimize
])
...
root.order.add_edge(crop_select, energy_integrate)
root.order.add_edge(irrigation_setup, staff_train)
root.order.add_edge(drainage_install, staff_train)
...
root.order.add_edge(staff_train, supply_coordinate)
root.order.add_edge(pest_control, monitoring_setup)
root.order.add_edge(logistics_plan, distribution_map)
root.order.add_edge(supply_coordinate, distribution_map)
root.order.add_edge(monitoring_setup, community_engage)
root.order.add_edge(community_engage, yield_optimize)
