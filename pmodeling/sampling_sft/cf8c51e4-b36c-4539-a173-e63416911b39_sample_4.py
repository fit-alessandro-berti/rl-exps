...
# Define the loop body: Pest Control -> Growth Monitor
body = StrictPartialOrder(nodes=[pest_control, growth_monitor])
# No edges => these two happen concurrently

# Define the loop: do Pest Control -> Growth Monitor, then optionally repeat
...
root = StrictPartialOrder(nodes=[
    ...
    hydroponic_setup, climate_control, nutrient_design,
    staff_hiring, staff_training, software_install, system_testing,
    crop_planting, loop, harvest_plan
])
