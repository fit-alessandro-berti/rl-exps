...
# Loop for continuous scent profiling and client feedback until satisfied
loop_profiling = OperatorPOWL(
    operator=Operator.LOOP,
    children=[scent_profiling, client_feedback]
)
...
root.order.add_edge(batch_mixing, loop_profiling)
root.order.add_edge(loop_profiling, release_scheduling)
