...
# Define the choice for final output: either display or loan
output_choice = OperatorPOWL(
...
root.order.add_edge(catalog_entry, monitor_setup)

# Final choice branch
root.order.add_edge(monitor_setup, output_choice)