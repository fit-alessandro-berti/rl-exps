...
loop = OperatorPOWL(operator=Operator.LOOP, children=[customer_feedback, recipe_adjusting])

# Build the partial‐order workflow
root = StrictPartialOrder(nodes=[
    milk_sourcing, quality_testing, starter_culture, milk_fermentation,
    curd_cutting, whey_draining, pressing_cheese, cave_aging,
    sample_tasting, flavor_profiling, packaging_design,
    cold_storage, logistics_planning, pop_up_sales, loop
])
...
root.order.add_edge(pop_up_sales, loop)