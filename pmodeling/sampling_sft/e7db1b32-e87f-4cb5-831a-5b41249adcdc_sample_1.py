...
# Define the data analysis loop: analyze then optionally check
...
# Parallel after harvesting
root.order.add_edge(harvesting_ops, waste_composting)
root.order.add_edge(harvesting_ops, water_recycling)

# Convergence to packaging and logistics
root.order.add_edge(waste_composting, eco_packaging)
