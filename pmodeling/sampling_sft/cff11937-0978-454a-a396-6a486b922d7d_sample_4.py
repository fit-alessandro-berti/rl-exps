...
# Loop for iterative flavor profiling and recipe adjustment
loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[flavor_profiling, recipe_adjusting]
)
...
root.order.add_edge(sample_tasting, loop)
root.order.add_edge(loop, packaging_design)
...
# Close the loop: after each pop-up sales, customer feedback starts
root.order.add_edge(pop_up_sales, customer_feedback)

# Close the feedback loop: after each feedback, the loop starts again
