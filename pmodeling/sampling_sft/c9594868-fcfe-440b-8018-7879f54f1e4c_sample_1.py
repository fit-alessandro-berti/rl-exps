...
# Loop for ongoing monitoring: repeat Growth Monitor until exit
monitor_loop = OperatorPOWL(operator=Operator.LOOP, children=[growth_monitor, None])

# Build the partial order
root = StrictPartialOrder(nodes=[
    site_survey, load_test, permit_review, design_layout,
    material_sourcing, soil_prep, hydroponic_setup,
    community_meet, crop_select, sensor_install,
    water_testing, pest_control, monitor_loop,
    harvest_plan, market_launch, feedback_collect
])
