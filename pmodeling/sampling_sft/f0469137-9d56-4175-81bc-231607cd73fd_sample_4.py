...
monitor_loop = OperatorPOWL(
    ...
    children=[iot_monitoring, pest_detection]
)

# XOR choice for either drone pollination or pesticide spray
pollinate_or_spray = OperatorPOWL(
...
root = StrictPartialOrder(nodes=[
    ...
    pollinate_or_spray, robotic_harvest, quality_check,
    package_product, waste_recycle, energy_optimize, data_logging
])
...
root.order.add_edge(monitor_loop, pollinate_or_spray)
root.order.add_edge(pollinate_or_spray, robotic_harvest)
