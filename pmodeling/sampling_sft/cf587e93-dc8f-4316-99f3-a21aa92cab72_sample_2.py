...
# Loop for continuous growth monitoring and control
growth_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[growth_scan, pest_control, water_cycle]
)

# Build the overall partial order
root = StrictPartialOrder(nodes=[
    seed_select, nutrient_mix, sensor_setup, env_monitor,
    growth_loop, harvest_robo, yield_assess, waste_process,
    energy_sync, pack_biodeg, market_track, order_align,
    logistics_plan, feedback_loop
])
...
root.order.add_edge(growth_loop, harvest_robo)
