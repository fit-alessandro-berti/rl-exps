...
root = StrictPartialOrder(nodes=[
    ...
    climate_setup, led_install, sensor_deploy,
    pest_control, waste_recycle, hydro_test,
    staff_train, yield_forecast, market_plan,
    data_review
])
...
root.order.add_edge(yield_forecast, data_review)
