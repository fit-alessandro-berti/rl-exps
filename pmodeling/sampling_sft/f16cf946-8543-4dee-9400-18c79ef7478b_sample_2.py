...
# Loop for continuous process improvement: do Data Review, then either exit or repeat
...
# The loop body (Data Review) is implicitly the second child of the LOOP operator
# Since it is a silent transition, it doesn't have an explicit edge in the order