...
# Loop for continuous yield monitoring and maintenance checks
...
root = StrictPartialOrder(nodes=[
    site_survey, permit_review, design_layout, system_assembly,
    climate_setup, nutrient_prep, irrigation_test, lighting_config,
    energy_install, sensor_setup, automation_deploy, crop_seeding,
    waste_plan, staff_training, community_outreach, monitor_loop
])
...
root.order.add_edge(community_outreach, monitor_loop)