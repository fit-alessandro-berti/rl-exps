...
# Loop for iterative material sourcing and fabrication
material_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[source_materials, fabricate_parts]
)
...
root.order.add_edge(stabilize_structure, material_loop)
root.order.add_edge(material_loop, perform_repairs)
