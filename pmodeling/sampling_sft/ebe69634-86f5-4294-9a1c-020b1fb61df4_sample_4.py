...
# Loop for iterative refinement: Feedback Loop -> Model Refinement, repeated until exit
refinement_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[feedback_loop, model_refinement]
)
...
root.order.add_edge(refinement_loop,   license_draft)
