...
# Define the monitoring‐loop: do Growth Monitoring, then optionally do Pest Control and repeat
monitoring_loop = OperatorPOWL(operator=Operator.LOOP, children=[growth_monitoring, pest_control])
...
root.order.add_edge(environmental_audit, monitoring_loop)
root.order.add_edge(monitoring_loop, market_launch)