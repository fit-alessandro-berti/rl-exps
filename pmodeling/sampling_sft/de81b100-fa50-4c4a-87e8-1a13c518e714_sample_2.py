...
# Loop for the crop cycle: do Crop Cycle, then optionally do Data Monitor & Harvest Plan, repeat until exit
loop_body = StrictPartialOrder(nodes=[data_monitor, harvest_plan])
loop_body.order.add_edge(data_monitor, harvest_plan)
crop_loop = OperatorPOWL(operator=Operator.LOOP, children=[crop_cycle, loop_body])
...
root.order.add_edge(crop_loop, distribution)