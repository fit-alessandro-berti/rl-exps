...
# Loop for iterative data analysis, pest monitoring, and feedback
loop_analysis = OperatorPOWL(
    operator=Operator.LOOP,
    children=[data_analysis, pest_monitor]
)

# Build the partial order
root = StrictPartialOrder(nodes=[
    site_survey, structural_check, climate_study, soil_prep,
    seed_selection, irrigation_setup, nutrient_mix, sensor_install,
    loop_analysis, regulation_review, community_meet, harvest_plan,
    packaging_design, distribution_map, feedback_loop, maintenance_sched
])
...
root.order.add_edge(sensor_install, loop_analysis)
root.order.add_edge(loop_analysis, regulation_review)
