...
# Loop for fabricating gears if needed
fabricate_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[fabricate_gears, fabricate_gears]
)
...
root.order.add_edge(initial_assess, disassemble)
root.order.add_edge(disassemble, ultrasonic_clean)
root.order.add_edge(ultrasonic_clean, inspect_components)
root.order.add_edge(inspect_components, fabricate_loop)
root.order.add_edge(fabricate_loop, dial_restoration)
