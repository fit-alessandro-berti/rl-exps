...
# Define the loop for flight calibration and environmental testing
# Each iteration: Flight Calibrate -> Enviro Test
flight_loop = OperatorPOWL(operator=Operator.LOOP, children=[flight_calibrate, enviro_test])
...
root.order.add_edge(software_sync,    flight_loop)
root.order.add_edge(flight_loop,      remote_pair)
