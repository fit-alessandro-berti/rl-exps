...
# Loop for continuous restoration tracking after each shipment
restoration_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[restoration_track, SilentTransition()]
)
...
root.order.add_edge(restoration_plan,  restoration_loop)
