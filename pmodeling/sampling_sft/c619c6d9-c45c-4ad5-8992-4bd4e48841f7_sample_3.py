...
# Define the iterative flight testing loop:
#   A = Flight Testing -> Data Analyze -> Regulation Check
#   B = Quality Inspect
loop_flight = OperatorPOWL(
    operator=Operator.LOOP,
    children=[flight_testing, data_analyze, regulation_check, quality_inspect]
)
...
root.order.add_edge(software_load, loop_flight)
root.order.add_edge(loop_flight, packaging_prep)
