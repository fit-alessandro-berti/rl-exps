...
# Define the expert review loop: after initial survey, experts review then choose to exit or repeat
expert_loop = OperatorPOWL(operator=Operator.LOOP, children=[expert_review, initial_survey])
...
root.order.add_edge(material_test, digital_tagging)
...
root.order.add_edge(digital_tagging, expert_loop)
