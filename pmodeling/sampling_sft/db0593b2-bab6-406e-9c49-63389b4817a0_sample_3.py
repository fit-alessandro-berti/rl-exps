...
root = StrictPartialOrder(nodes=[
    ...
    pest_monitor, staff_training, energy_integrate,
    data_analytics, waste_recycle, market_develop, yield_optimize, climate_sim
])
...
root.order.add_edge(crop_selection, lighting_cal)
...
root.order.add_edge(data_analytics, climate_sim)