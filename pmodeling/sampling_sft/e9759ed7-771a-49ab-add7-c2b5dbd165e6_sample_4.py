...
# Loop: after each feedback, either exit or repeat
loop_feedback = OperatorPOWL(operator=Operator.LOOP, children=[client_feedback, skip])
...
root.order.add_edge(scent_profiling, loop_feedback)
root.order.add_edge(loop_feedback, release_scheduling)
