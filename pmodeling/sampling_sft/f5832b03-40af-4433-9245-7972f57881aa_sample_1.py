...
# Loop for continuous data analysis and quality audit
...
root = StrictPartialOrder(nodes=[
    site_survey, design_layout, legal_review, tech_sourcing,
    structural_build, climate_setup, irrigation_install,
    sensor_deploy, crop_select, nutrient_prep, waste_system,
    automation_config, trial_growth, analysis_loop,
    stakeholder_meet, compliance_check
])
...
root.order.add_edge(nutrient_prep, automation_config)
root.order.add_edge(automation_config, trial_growth)
root.order.add_edge(trial_growth, analysis_loop)
root.order.add_edge(analysis_loop, trial_growth)
root.order.add_edge(trial_growth, stakeholder_meet)
