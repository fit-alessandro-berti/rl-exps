...
root = StrictPartialOrder(nodes=[
    ...
    crop_harvest, maintenance, community_meet
])
...
root.order.add_edge(data_monitor, maintenance)
root.order.add_edge(data_monitor, community_meet)

# Crop harvest and maintenance can happen in parallel
root.order.add_edge(crop_harvest, maintenance)
root.order.add_edge(crop_harvest, community_meet)

# Community meet can happen in parallel with both maintenance and crop harvest
root.order.add_edge(community_meet, maintenance)
root.order.add_edge(community_meet, crop_harvest)