...
loop_body = StrictPartialOrder(nodes=[data_analytics, yield_optimize])
...
root.order.add_edge(hydro_config, lighting_setup)
root.order.add_edge(aero_tune, lighting_setup)
