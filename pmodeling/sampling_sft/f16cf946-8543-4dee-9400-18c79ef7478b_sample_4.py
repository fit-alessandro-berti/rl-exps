...
# Define the monitoring loop: do Sensor Setup, then either exit or do Nutrient Mix and Sensor Setup again
monitoring_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[sensor_setup, nutrient_mix]
)
...
root.order.add_edge(unit_install,    monitoring_loop)
