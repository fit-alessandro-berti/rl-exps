...
# Loop for the aging and tasting sequence
# A: Aging Control, B: Flavor Tasting
aging_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[aging_control, flavor_tasting]
)
...
root.order.add_edge(aging_loop, packaging_artisanal)
