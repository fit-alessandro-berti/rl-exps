...
# Loop for continuous quality checks and microbial tests
# A = Quality Check, B = Microbial Test
quality_loop = OperatorPOWL(operator=Operator.LOOP, children=[quality_check, microbial_test])

# Build the partial order
root = StrictPartialOrder(nodes=[
    milk_sourcing, curd_preparation, starter_culture,
    temperature_control, pressing_cheese, salting_stage,
    aging_process, quality_loop,
    eco_packaging, label_printing, inventory_audit,
    order_processing, retail_shipping, customer_feedback,
...
root.order.add_edge(aging_process, quality_loop)
root.order.add_edge(quality_loop, eco_packaging)
