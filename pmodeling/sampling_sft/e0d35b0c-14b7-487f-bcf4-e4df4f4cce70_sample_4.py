...
root = StrictPartialOrder(nodes=[
    ...
    growth_monitor, data_logging, harvest_event,
...
# Optional: add a concurrent loop for feedback collection after harvest
# feedback_loop = OperatorPOWL(operator=Operator.LOOP, children=[feedback_collect, feedback_collect])
# root.order.add_edge(harvest_event, feedback_loop)
# root.order.add_edge(feedback_loop, harvest_event)
