...
# Loop for ongoing sustainability checks
loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[sustainability_check]
)

# Build the partial order
root = StrictPartialOrder(nodes=[
    site_review, impact_study, design_plan, structure_mod,
    hydroponics_setup, crop_select, nutrient_mix,
    pest_control, sensor_install, staff_train,
    compliance_audit, packaging_dev, logistics_plan,
    community_engage, loop
])
...
# Ongoing sustainability check loop
