...
# Loop for continuous monitoring and incident management
monitor_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[usage_track, incident_manage]
)
...
root.order.add_edge(fleet_deploy, monitor_loop)
root.order.add_edge(monitor_loop, billing_process)
