...
# Define the loop for continuous crop production (A, B)
A = StrictPartialOrder(nodes=[water_cycle, nutrient_mix, lighting_adjust])
B = StrictPartialOrder(nodes=[harvest_plan, delivery_setup, market_align])
