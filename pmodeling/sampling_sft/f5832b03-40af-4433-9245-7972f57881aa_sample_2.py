...
root = StrictPartialOrder(nodes=[
    ...
    structural_build, climate_setup, irrigation_install, sensor_deploy,
    crop_select, nutrient_prep, waste_system, automation_config,
    trial_growth, data_analysis, quality_audit, stakeholder_meet,
    compliance_check
])
...
# No loops or exclusive choices; all activities are concurrent