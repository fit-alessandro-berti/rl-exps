...
monitor_loop = OperatorPOWL(
    ...
    children=[pest_control, optimize_energy, recycle_water]
)
...
root.order.add_edge(setup_hydro, prepare_nutrients)
...
root.order.add_edge(deploy_sensors, monitor_loop)
root.order.add_edge(monitor_loop, automate_harvest)
