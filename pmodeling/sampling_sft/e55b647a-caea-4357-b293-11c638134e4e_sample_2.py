...
# Build the loop for iterative review & consensus
loop_body = StrictPartialOrder(nodes=[interim_report, department_review])
loop_body.order.add_edge(interim_report, department_review)

loop = OperatorPOWL(operator=Operator.LOOP, children=[loop_body, consensus_meeting])
...
root.order.add_edge(data_documentation, loop)
