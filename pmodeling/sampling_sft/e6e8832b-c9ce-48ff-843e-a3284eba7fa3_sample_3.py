...
# Loop for continuous fraud detection and monitoring
fraud_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[fraud_detection, bid_monitoring]
)
...
root.order.add_edge(auction_setup, fraud_loop)
root.order.add_edge(fraud_loop, ownership_transfer)
