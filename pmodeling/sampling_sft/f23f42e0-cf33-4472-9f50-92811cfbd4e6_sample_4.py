...
# Aging consists of climate control and quality tasting in parallel
aging = StrictPartialOrder(nodes=[climate_control, quality_tasting])
# No additional edges => they can run in parallel

# Define the loop for the aging sub‐process
# Loop: do climate control, then optionally do quality tasting and repeat
