...
# Loop for sequential analysis (Material Analysis, Spectroscopy Test, Carbon Dating)
analysis_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[material_analysis, spectroscopy_test, carbon_dating]
)
...
root.order.add_edge(archive_research, analysis_loop)
root.order.add_edge(expert_interview, analysis_loop)
root.order.add_edge(analysis_loop, digital_imaging)
root.order.add_edge(analysis_loop, three_d_modeling)
