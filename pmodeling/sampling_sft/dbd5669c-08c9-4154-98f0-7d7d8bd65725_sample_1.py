...
loop_body = StrictPartialOrder(nodes=[yield_analysis, community_meet])
loop_body.order.add_edge(yield_analysis, community_meet)
yield_loop = OperatorPOWL(operator=Operator.LOOP, children=[loop_body, loop_body])
...
root.order.add_edge(data_calibration, yield_loop)
root.order.add_edge(yield_loop, compliance_check)
