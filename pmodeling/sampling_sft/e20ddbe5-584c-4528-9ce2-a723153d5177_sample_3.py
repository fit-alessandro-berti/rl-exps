...
install_irrig    = Transition(label='Install Irrigation')
...
# Loop for regular monitoring and system adjustments
...
root = StrictPartialOrder(nodes=[
    ...
    procure_seeds, install_irrig, setup_climate, create_schedule,
    pest_control, monitor_loop, harvest_crops, package_produce,
...
root.order.add_edge(procure_seeds, install_irrig)
root.order.add_edge(install_irrig, setup_climate)
