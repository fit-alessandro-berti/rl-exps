...
# Loop: after growth monitoring, either exit or do data review then monitor again
loop = OperatorPOWL(operator=Operator.LOOP, children=[growth_monitor, data_review])
