...
monitor_loop = OperatorPOWL(
    ...
    children=[data_monitor, pest_control]
)

# Build the top-level partial order
root = StrictPartialOrder(nodes=[
    site_survey, permit_review, design_layout,
    material_sourcing, irrigation_setup, sensor_install,
    structural_test, recruit_farmers, trial_planting,
    soilless_prep, system_calibrate,
    monitor_loop, harvest_plan, community_outreach
])
