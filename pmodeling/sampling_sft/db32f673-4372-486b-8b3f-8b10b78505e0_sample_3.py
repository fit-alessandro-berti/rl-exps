...
root = StrictPartialOrder(nodes=[
    receive, condition_log, radiocarbon, spectroscopy,
    expert_consult, provenance_check, archive_search, risk_assess,
    three_d_scan, legal_review, insurance_setup, certificate_draft,
    certificate_approve, climate_pack, conservation_plan, monitoring_schedule
])

# Define the control‐flow dependencies
root.order.add_edge(receive, condition_log)
root.order.add_edge(condition_log, radiocarbon)
root.order.add_edge(condition_log, spectroscopy)
root.order.add_edge(radiocarbon, expert_consult)
root.order.add_edge(spectroscopy, expert_consult)
...
root.order.add_edge(archive_search, three_d_scan)
...
# Final concurrency
root.order.add_edge(monitoring_schedule, monitoring_schedule)
