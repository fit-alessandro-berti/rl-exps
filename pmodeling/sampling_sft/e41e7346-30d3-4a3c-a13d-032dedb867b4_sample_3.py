...
root.order.add_edge(light_adjust,   monitor_loop)
root.order.add_edge(co2_control,    monitor_loop)
root.order.add_edge(humidity_tune,  monitor_loop)
...
root.order.add_edge(cycle_review,   seed_select)  # Optional: loop back to start