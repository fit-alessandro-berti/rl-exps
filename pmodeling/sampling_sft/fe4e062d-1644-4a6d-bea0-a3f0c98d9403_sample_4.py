...
mature_cycle = Transition(label='Maturation Cycle')
...
root.order.add_edge(ingredient_sourcing, blend_experiment)
root.order.add_edge(quality_check, blend_experiment)
root.order.add_edge(blend_experiment, mature_cycle)
root.order.add_edge(mature_cycle, sensory_panel)
