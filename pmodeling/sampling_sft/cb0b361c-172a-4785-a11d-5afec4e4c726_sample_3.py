...
# Loop for pest inspection: repeat Pest Inspect then skip or Harvest Plan then Pest Inspect
pest_loop = OperatorPOWL(operator=Operator.LOOP, children=[pest_inspect, skip])
...
root = StrictPartialOrder(nodes=[
    ...
    growth_monitor, pest_loop,
    harvest_plan, packaging_prep, distribution,
    sustainability
])
