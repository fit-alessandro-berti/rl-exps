...
# Loop for repeated aging and monitoring
loop_aging = OperatorPOWL(
    operator=Operator.LOOP,
    children=[humidity_control, temp_monitor]
)
...
root.order.add_edge(aging_setup,      loop_aging)
root.order.add_edge(loop_aging,       quality_test)
