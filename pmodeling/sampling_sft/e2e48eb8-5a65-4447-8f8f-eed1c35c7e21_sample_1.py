...
# Build the loop for continuous pest monitoring & data analysis
...
root.order.add_edge(pest_loop,       regulation_review)
root.order.add_edge(pest_loop,       community_meet)
