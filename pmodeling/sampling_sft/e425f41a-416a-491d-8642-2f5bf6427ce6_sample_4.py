...
# Loop for feedback and refinement: do Feedback Review, then either exit or do Refinement then Testing then Feedback again
feedback_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[feedback_review, sensory_testing, recipe_refinement]
)
...
root.order.add_edge(chemical_analysis,     feedback_loop)
root.order.add_edge(feedback_loop,         final_adjustment)
