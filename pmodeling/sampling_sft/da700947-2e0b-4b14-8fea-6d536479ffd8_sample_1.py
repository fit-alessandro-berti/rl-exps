...
# Build the loop for continuous improvement: do Yield Review, then optionally do Feedback Loop and then repeat
loop_body = StrictPartialOrder(nodes=[yield_review, feedback_loop])
loop_body.order.add_edge(yield_review, feedback_loop)
...
root.order.add_edge(community_meet, improvement_loop)
