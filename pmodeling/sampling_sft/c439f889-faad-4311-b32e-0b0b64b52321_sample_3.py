...
# Define the loop for continuous monitoring and scheduling
monitoring_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[sensor_monitoring, pest_inspection]
)
...
root.order.add_edge(farm_scheduling, monitoring_loop)
root.order.add_edge(monitoring_loop, crop_forecasting)
root.order.add_edge(crop_forecasting, nutrient_cycling)
root.order.add_edge(nutrient_cycling, harvest_timing)
