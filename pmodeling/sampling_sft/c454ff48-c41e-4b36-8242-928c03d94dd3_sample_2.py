...
# Loop for continuous monitoring and yield optimization
monitor_loop = OperatorPOWL(operator=Operator.LOOP, children=[monitoring_setup, yield_optimize])
...
root = StrictPartialOrder(nodes=[
    ...
    distribution_map, community_engage, monitor_loop
])
