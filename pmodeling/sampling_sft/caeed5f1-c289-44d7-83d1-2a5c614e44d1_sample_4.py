...
# Loop for iterative concept development
concept_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[concept_draft, feedback_loop]
)
...
root.order.add_edge(vision_capture, concept_loop)
root.order.add_edge(concept_loop, material_sourcing)
