...
# Loop: Pest Monitor -> Nutrient Calibrate
loop_body = StrictPartialOrder(nodes=[pest_monitor, nutrient_calibrate])
loop_body.order.add_edge(pest_monitor, nutrient_calibrate)

# LOOP operator: execute loop_body, then optionally skip and repeat
