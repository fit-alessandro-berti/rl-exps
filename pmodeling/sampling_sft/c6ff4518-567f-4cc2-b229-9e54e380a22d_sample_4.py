...
microclimate_ctl = Transition(label='Microclimate Control')
...
root.order.add_edge(aging_setup,       microclimate_ctl)
root.order.add_edge(microclimate_ctl,  flavor_profiling)
