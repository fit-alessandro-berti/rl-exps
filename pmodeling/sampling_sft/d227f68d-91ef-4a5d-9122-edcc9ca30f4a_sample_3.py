...
root = StrictPartialOrder(nodes=[
    site_survey, design_layout, permits_check, foundation_prep, frame_assembly,
    hydro_setup, climate_setup, seed_selection, nutrient_mix, system_calibration,
    pest_control, automation_link, staff_training, yield_tracking, distribution_plan
])
...
# Optional: if you want to add a loop for ongoing performance analysis,
# you can uncomment and adjust the following lines:
# analysis = Transition(label='Performance Analysis')
# root.order.add_edge(distribution_plan, analysis)
# root.order.add_edge(analysis, distribution_plan)
