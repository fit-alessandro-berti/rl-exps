...
root = StrictPartialOrder(nodes=[
    site_audit, impact_study, design_modules,
    sensor_setup, hydroponics_install, nutrient_test, lighting_config,
    staff_training, data_collection, yield_analysis, pest_control, harvest_plan,
    packaging_prep, market_delivery, feedback_loop
])
...
root.order.add_edge(hydroponics_install, staff_training)
...
# Loop for feedback: after market delivery, loop back to data collection
root.order.add_edge(market_delivery, feedback_loop)
root.order.add_edge(feedback_loop, data_collection)