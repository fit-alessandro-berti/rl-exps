...
# Define the loop for continuous monitoring and data analysis
loop_body = StrictPartialOrder(nodes=[data_monitor, yield_forecast, energy_audit, market_setup, logistics_plan, waste_manage])
loop = OperatorPOWL(operator=Operator.LOOP, children=[loop_body])

# Build the overall partial order
root = StrictPartialOrder(nodes=[
    site_survey, structure_prep, system_install, env_control, nutrient_mix,
    crop_select, ai_setup, worker_train, pest_control, irrigation_plan,
    loop
])
