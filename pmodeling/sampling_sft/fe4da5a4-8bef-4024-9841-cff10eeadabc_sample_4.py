...
# Loop for seasonal crop rotation: Crop Rotation then optionally repeat
loop_crop_rotation = OperatorPOWL(
    operator=Operator.LOOP,
    children=[crop_rotation, crop_rotation]
)
...
root.order.add_edge(produce_marketing,  loop_crop_rotation)
