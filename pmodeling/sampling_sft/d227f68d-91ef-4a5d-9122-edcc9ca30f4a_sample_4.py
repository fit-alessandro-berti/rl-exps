...
# Loop for ongoing performance analysis: track yield then optionally re-run the loop
loop_analysis = OperatorPOWL(
    operator=Operator.LOOP,
    children=[yield_tracking, yield_tracking]
)
...
root.order.add_edge(loop_analysis, distribution_plan)