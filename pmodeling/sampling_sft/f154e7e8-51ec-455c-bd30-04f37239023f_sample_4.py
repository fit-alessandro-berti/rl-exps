...
# Loop for continuous data logging and quality testing
loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[data_logging, quality_test]
)

# Build the partial order
root = StrictPartialOrder(nodes=[
    site_survey, flora_mapping, hive_setup, sensor_install,
    health_check, pest_control, loop,
    community_meet, workshop_plan,
    honey_extract, packaging, market_setup, sales_report,
