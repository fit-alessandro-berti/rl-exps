...
# Loop for continuous monitoring after installation
loop = OperatorPOWL(operator=Operator.LOOP, children=[health_monitor])
...
root = StrictPartialOrder(nodes=[
    ...
    staff_train, market_outreach, supplier_contact, system_setup, loop
])
