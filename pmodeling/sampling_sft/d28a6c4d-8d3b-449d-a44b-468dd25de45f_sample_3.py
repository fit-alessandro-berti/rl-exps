...
# Loop for continuous feedback and iterative scaling
loop_body = StrictPartialOrder(nodes=[feedback_loop, scale_planning, risk_assess, demand_scan, agile_adjust])
loop_body.order.add_edge(feedback_loop, scale_planning)
loop_body.order.add_edge(scale_planning, risk_assess)
loop_body.order.add_edge(risk_assess, demand_scan)
loop_body.order.add_edge(demand_scan, agile_adjust)
...
root.order.add_edge(idea_fusion, loop)
