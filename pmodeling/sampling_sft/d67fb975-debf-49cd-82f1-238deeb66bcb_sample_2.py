...
# Community loop: engage then collect feedback, then either exit or re‐engage
community_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[community_engage, feedback_collect]
)
root.order.add_edge(plant_precise,    community_loop)
...
# Final distribution and data analysis
