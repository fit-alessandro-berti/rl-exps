...
# XOR for either drone intervention or pesticide spray
...
root.order.add_edge(monitor_loop, intervention_choice)
root.order.add_edge(intervention_choice, robotic_harvest)
