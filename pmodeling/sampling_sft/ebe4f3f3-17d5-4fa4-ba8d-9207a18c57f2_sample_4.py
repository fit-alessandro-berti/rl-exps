...
# Loop for aging and quality checks
...
root = StrictPartialOrder(nodes=[
    ...
    aging_loop, packaging_design, label_printing,
    inventory_update, order_receiving, retail_coord,
    shipping_prep, customer_feedback, demand_forecast,
    limited_release
])
...
root.order.add_edge(order_receiving, retail_coord)
