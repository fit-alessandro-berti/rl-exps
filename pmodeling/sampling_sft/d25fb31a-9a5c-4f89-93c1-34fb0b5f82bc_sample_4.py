...
# Define the monitoring loop: Monitor Growth, then either exit or do Manage Pests and repeat
loop_body = StrictPartialOrder(nodes=[manage_pests])
loop_body.order.add_edge(manage_pests, monitor_growth)
