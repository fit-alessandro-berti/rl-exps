...
design_loop = OperatorPOWL(
    ...
    children=[design_review, design_review]
)
...
root.order.add_edge(budget_align,       design_loop)
root.order.add_edge(design_loop,        structure_simulate)
root.order.add_edge(design_loop,        material_procure)
