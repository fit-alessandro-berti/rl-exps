...
# Loop for iterative imaging and forgery detection
imaging_loop = OperatorPOWL(
    operator=Operator.LOOP,
    children=[imaging_scan, forgery_detect]
)
...
root.order.add_edge(material_test, imaging_loop)
root.order.add_edge(imaging_loop, historical_check)
