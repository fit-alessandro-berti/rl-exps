...
loop_seasonal = OperatorPOWL(operator=Operator.LOOP, children=[seasonal_review, feedback_analysis])
...
root = StrictPartialOrder(nodes=[
    ...
    packaging_prep, climate_shipping, retail_coordination, loop_seasonal
])
...
root.order.add_edge(retail_coordination, loop_seasonal)