...
root = StrictPartialOrder(nodes=[
    site_survey, design_draft, permit_review,
    structure_build, enviro_setup, nutrient_mix,
    seed_selection, plant_robots, sensor_install,
    data_sync, monitor_loop,
...
root.order.add_edge(data_sync, monitor_loop)
...
# Feedback loop exits after market launch
