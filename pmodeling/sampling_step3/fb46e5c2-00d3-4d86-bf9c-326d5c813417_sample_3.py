...
# Define the transitions (activities) with exact names as given in the problem description
...
root = StrictPartialOrder(nodes=[
    ...
    drone_deploy, health_scan, data_logging, supply_sync, maintenance_plan, waste_manage
])
