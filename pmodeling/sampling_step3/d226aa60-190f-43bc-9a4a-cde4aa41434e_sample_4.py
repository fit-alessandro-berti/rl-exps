...
root = StrictPartialOrder(nodes=[SeedSelect, TrendAnalyze, NutrientMix, AutoPlant, SensorCheck, DataAnalyze, WaterAdjust, LightControl, HumidityMonitor, PestInspect, GrowthForecast, HarvestPlan, RapidCool, QualityGrade, EcoPackage, LogisticsPrep, FeedbackCollect, SystemMaintain])
