...
# Define the POWL model for the drone assembly process
...
root = StrictPartialOrder(nodes=[
    gather_specs, design_custom, source_parts, firmware_load, mechanical_fit,
    cable_routing, sensor_align, component_test, software_sync, flight_calibrate,
    enviro_test, remote_pair, quality_check, package_unit, register_drone, client_train
])
