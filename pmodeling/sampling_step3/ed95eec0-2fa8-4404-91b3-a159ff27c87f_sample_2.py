...
root = StrictPartialOrder(nodes=[
    Trend_Scan, Idea_Harvest, Sector_Match, Brainstorm_Hub, Concept_Filter, Prototype_Build, Hybrid_Testing, Stakeholder_Sync, Risk_Assess, Scenario_Map, Strategy_Align, Pilot_Launch, Data_Capture, Market_Sense, Scale_Plan
])
