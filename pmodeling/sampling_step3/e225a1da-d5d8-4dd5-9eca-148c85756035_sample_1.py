...
root = StrictPartialOrder(nodes=[
    ...
    setup_sensors, calibrate_climate, configure_lighting, integrate_iot,
    train_staff, run_trials, analyze_data, optimize_yield, check_compliance,
    plan_marketing, launch_facility
])
