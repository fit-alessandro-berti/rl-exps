...
root = StrictPartialOrder(nodes=[
    trend_sensing, idea_fusion, prototype_build, expert_review,
    field_testing, ip_analysis, compliance_check, partner_setup,
    user_profiling, launch_prep, feedback_loop, scale_planning,
