...
# Define the transitions (activities) of the POWL model
...
root = StrictPartialOrder(nodes=[Return_Request, Authorization_Check, Pickup_Schedule, Transport_Dispatch, Receiving_Goods, Quality_Inspect, Sort_Items, Refurbish_Prep, Recycle_Process, Inventory_Update, Customer_Notify, Disposal_Arrange, Compliance_Audit, Cost_Analysis, Report_Generate])
