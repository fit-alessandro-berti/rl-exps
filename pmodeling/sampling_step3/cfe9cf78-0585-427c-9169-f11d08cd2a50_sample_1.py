...
root = StrictPartialOrder(nodes=[
    site_analysis, env_assessment, system_design, equipment_order, seed_selection, install_modules, calibrate_systems, staff_training, plant_seeding, iot_monitoring, data_analytics, nutrient_adjust, pest_control, maintenance_check, market_launch, logistics_setup
])
