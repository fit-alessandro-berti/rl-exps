...
root = StrictPartialOrder(nodes=[
    initial_review, provenance_check, material_testing, expert_survey, digital_scan, condition_report, legal_review, risk_analysis,
    seller_negotiation, documentation, archival_entry, committee_review, final_approval, acquisition_setup, exhibit_planning
])
