...
root = StrictPartialOrder(nodes=[
    ...
    set_controls, test_modules, select_crops, configure_irrigation,
    deploy_ai, monitor_pests, manage_energy, recycle_waste, train_staff,
    launch_market, engage_community
])
