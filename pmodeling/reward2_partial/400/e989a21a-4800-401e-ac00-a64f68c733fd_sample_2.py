...
root = StrictPartialOrder(nodes=[Visual_Inspect, Document_Gather, Material_Test, Pigment_Analyze, Style_Compare, Provenance_Trace, Data_Crosscheck, Infrared_Scan, Xray_Fluoresce, Expert_Consult, Forging_Detect, Report_Draft, Stakeholder_Review, Final_Approval, Archive_Store])
