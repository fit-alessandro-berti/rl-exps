...
root = StrictPartialOrder(nodes=[
    Site_Assess, Permit_Obtain, Soil_Testing, Crop_Select, Irrigation_Setup, 
    Drainage_Install, Energy_Integrate, Staff_Train, Pest_Control, Logistics_Plan, 
    Supply_Coordinate, Distribution_Map, Community_Engage, Monitoring_Setup, Yield_Optimize
])
