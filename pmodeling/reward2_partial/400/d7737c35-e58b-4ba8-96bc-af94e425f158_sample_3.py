...
root = StrictPartialOrder(nodes=[
    Milk_Sourcing, Supplier_Audit, Culture_Prep, Milk_Testing, Fermentation_Start, pH_Monitoring, Curd_Cutting, Mold_Inoculation, Aging_Setup, Humidity_Control, Texture_Check, Flavor_Profiling, Batch_Labeling, Packaging, Distribution, Feedback_Review, Sustainability_Audit
])
