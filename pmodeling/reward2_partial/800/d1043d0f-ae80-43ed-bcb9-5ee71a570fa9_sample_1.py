...
# Define the root model as a strict partial order
root = StrictPartialOrder(nodes=[
    Site_Survey, Env_Analysis, Module_Design, Seed_Selection, Nutrient_Mix,
    Climate_Setup, LED_Install, Sensor_Deploy, Pest_Control, Waste_Recycle,
