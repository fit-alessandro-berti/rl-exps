...
root = StrictPartialOrder(nodes=[
    ...
    curd_cutting, whey_draining, molding_cheese, pressing_blocks,
    salting_process, aging_monitoring, flavor_profiling, packaging_design,
    compliance_check, market_research, direct_shipping, customer_feedback,
    recipe_adjust
])
