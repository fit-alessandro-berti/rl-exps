...
root = StrictPartialOrder(nodes=[
    provenance_check, material_testing, stylistic_review, expert_panel, legal_clearance,
    ethics_audit, insurance_quote, risk_assess, digital_archive, replica_build, transport_prep,
    final_review, catalog_entry, public_notice, condition_report
])
