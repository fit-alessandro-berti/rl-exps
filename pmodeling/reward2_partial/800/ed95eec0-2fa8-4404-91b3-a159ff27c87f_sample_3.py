...
root = StrictPartialOrder(nodes=[
    TrendScan, IdeaHarvest, SectorMatch, BrainstormHub, ConceptFilter, PrototypeBuild, HybridTesting,
    StakeholderSync, RiskAssess, ScenarioMap, StrategyAlign, PilotLaunch, DataCapture, MarketSense, ScalePlan
])
