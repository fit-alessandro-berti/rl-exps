...
root = StrictPartialOrder(nodes=[
    ...
    provenance_check, archive_research, expert_review, style_analysis, craftsmanship_eval,
    condition_check, restoration_plan, forgeries_risk, legal_review, report_drafting, catalog_entry
])
