...
root = StrictPartialOrder(nodes=[
    SiteAssess, EnvAnalysis, ModularInstall, IrrigationSetup, CropSelection, NutrientMix,
    LightingCalibrate, PestMonitor, StaffTraining, EnergyIntegrate, DataAnalytics, WasteRecycle,
    MarketDevelop, YieldOptimize, ClimateSimulate
])
