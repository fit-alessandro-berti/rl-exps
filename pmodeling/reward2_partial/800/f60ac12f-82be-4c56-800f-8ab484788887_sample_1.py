...
root = StrictPartialOrder(nodes=[
    milk_sourcing, culture_blending, milk_pasteurize, curd_cutting, whey_drain, mold_inoculate, press_cheese,
    salt_brine, age_monitor, quality_test, packaging_prep, label_design, order_allocation, transport_arrange,
    retail_sync, customer_review, feedback_analyze
])
