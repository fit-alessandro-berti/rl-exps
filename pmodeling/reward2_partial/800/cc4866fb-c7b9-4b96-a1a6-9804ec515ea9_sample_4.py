...
root = StrictPartialOrder(nodes=[
    site_survey, design_planning, permit_filing, structural_reinforce, hydroponic_setup, sensor_install, energy_audit, crop_selection, nutrient_mix, waste_process, climate_control, staff_training, market_study, community_meet, launch_trial, data_monitor
])
