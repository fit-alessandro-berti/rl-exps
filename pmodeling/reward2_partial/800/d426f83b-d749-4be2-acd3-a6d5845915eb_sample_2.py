...
root.order.add_edge(style_compare, condition_review)
root.order.add_edge(historical_search, scientific_analysis)
root.order.add_edge(expert_consult, scientific_analysis)
