...
# Define silent transition for no action
skip = SilentTransition()

# Define the workflow model
root = StrictPartialOrder(nodes=[
    preflight_check, sensor_calibrate, battery_test, route_update, firmware_patch,
    flight_launch, telemetry_monitor, anomaly_detect, collision_assess, data_upload,
    postflight_review, battery_optimize, damage_repair, compliance_report, performance_log, mission_debrief
])
