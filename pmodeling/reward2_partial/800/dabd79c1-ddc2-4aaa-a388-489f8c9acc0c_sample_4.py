...
skip_document_review = SilentTransition()
skip_material_testing = SilentTransition()
skip_radiocarbon_date = SilentTransition()
skip_stylistic_eval = SilentTransition()
skip_database_check = SilentTransition()
skip_ownership_audit = SilentTransition()
skip_export_verify = SilentTransition()
skip_expert_arbitration = SilentTransition()
skip_conservation_plan = SilentTransition()
skip_risk_assessment = SilentTransition()
skip_approval_review = SilentTransition()
skip_insurance_setup = SilentTransition()
skip_secure_transport = SilentTransition()
skip_acquisitions_meet = SilentTransition()
