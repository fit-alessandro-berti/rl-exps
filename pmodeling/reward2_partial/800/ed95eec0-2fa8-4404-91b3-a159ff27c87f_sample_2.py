...
root = StrictPartialOrder(nodes=[
    trend_scan, idea_harvest, sector_match, brainstorm_hub, concept_filter, prototype_build,
    hybrid_testing, stakeholder_sync, risk_assess, scenario_map, strategy_align, pilot_launch,
    data_capture, market_sense, scale_plan
])
...
# Print the root to see the final model
print(root)