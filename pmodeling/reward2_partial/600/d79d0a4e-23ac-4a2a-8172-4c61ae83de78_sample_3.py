...
root = StrictPartialOrder(nodes=[
    spec_review, component_pick, frame_build, motor_mount, sensor_fit, wiring_setup, software_load,
    calibration_test, stress_check, firmware_flash, feedback_loop, package_prep, doc_compile, ship_arrange, remote_setup
])
