...
root = StrictPartialOrder(nodes=[
    Component_Sourcing, Frame_Assembly, Motor_Installation, Sensor_Mounting, Wiring_Setup, Firmware_Upload, AI_Module,
    Calibration_Phase, Stress_Testing, Flight_Simulation, Pattern_Adjustment, Quality_Inspect, Compliance_Check,
