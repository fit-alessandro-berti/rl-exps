...
root = StrictPartialOrder(nodes=[
    seed_selection, ai_prediction, automated_planting, sensor_calibration, environment_adjustment, nutrient_dosing, hydroponic_flow, robotic_pruning, health_monitor, harvesting_ops, data_analysis, predictive_check, waste_composting, water_recycling, eco_packaging, carbon_tracking, logistics_dispatch
])
