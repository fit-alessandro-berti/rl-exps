...
# Define the partial order (workflow) with dependencies between activities
root = StrictPartialOrder(nodes=[
    client_consult, spec_finalize, design_draft, aerodynamics_test, ai_integration,
    material_sourcing, component_order, assembly_line, firmware_install, environmental_test,
    quality_check, brand_packaging, shipping_prep, delivery_schedule, post_sale_support
])

# Define the dependencies (workflow structure)
...
# Now, 'root' contains the POWL model for the drone manufacturing process.