...
root = StrictPartialOrder(nodes=[
    ...
    material_procure, vendor_select, permit_apply, safety_check, site_prep,
    logistics_plan, fabricate_parts, assemble_onsite, quality_inspect,
    weather_monitor, public_unveil, maintenance_plan, stakeholder_meet
])
...
# Note: In POWL, the order of nodes defines the execution order of the process. The dependencies defined above ensure the process flows sequentially from one node to another.