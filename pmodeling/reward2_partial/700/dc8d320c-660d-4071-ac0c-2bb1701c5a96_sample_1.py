...
root = StrictPartialOrder(nodes=[intake, provenance_check, material_testing, historical_review, expert_interview, condition_audit, digital_catalog, forgery_detection, legal_compliance, restoration_plan, valuation_report, market_analysis, final_approval, sale_preparation, client_notification])
