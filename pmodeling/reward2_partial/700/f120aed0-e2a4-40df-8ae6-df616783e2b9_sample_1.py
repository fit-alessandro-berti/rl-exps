...
root = StrictPartialOrder(nodes=[
    site_survey, rack_design, system_setup, climate_calibrate,
    nutrient_prep, crop_select, seed_germinate, sensor_deploy,
    pest_control, harvest_automate, quality_check, pack_produce,
