...
# For example, if there is a concurrent process:
# silent_transition = SilentTransition()
# root.order.add_edge(provenance_check, silent_transition)
# root.order.add_edge(material_scan, silent_transition)
# root.order.add_edge(style_compare, silent_transition)
