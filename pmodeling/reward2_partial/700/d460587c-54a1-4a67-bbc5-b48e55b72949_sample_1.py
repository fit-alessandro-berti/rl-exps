...
root = StrictPartialOrder(nodes=[
    site_survey, permit_filing, load_testing, soil_sampling, water_testing, system_design, solar_setup, crop_planning, stakeholder_meet, material_order, system_install, environmental_audit, growth_monitoring, pest_control, market_launch
])
