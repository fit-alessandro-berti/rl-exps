...
root = StrictPartialOrder(nodes=[
    Soil_Analyze, Site_Mapping, Bed_Setup, Crop_Select, Sensor_Deploy, Irrigation_Adjust, Nutrient_Feed, Pest_Scouting, Pest_Predict, Workshop_Host, Crop_Rotate, Waste_Compost, Water_Recycle, Data_Analyze, Cycle_Refine, Resource_Share, Yield_Report
])
