...
root = StrictPartialOrder(nodes=[
    MilkSourcing, QualityTesting, CurdProcessing, SaltApplication, MoldInoculation, PressMolding, BrineSoaking,
    AgingSetup, HumidityControl, MicrobialCheck, PackagingDesign, LabelPrinting, TraceLogging, DistributionPlan,
    CustomerReview, InventoryAudit, SustainabilityAudit
])
