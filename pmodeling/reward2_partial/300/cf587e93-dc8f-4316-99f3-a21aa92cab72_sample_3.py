...
# Create a strict partial order with all transitions
root = StrictPartialOrder(nodes=[
    SeedSelect, NutrientMix, SensorSetup, EnvMonitor, GrowthScan, PestControl, WaterCycle, HarvestRobo, YieldAssess, WasteProcess, EnergySync, PackBiodeg, MarketTrack, OrderAlign, LogisticsPlan, FeedbackLoop
])

# Define dependencies between transitions (partial order edges)
