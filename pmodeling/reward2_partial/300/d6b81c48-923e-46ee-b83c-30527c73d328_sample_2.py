...
# Define the transitions (activities) based on the given process description
...
root = StrictPartialOrder(nodes=[preflight_check, sensor_calibrate, battery_test, route_update, firmware_patch, flight_launch, telemetry_monitor, anomaly_detect, collision_assess, data_upload, postflight_review, battery_optimize, damage_repair, compliance_report, performance_log, mission_debrief])

# Define the dependencies between activities (partial order edges)
