...
# Define the POWL process
root = StrictPartialOrder(nodes=[
    quantum_init, data_ingest, ai_forecast, inventory_sync, procurement_plan, production_align,
    distribution_map, iot_monitor, risk_assess, maintenance_alert, quantum_compute, feedback_loop,
    schedule_adjust, demand_update, delivery_track, compliance_check
])
