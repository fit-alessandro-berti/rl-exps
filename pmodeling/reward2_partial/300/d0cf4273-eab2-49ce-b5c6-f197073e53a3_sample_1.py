...
packaging = Transition(label='Package Assembly')
...
root = StrictPartialOrder(nodes=[sourcing, verify, transport, storytelling, crafting, creation, catalog, market, targeting, packaging, coop, audit, logistics, shipping, feedback])
...
root.order.add_edge(targeting, packaging)
root.order.add_edge(packaging, coop)
