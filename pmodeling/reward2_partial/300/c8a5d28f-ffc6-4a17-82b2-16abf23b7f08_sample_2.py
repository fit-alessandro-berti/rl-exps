...
root = StrictPartialOrder(nodes=[
    milk_sourcing, quality_testing, pasteurize, culture_addition, curd_cutting, whey_drain, cheese_molding,
    controlled_aging, sensory_check, health_certify, custom_labeling, cold_packaging, logistics_setup, export_docs,
    customs_clearance, shipment_track, client_feedback
])

# Define the POWL partial order dependencies
root.order.add_edge(milk_sourcing, quality_testing)
root.order.add_edge(quality_testing, pasteurize)
root.order.add_edge(pasteurize, culture_addition)
