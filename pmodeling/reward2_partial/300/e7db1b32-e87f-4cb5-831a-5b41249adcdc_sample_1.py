...
root = StrictPartialOrder(nodes=[
    seed_selection, ai_prediction, automated_planting, sensor_calibration, environment_adjustment, nutrient_dosing,
    hydroponic_flow, robotic_pruning, health_monitoring, harvesting_ops, data_analysis, predictive_check,
...
root.order.add_edge(robotic_pruning, health_monitoring)
root.order.add_edge(health_monitoring, harvesting_ops)
