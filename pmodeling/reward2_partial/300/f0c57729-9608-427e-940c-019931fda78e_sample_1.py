...
root = StrictPartialOrder(nodes=[inquiry, consultation, concept, feedback, contract, artist, material, ethics, progress, milestone, quality, copyright, packaging, shipping, post_delivery, client_survey])
