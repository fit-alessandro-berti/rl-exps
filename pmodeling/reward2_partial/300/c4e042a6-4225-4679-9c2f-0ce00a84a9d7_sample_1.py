...
# Define the POWL model for the supply chain management process
...
root = StrictPartialOrder(nodes=[
    ...
    production_sync, shipping_plan, compliance_check, feedback_loop, market_target,
    order_fulfill, sustainability, customer_engage
])
