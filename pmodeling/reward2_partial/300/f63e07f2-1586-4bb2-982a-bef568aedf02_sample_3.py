...
root = StrictPartialOrder(nodes=[
    artifact_intake, provenance_check, archive_research, expert_interview,
    material_analysis, spectroscopy_test, carbon_dating, digital_imaging,
    three_d_modeling, data_review, consensus_meeting, conservation_plan,
    preservation_setup, documentation, exhibition_prep
])
...
root.order.add_edge(archive_research, material_analysis)
...
root.order.add_edge(spectroscopy_test, digital_imaging)
root.order.add_edge(carbon_dating, three_d_modeling)
