...
root = StrictPartialOrder(nodes=[
    ...
    climate_test, sensor_deploy, energy_setup, crop_select, plant_seeding, community_meet, compliance_check,
...
# The final POWL model for the urban rooftop farm process is now defined in the 'root' variable.