...
root = StrictPartialOrder(nodes=[
    ...
    molding_cheese, salting_process, aging_setup, quality_check,
    packaging_prep, label_design, distribution_plan, retail_delivery,
    customer_feedback
])

# Add dependencies between nodes (partial order structure)
