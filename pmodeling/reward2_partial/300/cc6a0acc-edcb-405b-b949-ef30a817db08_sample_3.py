...
root = StrictPartialOrder(nodes=[
    site_survey, load_test, soil_sample, water_check, design_plan, bed_setup, irrigation_install, climate_setup, seed_selection, planting_phase, pest_control, growth_monitor, harvest_prep, community_meet, waste_manage, yield_report
])
