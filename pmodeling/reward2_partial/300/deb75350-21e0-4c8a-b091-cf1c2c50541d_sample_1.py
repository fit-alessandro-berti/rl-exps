...
root = StrictPartialOrder(nodes=[
    Intake_Review, Visual_Inspect, Material_Test, Provenance_Check, Archival_Search, Expert_Consult, Digital_Scan, Condition_Report, Forgeries_Assess, Legal_Review, Risk_Analysis, Acquisition_Vote, Catalog_Entry, Storage_Prep, Final_Approval
])
...
root.order.add_edge(Condition_Report, Forgeries_Assess)
