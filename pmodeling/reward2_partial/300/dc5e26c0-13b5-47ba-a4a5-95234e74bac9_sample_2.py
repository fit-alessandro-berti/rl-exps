...
root = StrictPartialOrder(nodes=[activities['Site Survey'], activities['Design Layout'], activities['Climate Setup'], activities['Sensor Install'], activities['Nutrient Mix'], activities['Automation Code'], activities['Crop Planning'], activities['Pest Control'], activities['Energy Audit'], activities['Waste Sort'], activities['Planting Tier'], activities['Harvest Prep'], activities['Logistics Plan'], activities['Community Meet'], activities['Data Review'], activities['System Upgrade']])
