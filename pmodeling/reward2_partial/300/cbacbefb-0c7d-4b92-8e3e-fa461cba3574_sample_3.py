...
root = StrictPartialOrder(nodes=[
    site_analysis, design_layout, module_assembly, climate_setup, sensor_install, water_testing, nutrient_mix, seed_selection,
    planting_phase, growth_monitor, pest_control, harvest_plan, yield_audit, packaging_prep, market_delivery, waste_recycling
])
