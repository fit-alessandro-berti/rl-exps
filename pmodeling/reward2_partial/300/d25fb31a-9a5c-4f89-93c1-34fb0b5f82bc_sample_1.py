...
root = StrictPartialOrder(nodes=[
    AssessStructure, AnalyzeEnvironment, DesignModules, ProcureMaterials, InstallIrrigation, SetSensors,
    SelectSeeds, SchedulePlanting, MonitorGrowth, CollectData, ManagePests, HarvestCrops, CoordinateSales,
    CompostWaste, ReviewFeedback
])

# Define dependencies (partial order relationships)
