...
root = StrictPartialOrder(nodes=[initial_assess, artifact_scan, condition_map, material_test, 
                                 cleaning_phase, stability_check, minor_repair, structural_reinforce, 
                                 surface_restore, coating_apply, ethics_review, provenance_verify, 
