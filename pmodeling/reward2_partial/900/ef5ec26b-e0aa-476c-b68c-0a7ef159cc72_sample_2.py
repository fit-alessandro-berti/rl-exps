...
conflict_mediator = Transition(label='Conflict Mediate')
...
root = StrictPartialOrder(nodes=[
    site_survey, soil_testing, stakeholder_meet, resource_plan, crop_selection, volunteer_sign_up,
    tech_setup, irrigation_check, data_collection, growth_monitoring, conflict_mediator, workshop_prep,
    market_forecast, yield_analysis, sustainability_audit, community_feedback, equipment_maintain, waste_manage
])
...
root.order.add_edge(growth_monitoring, conflict_mediator)
root.order.add_edge(conflict_mediator, workshop_prep)
