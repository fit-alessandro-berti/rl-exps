...
set_delivery_schedule = Transition(label='Schedule Delivery')
...
root = StrictPartialOrder(nodes=[user_signup, set_preference, select_meal, set_delivery_schedule, match_supplier, check_inventory, order_ingredient, quality_inspect, pack_meal, plan_route, dispatch_kit, track_delivery, collect_feedback, analyze_data, optimize_plan])
...
root.order.add_edge(select_meal, set_delivery_schedule)
root.order.add_edge(set_delivery_schedule, match_supplier)
