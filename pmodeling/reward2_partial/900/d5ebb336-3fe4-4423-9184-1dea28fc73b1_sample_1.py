...
root = StrictPartialOrder(nodes=[
    ...
    activities['Point Aggregation'],
    activities['Conflict Check'],
    activities['Fraud Scan'],
    activities['Reward Adjust'],
    activities['Redemption Verify'],
    activities['Partner Sync'],
    activities['Behavior Analyze'],
    activities['Async Update'],
    activities['Rollback Trigger'],
    activities['Compliance Check'],
    activities['Notification Send'],
    activities['User Feedback'],
