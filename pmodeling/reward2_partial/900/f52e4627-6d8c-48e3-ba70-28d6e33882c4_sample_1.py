...
forecast_adjustment = Transition(label='Forecast Adjust')
...
root.order.add_edge(shipment_plan, customs_clearance)
root.order.add_edge(customs_clearance, inventory_update)
root.order.add_edge(inventory_update, supplier_review)
root.order.add_edge(supplier_review, risk_assessment)
root.order.add_edge(risk_assessment, forecast_adjustment)
root.order.add_edge(forecast_adjustment, payment_process)
