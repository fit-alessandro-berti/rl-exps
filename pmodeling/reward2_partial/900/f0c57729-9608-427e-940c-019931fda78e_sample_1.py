...
# Define the transitions (activities) in the workflow
...
root = StrictPartialOrder(nodes=[
    inquiry_intake, consultation_call, concept_draft, feedback_loop, contract_setup, artist_match,
    material_sourcing, ethics_review, progress_check, milestone_approve, quality_audit, copyright_transfer,
    packaging_plan, shipping_arrange, post_delivery, client_survey
])
