...
root.order.add_edge(visual_inspection, radiocarbon_dating)
root.order.add_edge(material_testing, radiocarbon_dating)
root.order.add_edge(radiocarbon_dating, provenance_check)
...
root.order.add_edge(restoration_plan, forgeries_risk)
root.order.add_edge(forgeries_risk, legal_review)
