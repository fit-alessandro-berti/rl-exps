...
root = StrictPartialOrder(nodes=[activities['Site Analysis'], activities['Permit Securing'], activities['Unit Designing'], activities['LED Sourcing'], activities['Hydroponic Setup'], activities['Staff Hiring'], activities['Pilot Cultivation'], activities['Data Integration'], activities['Waste Recycling'], activities['Local Distribution'], activities['Subscription Setup'], activities['IoT Deployment'], activities['Sustainability Audit'], activities['Market Testing'], activities['Process Refinement']])
