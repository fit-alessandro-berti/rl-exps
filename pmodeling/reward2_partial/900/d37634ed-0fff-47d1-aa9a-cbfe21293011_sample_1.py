...
root = StrictPartialOrder(nodes=[seed_selection, nutrient_mix, env_check, planting_setup, growth_monitoring, pest_control, automated_harvest, quality_inspect, packaging_prep, order_fulfill, local_delivery, waste_collect, biomass_process, compost_create, energy_recover, regulation_review, community_engage])
