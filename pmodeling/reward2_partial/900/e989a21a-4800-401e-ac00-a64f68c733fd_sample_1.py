...
root = StrictPartialOrder(nodes=[visual_inspect, document_gather, material_test, pigment_analyze, style_compare, provenance_trace, data_crosscheck, infrared_scan, xray_fluoresce, expert_consult, forgeries_detect, report_draft, stakeholder_review, final_approval, archive_store])
...
root.order.add_edge(expert_consult, forgeries_detect)
root.order.add_edge(forgeries_detect, report_draft)
