...
root = StrictPartialOrder(nodes=[
    initial_assess, condition_scan, material_test, historical_check,
    provenance_verify, parts_sourcing, gentle_clean, stabilize_item,
    structural_repair, surface_finish, expert_consult, archival_review,
    ethics_audit, quality_inspect, photo_document, packaging_prep,
