...
root = StrictPartialOrder(nodes=[
    seed_select, trend_analyze, nutrient_mix, auto_plant, sensor_check, data_analyze,
    water_adjust, light_control, humidity_monitor, pest_inspect, growth_forecast,
    harvest_plan, rapid_cool, quality_grade, eco_package, logistics_prep, feedback_collect,
    system_maintain
])
