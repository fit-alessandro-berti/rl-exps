...
root = StrictPartialOrder(nodes=[
    ...
    climate_setup, nutrient_mix, system_assembly, automation_config, crop_seeding, growth_monitoring,
    waste_handling, community_meet, data_analysis, feedback_loop, yield_forecast
])
...
# Now, 'root' is the POWL model for the urban vertical farm process
print(root)