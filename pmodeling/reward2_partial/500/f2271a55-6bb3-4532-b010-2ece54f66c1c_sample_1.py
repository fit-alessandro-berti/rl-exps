...
root = StrictPartialOrder(nodes=[
    provenance_check, spectroscopy_test, carbon_dating, style_analysis, image_scanning, restoration_scan, appraiser_review, database_match, blockchain_entry, certificate_issue, forgery_detect, report_compilation, client_briefing, secure_storage, final_approval
])
