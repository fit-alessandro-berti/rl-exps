...
root = StrictPartialOrder(nodes=[ThreatAssess, AlertDispatch, ResourceCheck, TeamMobilize, CommandSetup, IntelGather, RiskEvaluate, PrioritySet, FieldDeploy, CommSync, PublicUpdate, SupplyManage, SafetyMonitor, IncidentLog, RecoveryPlan, DebriefTeam, DataArchive])
