...
root = StrictPartialOrder(nodes=[
    Document_Review, Material_Testing, Radiocarbon_Date, Stylistic_Eval, Database_Check, Ownership_Audit, Export_Verify,
    Expert_Arbitration, Conservation_Plan, Risk_Assessment, Approval_Review, Insurance_Setup, Secure_Transport, Acquisitions_Meet,
    Final_Documentation
])
