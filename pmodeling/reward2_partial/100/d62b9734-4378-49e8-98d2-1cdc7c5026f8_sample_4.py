...
root = StrictPartialOrder(nodes=[
    provenance_check, image_capture, material_scan, expert_review, historical_cross, legal_verify, registry_search, customs_clear, condition_assess, data_log, chain_custody, report_draft, certification, secure_archive, auction_prep
])
