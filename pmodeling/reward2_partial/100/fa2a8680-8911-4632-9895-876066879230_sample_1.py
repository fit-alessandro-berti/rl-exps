...
root = StrictPartialOrder(nodes=[ClientMeet, RequirementGather, ModuleDesign, SupplierVetting, ComponentOrder, PrototypeBuild, FieldTesting, TestAnalysis, SoftwareSetup, DataIntegration, PilotTrain, ComplianceCheck, FleetDeploy, RemoteMonitor, MaintenancePlan, PerformanceTune])
