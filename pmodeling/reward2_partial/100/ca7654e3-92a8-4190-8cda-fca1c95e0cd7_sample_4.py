...
root = StrictPartialOrder(nodes=[
    MilkSourcing, CurdPreparation, starterCulture, TemperatureControl, PressingCheese, SaltingStage, AgingProcess,
    MicrobialTest, QualityCheck, EcoPackaging, LabelPrinting, InventoryAudit, OrderProcessing, RetailShipping,
    CustomerFeedback, RecipeUpdate, MarketAnalysis
])
