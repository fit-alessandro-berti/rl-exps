...
root = StrictPartialOrder(nodes=[
    site_analysis, structural_check, system_design, hydroponics_setup, lighting_install, sensor_install, climate_control, nutrient_monitor, seed_selection, germination_start, auto_planting, growth_monitoring, ai_analytics, robotic_harvest, packaging, trace_labeling, logistics_plan
])
