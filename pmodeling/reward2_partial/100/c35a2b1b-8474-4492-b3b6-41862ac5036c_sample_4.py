...
root.order.add_edge(Historical_Check, Market_Analyze)
root.order.add_edge(Forgery_Detect, Restoration_Map)
root.order.add_edge(Market_Analyze, Auction_Review)
root.order.add_edge(Provenance_Trace, Value_Assess)
root.order.add_edge(Auction_Review, Board_Review)
root.order.add_edge(Report_Draft, Certification)
root.order.add_edge(Board_Review, Release_Artifact)
root.order.add_edge(Certification, Chain_Custody)