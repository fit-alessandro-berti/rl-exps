...
root = StrictPartialOrder(nodes=[
    ...
    stylistic_match, database_query, panel_review, certify_report, condition_assess, storage_plan,
    catalog_entry, display_prep, loan_arrange, monitor_setup
])
...
root.order.add_edge(database_query, stylistic_match)
