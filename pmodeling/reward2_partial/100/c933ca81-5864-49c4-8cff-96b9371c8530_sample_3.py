...
# Create the root partial order with all the transitions
root = StrictPartialOrder(nodes=[
    client_consult, spec_finalize, design_draft, aerodynamics_test, ai_integration,
    material_sourcing, component_order, assembly_line, firmware_install,
    environmental_test, quality_check, brand_packaging, shipping_prep,
