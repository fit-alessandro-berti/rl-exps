...
root = StrictPartialOrder(nodes=[
    data_collection, point_aggregation, conflict_check, fraud_scan, reward_adjust, redemption_verify, partner_sync, behavior_analyze, async_update, rollback_trigger, compliance_check, notification_send, user_feedback, report_generate, system_audit
])
