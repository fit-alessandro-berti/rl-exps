...
root.order.add_edge(seed_sourcing, yield_monitor)
root.order.add_edge(seed_sourcing, market_setup)
root.order.add_edge(seed_sourcing, maintenance)
root.order.add_edge(seed_sourcing, waste_manage)
