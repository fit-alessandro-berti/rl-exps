...
root = StrictPartialOrder(nodes=[
    SiteAssess, LoadTesting, ClimateStudy, MediumPrep, BedInstall, IrrigationSetup,
    CropSelect, PestControl, CommunityMeet, MonitorDeploy, WasteCycle, YieldForecast,
    MarketLink, WorkshopPlan, TechIntegrate
])
