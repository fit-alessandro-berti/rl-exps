...
root = StrictPartialOrder(nodes=[
    SiteAssess, StructureCheck, PermitObtain, MaterialSource, SoilPrepare, WaterproofRoof, IrrigationSetup, BedAssemble, CropPlan, PestMonitor, NutrientCalibrate, HarvestSchedule, CommunityTrain, YieldRecord, ImpactReview
])
