...
root = StrictPartialOrder(nodes=[
    material_sourcing, supplier_vetting, design_review, prototype_build, quality_audit, batch_scheduling,
    handcrafting, packaging_design, custom_labeling, sustainability_check, inventory_sync, market_analysis,
    order_aggregation, distribution_plan, customer_feedback
])
