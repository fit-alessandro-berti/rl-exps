...
root.order.add_edge(Ownership_Audit, Expert_Arb)
root.order.add_edge(Export_Verify, Expert_Arb)
root.order.add_edge(Expert_Arb, Conservation_Plan)
...
root.order.add_edge(Acquisitions_Meet, Final_Doc)