...
root = StrictPartialOrder(nodes=[
    inspect_item, verify_provenance, document_condition, disassemble_parts, clean_components,
    analyze_damage, select_materials, perform_repairs, match_finishes, apply_treatments, reassemble_item,
    quality_check, photograph_results, update_archive, client_review, finalize_report
])
