...
root = StrictPartialOrder(nodes=[
    Milk_Sourcing, Quality_Testing, Curd_Processing, Salt_Application, Mold_Inoculation, Press_Molding, Brine_Soaking, Aging_Setup, Humidity_Control, Microbial_Check, Packaging_Design, Label_Printing, Trace_Logging, Distribution_Plan, Customer_Review, Inventory_Audit, Sustainability_Audit
])
