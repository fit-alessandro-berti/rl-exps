...
root = StrictPartialOrder(nodes=[
    sourcing, verify, transport, storytelling, crafting, creation, catalog, 
    marketing, targeting, packaging, cooperatives, audit, logistics, shipping, feedback
])
...
root.order.add_edge(packaging, cooperatives)
