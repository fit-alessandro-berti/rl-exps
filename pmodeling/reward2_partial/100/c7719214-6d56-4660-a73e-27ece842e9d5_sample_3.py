...
root = StrictPartialOrder(nodes=[
    Milk_Sourcing, Diet_Monitoring, Culture_Selection, Milk_Pasteurize, Curd_Cutting, Whey_Draining, Mold_Inoculate,
    Press_Forming, Salt_Application, Aging_Setup, Humidity_Control, Flavor_Testing, Packaging_Design, Order_Processing,
    Retail_Delivery, Event_Coordination, Feedback_Review
])
