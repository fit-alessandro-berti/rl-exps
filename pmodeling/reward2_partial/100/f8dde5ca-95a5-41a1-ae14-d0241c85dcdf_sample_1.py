...
# Define the partial order (workflow) using StrictPartialOrder
root = StrictPartialOrder(nodes=[
    provenance_check, material_scan, radiocarbon_test, style_compare, database_query,
    blockchain_prep, legal_review, ownership_audit, conservation_plan, expert_panel,
    report_draft, client_review, authority_submit, exhibit_setup, final_approval
])

# Define the order of execution (dependencies) between the activities
