...
root.order.add_edge(activities['Demand Forecast'], activities['Inventory Check'])
root.order.add_edge(activities['Inventory Check'], activities['Route Update'])
root.order.add_edge(activities['Route Update'], activities['Shipment Plan'])
...
root.order.add_edge(activities['Contract Mod'], activities['Blockchain Verify'])
...
root.order.add_edge(activities['Scenario Sim'], activities['Feedback Loop'])
root.order.add_edge(activities['Feedback Loop'], activities['AI Adjust'])
root.order.add_edge(activities['AI Adjust'], activities['Waste Audit'])
root.order.add_edge(activities['Waste Audit'], activities['Report Generate'])
root.order.add_edge(activities['Report Generate'], activities['Stakeholder Alert'])
