...
root = StrictPartialOrder(nodes=[MilkSourcing, FarmSelection, QualityTesting, MilkPasteurize, StarterCulture, Coagulation, CurdCutting, WheyDraining, MoldInoculate, AgingControl, FlavorTasting, PackagingDesign, LabelApproval, InventoryAudit, OrderFulfill, RetailShipping])
