...
root = StrictPartialOrder(nodes=[OpportunityScan, IdeaWorkshop, ConceptMerge, ResourceAlign, PrototypeBuild, FeasibilityTest, PilotLaunch, FeedbackGather, DesignAdapt, ComplianceCheck, ScalingPlan, IPManagement, MarketSync, PartnerReview, ExitStrategy])
