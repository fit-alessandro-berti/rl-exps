...
root = StrictPartialOrder(nodes=[site_select, layout_design, sensor_integrate, crop_choose, soil_prepare, irrigation_setup, pest_control, lighting_install, staff_train, compliance_check, market_analyze, package_design, logistics_plan, data_analyze, feedback_loop])

# Define the order between transitions
root.order.add_edge(site_select, layout_design)
root.order.add_edge(layout_design, sensor_integrate)
