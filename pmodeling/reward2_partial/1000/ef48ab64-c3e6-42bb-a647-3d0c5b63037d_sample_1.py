...
# Define the process as a StrictPartialOrder with defined dependencies
root = StrictPartialOrder(nodes=[Site_Select, Env_Assess, Design_Modules, Hydroponics_Setup, Software_Dev, Seed_Choose, LED_Install, Train_Staff, Compliance_Check, Engage_Community, Plant_Crops, Monitor_Growth, Optimize_Yields, Waste_Manage, Energy_Audit, Water_Recycle])
