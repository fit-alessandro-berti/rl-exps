...
root.order.add_edge(material_test, ledger_verification)
root.order.add_edge(spectrometry_scan, archive_search)
root.order.add_edge(spectrometry_scan, ledger_verification)
root.order.add_edge(stylistic_analysis, secondary_review)
root.order.add_edge(stylistic_analysis, cross_check)
root.order.add_edge(expert_consult, secondary_review)
root.order.add_edge(expert_consult, cross_check)
root.order.add_edge(archive_search, conservation_prep)
root.order.add_edge(archive_search, report_creation)
root.order.add_edge(ledger_verification, conservation_prep)
root.order.add_edge(ledger_verification, report_creation)
root.order.add_edge(secondary_review, conservation_prep)
root.order.add_edge(secondary_review, report_creation)
root.order.add_edge(cross_check, conservation_prep)
root.order.add_edge(cross_check, report_creation)
