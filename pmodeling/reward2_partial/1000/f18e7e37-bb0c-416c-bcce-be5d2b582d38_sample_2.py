...
root = StrictPartialOrder(nodes=[
    user_signup, set_preference, meal_select, schedule_delivery, supplier_match,
    inventory_check, ingredient_order, quality_inspect, meal_pack, route_plan,
    dispatch_kit, delivery_track, feedback_collect, data_analyze, plan_optimize
])

# Define the order
root.order.add_edge(user_signup, set_preference)
root.order.add_edge(set_preference, meal_select)
