...
root = StrictPartialOrder(nodes=[
    ComponentSourcing, FrameAssembly, SensorMounting, WiringHarness, CircuitTesting, 
    FirmwareLoading, InitialCalibration, SoftwareIntegration, FlightTesting, DataLogging, 
    PerformanceTuning, PackagingPrep, CustomLabeling, DocumentationPrint, QualityReview, 
    ClientTraining, RemoteMonitoring, FirmwareUpdate
])
