...
root = StrictPartialOrder(nodes=[
    site_survey, structural_check, iot_setup, crop_selection,
    hydroponic_install, water_recycling, energy_audit,
    plant_scheduling, yield_monitoring, regulation_review,
    staff_training, data_integration, supply_setup,
...
root.order.add_edge(structural_check, crop_selection)
root.order.add_edge(structural_check, hydroponic_install)
root.order.add_edge(iot_setup, water_recycling)
root.order.add_edge(iot_setup, energy_audit)
root.order.add_edge(crop_selection, plant_scheduling)
root.order.add_edge(hydroponic_install, yield_monitoring)
root.order.add_edge(energy_audit, regulation_review)
