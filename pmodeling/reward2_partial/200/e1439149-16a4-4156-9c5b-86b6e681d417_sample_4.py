...
root = StrictPartialOrder(nodes=[
    trend_scan, idea_harvest, workshop_host, concept_filter, prototype_build, expert_review,
    feasibility_check, risk_assess, pilot_launch, data_capture, performance_review, scale_plan,
    resource_align, learn_share, culture_embed
])
