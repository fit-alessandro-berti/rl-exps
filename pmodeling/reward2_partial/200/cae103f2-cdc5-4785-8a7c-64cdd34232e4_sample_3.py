...
root = StrictPartialOrder(nodes=[
    site_acquisition, impact_assessment, modular_setup, crop_planting, nutrient_control,
    pest_control, growth_monitor, community_engagement, yield_forecast, supply_coordinate,
