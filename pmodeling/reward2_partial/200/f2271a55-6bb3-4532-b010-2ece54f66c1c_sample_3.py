...
root = StrictPartialOrder(nodes=[
    provenance_check, spectroscopy_test, carbon_dating, style_analysis,
    image_scanning, restoration_scan, appraiser_review, database_match,
    blockchain_entry, certificate_issue, forgery_detect, report_compilation,
    client_briefing, secure_storage, final_approval
])
...
root.order.add_edge(spectroscopy_test, blockchain_entry)
root.order.add_edge(carbon_dating, blockchain_entry)
root.order.add_edge(style_analysis, blockchain_entry)
root.order.add_edge(image_scanning, blockchain_entry)
root.order.add_edge(restoration_scan, blockchain_entry)
root.order.add_edge(appraiser_review, blockchain_entry)
...
root.order.add_edge(certificate_issue, report_compilation)
