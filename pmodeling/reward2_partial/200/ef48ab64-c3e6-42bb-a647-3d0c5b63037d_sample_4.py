...
root = StrictPartialOrder(nodes=[
    site_select, env_assess, design_modules, hydroponics_setup, software_dev,
    seed_choose, led_install, train_staff, compliance_check, engage_community,
    plant_crops, monitor_growth, optimize_yields, waste_manage, energy_audit,
    water_recycle
])

# Define the order of the nodes in the workflow
