...
root = StrictPartialOrder(nodes=[signup, set_preferences, select_meal, schedule_delivery, match_supplier, check_inventory, order_ingredients, inspect_quality, pack_meal, plan_route, dispatch_kit, track_delivery, collect_feedback, analyze_data, optimize_plan])
