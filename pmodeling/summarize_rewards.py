...
# Example usage:
file_list = ['reward_scores_step0.csv', 'reward_scores_sft.csv', 'reward_scores_step1.csv', 'reward_scores_step2.csv', 'reward_scores_step3.csv', 'reward_scores_step4.csv', 'reward_scores_step5.csv', 'reward_scores_step6.csv', 'reward_scores_step7.csv', 'reward_scores_step8.csv', 'reward_scores_step9.csv']
