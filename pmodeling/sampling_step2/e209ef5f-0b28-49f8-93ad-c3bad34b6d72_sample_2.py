...
# Create a partial order graph with the defined transitions
root = StrictPartialOrder(nodes=[
    soil_analyze, site_mapping, bed_setup, crop_select,
    sensor_deploy, irrigation_adjust, nutrient_feed, pest_scouting,
    pest_predict, workshop_host, crop_rotate, waste_compost,
