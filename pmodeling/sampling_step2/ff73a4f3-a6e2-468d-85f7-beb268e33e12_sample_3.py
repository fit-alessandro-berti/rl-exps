...
root = StrictPartialOrder(nodes=[
    audit_artifacts, interview_staff, assess_risks, plan_retrieval, legal_review,
    security_check, execute_recovery, validate_items, restore_function, update_systems,
    train_users, document_findings, archive_records, review_lessons, close_process
])
