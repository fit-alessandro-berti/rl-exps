...
# Define the POWL model for the urban farming cooperative process
...
root = StrictPartialOrder(nodes=[
    seed_sourcing, farm_scheduling, sensor_monitoring, nutrient_cycling,
    crop_forecasting, pest_inspection, harvest_timing, quality_check,
    eco_packaging, storage_allocation, order_processing, route_planning,
    vehicle_dispatch, customer_feedback, demand_analysis, waste_management,
    community_outreach
])
