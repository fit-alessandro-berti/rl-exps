...
root = StrictPartialOrder(nodes=[
    site_survey, permit_check, hive_setup, community_meet, hive_monitor,
    pest_control, honey_harvest, data_logging, workshop_plan, supply_order,
    volunteer_coord, regulation_review, pollination_map, apiary_audit,
