...
root = StrictPartialOrder(nodes=[
    site_survey, design_layout, system_build, install_sensors, set_controls,
    test_modules, select_crops, configure_irrigation, deploy_ai, monitor_pests,
    manage_energy, recycle_waste, train_staff, launch_market, engage_community
])
