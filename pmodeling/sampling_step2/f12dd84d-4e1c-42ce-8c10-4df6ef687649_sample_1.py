...
root = StrictPartialOrder(nodes=[
    ...
    press_molding, brine_soaking, aging_setup, humidity_control, microbial_check,
    packaging_design, label_printing, trace_logging, distribution_plan, customer_review,
