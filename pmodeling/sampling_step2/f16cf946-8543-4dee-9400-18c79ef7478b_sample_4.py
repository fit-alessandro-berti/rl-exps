...
root = StrictPartialOrder(nodes=[
    site_survey, climate_study, system_design, seed_selection, unit_install,
    sensor_setup, nutrient_mix, energy_audit, pest_control, crop_plan,
    quality_check, yield_forecast, supply_sync, staff_train, data_review
])
...
# Now, the 'root' variable contains the POWL model for the urban vertical farming process.