...
OUTPUT_DIR = "grpo_qwen_powl_generator_step7"
...
def powl_reward_function(completions: List[str], positive_way: bool = False, **kwargs) -> List[float]:
    ...
    for gen_code, ref_code in zip(completions, reference_completions):
        ...
        try:
            ...
            # Activity matching reward (keep this)
