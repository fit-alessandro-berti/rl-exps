...
# Define the transitions (activities) for the workflow
...
# Define the partial order structure of the workflow
root = StrictPartialOrder(nodes=[
    inquiry_review, client_onboard, concept_draft, feedback_cycle, 
    contract_setup, payment_schedule, material_sourcing, artwork_create, 
    quality_check, frame_selection, packaging_prep, shipment_arrange, 
    delivery_confirm, post_sale_support, revision_manage, delay_mitigate
])
