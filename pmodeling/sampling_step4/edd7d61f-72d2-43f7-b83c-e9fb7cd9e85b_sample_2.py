...
root = StrictPartialOrder(nodes=[initial_review, provenance_check, material_scan, chemical_test, imaging_capture, expert_consult, historical_match, forgery_detect, documentation_verify, cross_border_check, condition_assess, value_estimate, report_draft, report_review, client_approval, certification_issue, archive_record])
