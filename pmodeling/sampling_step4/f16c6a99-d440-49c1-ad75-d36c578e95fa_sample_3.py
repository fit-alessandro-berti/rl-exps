...
# Define the POWL model as a strict partial order with defined order dependencies
...
# The final result, the root of the POWL model, is stored in the 'root' variable.
print(root)