...
root = StrictPartialOrder(nodes=[schedule_compliance_audit, conduct_self_assessment, gather_evidence, conduct_external_audit, identify_gaps_or_issues, make_necessary_corrections_or_improvements, conduct_final_audit, prepare_documentation, issue_official_documents, award_certification])

# Define the dependencies
root.order.add_edge(schedule_compliance_audit, conduct_self_assessment)
root.order.add_edge(conduct_self_assessment, gather_evidence)
root.order.add_edge(gather_evidence, conduct_external_audit)
...
root.order.add_edge(issue_official_documents, award_certification)