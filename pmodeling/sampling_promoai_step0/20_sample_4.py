...
sommelier_fetches_wine_and_prepares_alcoholic_beverages = Transition(label='Sommelier fetches wine and prepares alcoholic beverages')
...
root.order.add_edge(manager_gives_order_to_sommelier, manager_submits_order_ticket_to_kitchen)
root.order.add_edge(manager_submits_order_ticket_to_kitchen, manager_takes_down_the_order)
root.order.add_edge(manager_takes_down_the_order, kitchen_prepares_food)
