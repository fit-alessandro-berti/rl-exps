...
root.order.add_edge(identify_idea, conduct_feasibility)
...
root.order.add_edge(build_prototype, test_safety)
root.order.add_edge(build_prototype, test_market_potential)
root.order.add_edge(test_functionality, collect_feedback)
root.order.add_edge(test_safety, collect_feedback)
root.order.add_edge(test_market_potential, collect_feedback)
root.order.add_edge(collect_feedback, refine_prototype)
root.order.add_edge(refine_prototype, build_prototype)
root.order.add_edge(refine_prototype, test_functionality)
root.order.add_edge(refine_prototype, test_safety)
root.order.add_edge(refine_prototype, test_market_potential)
root.order.add_edge(refine_prototype, collect_feedback)
root.order.add_edge(refine_prototype, approve_development)
root.order.add_edge(refine_prototype, discard_prototype)
root.order.add_edge(approve_development, discard_prototype)
