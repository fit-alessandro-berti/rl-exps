...
# Define the partial order's order
root.order.add_edge(guest_calls_room_service, manager_takes_down_order)
root.order.add_edge(manager_takes_down_order, manager_submits_order_ticket_to_kitchen)
root.order.add_edge(manager_submits_order_ticket_to_kitchen, manager_assigns_order_to_waiter)
root.order.add_edge(manager_assigns_order_to_waiter, manager_gives_order_to_sommelier)
root.order.add_edge(manager_gives_order_to_sommelier, kitchen_prepares_food)
root.order.add_edge(manager_gives_order_to_sommelier, sommelier_fetches_wine_and_preps_alcoholic_beverages)
root.order.add_edge(kitchen_prepares_food, waiter_debits_guests_account)
...
root.order.add_edge(sommelier_fetches_wine_and_preps_alcoholic_beverages, waiter_delivers_order_to_guests_room)
root.order.add_edge(waiter_debits_guests_account, waiter_prepares_nonalcoholic_drinks)
root.order.add_edge(waiter_debits_guests_account, waiter_readies_cart)
root.order.add_edge(waiter_delivers_order_to_guests_room, waiter_prepares_nonalcoholic_drinks)
root.order.add_edge(waiter_delivers_order_to_guests_room, waiter_readies_cart)
root.order.add_edge(waiter_prepares_nonalcoholic_drinks, waiter_returns_to_room_service_station)
root.order.add_edge(waiter_prepares_nonalcoholic_drinks, waiter_waits_delays_debiting)
root.order.add_edge(waiter_readies_cart, waiter_returns_to_room_service_station)
root.order.add_edge(waiter_readies_cart, waiter_waits_delays_debiting)
...
root.order.add_edge(waiter_returns_to_room_service_station, waiter_readies_cart)
root.order.add_edge(waiter_waits_delays_debiting, waiter_debits_guests_account)
root.order.add_edge(waiter_waits_delays_debiting, waiter_prepares_nonalcoholic_drinks)
root.order.add_edge(waiter_waits_delays_debiting, waiter_readies_cart)
