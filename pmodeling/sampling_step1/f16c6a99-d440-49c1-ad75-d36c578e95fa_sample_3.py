...
root = StrictPartialOrder(nodes=[
    SiteSurvey, DesignLayout, SensorDeploy, CropSelect, SystemInstall,
    EnergySetup, WaterCycle, PestControl, RegulatoryCheck, StaffTraining,
    DataConfigure, SupplyPlan, HarvestSchedule, QualityAudit, MarketLaunch,
    FeedbackLoop
])
