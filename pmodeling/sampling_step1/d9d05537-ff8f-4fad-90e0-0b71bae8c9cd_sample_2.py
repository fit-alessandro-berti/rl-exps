...
# Define the loop for the recovery plan
loop_recovery = OperatorPOWL(operator=Operator.LOOP, children=[risk_mitigate, external_consult])

# Define the partial order
root = StrictPartialOrder(nodes=[alert_verify, impact_assess, team_assemble, resource_allocate, stakeholder_notify, legal_review, media_brief, response_deploy, situation_monitor, data_collect, loop_recovery, status_update, post_review])
...
root.order.add_edge(risk_mitigate, external_consult)
