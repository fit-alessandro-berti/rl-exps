...
root = StrictPartialOrder(nodes=[provenance_check, material_test, archive_search, expert_review, three_d_scanning, wear_analysis, database_cross, law_consult, forgery_detect, certification, document_prep, client_brief, secure_storage, risk_assessment, final_approval])
...
root.order.add_edge(three_d_scanning, law_consult)
...
root.order.add_edge(forgery_detect, document_prep)
root.order.add_edge(forgery_detect, client_brief)
