...
root = StrictPartialOrder(nodes=[
    farm_selection, sample_testing, trade_negotiation, micro_lot_sorting, fermentation_control, sensory_profiling, roast_calibration, blend_creation, sustainability_audit, packaging_design, quality_inspection, inventory_sync, logistics_planning, cafe_training, dynamic_pricing, customer_feedback, traceability_logging
])
