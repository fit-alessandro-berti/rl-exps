...
loop = OperatorPOWL(operator=Operator.LOOP, children=[system_install, hydroponic_setup, climate_config, ai_integration, nutrient_sourcing, waste_planning, staff_training])
xor = OperatorPOWL(operator=Operator.XOR, children=[crop_seeding, growth_monitoring, quality_testing, harvest_scheduling, distribution_plan, data_analysis])

root = StrictPartialOrder(nodes=[site_survey, permit_filing, structure_design, loop, xor])
