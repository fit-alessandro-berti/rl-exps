...
# Define the loop node for the art installation process
...
root = StrictPartialOrder(nodes=[client_consult, needs_assess, art_selection, inventory_check, legal_draft, contract_sign, insurance_setup, transport_plan, secure_transit, art_install_loop, lease_renew, payment_process, deinstall_art, return_inspect, purchase_option])
...
root.order.add_edge(secure_transit, art_install_loop)
root.order.add_edge(art_install_loop, lease_renew)
