...
root.order.add_edge(condition_report, forgeriescan)
root.order.add_edge(forgeriescan, digital_tagging)
...
root.order.add_edge(legal_verify, provenancedraft)
root.order.add_edge(provenancedraft, client_approval)
