...
# Define the loop for data analysis and maintenance
loop = OperatorPOWL(operator=Operator.LOOP, children=[data_analysis, system_maintenance])

# Define the partial order of activities
root = StrictPartialOrder(nodes=[seed_selection, nutrient_mix, planting_setup, climate_control, water_cycling, growth_monitoring, pest_detection, light_adjustment, loop, harvest_planning, crop_harvest, yield_sorting, packaging_prep, distribution_plan, regulation_check, waste_recycling])
