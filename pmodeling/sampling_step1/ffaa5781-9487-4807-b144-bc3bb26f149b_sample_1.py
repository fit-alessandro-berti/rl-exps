...
# Define the choice for expert consultations
...
root = StrictPartialOrder(nodes=[provenance_check, analysis_loop, expert_choice, context_validation, legal_audit, export_verify, digital_imaging, three_d_modeling, consensus_meeting, final_approval, catalog_entry, virtual_setup, archival_backup])
root.order.add_edge(provenance_check, analysis_loop)
root.order.add_edge(analysis_loop, expert_choice)
root.order.add_edge(expert_choice, context_validation)
