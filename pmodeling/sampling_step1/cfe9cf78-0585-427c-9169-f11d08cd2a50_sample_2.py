...
# Define the loop for the operational launch
...
# Define the exclusive choice for the operational launch
xor = OperatorPOWL(operator=Operator.XOR, children=[market_launch, logistics_setup])

# Define the root POWL model
root = StrictPartialOrder(nodes=[site_analysis, env_assessment, system_design, equipment_order, seed_selection, install_modules, calibrate_systems, staff_training, plant_seeding, loop, xor])
...
root.order.add_edge(logistics_setup, loop)
