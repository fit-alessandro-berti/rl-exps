...
expert_panel_loop = OperatorPOWL(operator=Operator.LOOP, children=[style_assessment, context_review])

root = StrictPartialOrder(nodes=[
    artifact_intake, document_check, provenance_loop, scientific_loop, expert_panel_loop, report_draft, quality_review,
...
root.order.add_edge(scientific_loop, expert_panel_loop)
