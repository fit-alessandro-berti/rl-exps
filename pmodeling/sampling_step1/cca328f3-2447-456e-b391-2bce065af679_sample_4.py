...
root = StrictPartialOrder(nodes=[
    ...
    expert_review, database_search, legal_audit, cultural_assess, data_synthesis,
...
# Add a loop for the investigation flag
loop = OperatorPOWL(operator=Operator.LOOP, children=[investigation_flag])
root.order.add_edge(loop, investigation_flag)

# Add a choice between display approve and lender notify
xor = OperatorPOWL(operator=Operator.XOR, children=[display_approve, lender_notify])
