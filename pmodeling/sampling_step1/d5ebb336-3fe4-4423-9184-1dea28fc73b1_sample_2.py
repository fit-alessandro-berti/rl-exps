...
xor2 = OperatorPOWL(operator=Operator.XOR, children=[async_update, rollback_trigger])
xor3 = OperatorPOWL(operator=Operator.XOR, children=[compliance_check, notification_send])
xor4 = OperatorPOWL(operator=Operator.XOR, children=[user_feedback, report_generate])
xor5 = OperatorPOWL(operator=Operator.XOR, children=[system_audit])
...
root.order.add_edge(xor4, system_audit)