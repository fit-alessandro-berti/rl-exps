...
root = StrictPartialOrder(
    nodes=[milk_sourcing, quality_testing, milk_pasturize, culture_addition, curd_cutting, whey_drain, cheese_molding, controlled_aging, sensory_check, health_certify, custom_labeling, cold_packaging, logistics_setup, export_docs, customs_clearance, shipment_track, client_feedback]
)
