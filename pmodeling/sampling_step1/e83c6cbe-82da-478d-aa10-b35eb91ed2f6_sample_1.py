...
root = StrictPartialOrder(nodes=[
    provenance_check, material_testing, stylistic_review, expert_panel,
    legal_clearance, ethics_audit, insurance_quote, risk_assess,
    digital_archive, replica_build, transport_prep, final_review,
    catalog_entry, public_notice, condition_report
])
...
root.order.add_edge(material_testing, legal_clearance)
root.order.add_edge(material_testing, ethics_audit)
root.order.add_edge(stylistic_review, insurance_quote)
root.order.add_edge(stylistic_review, risk_assess)
