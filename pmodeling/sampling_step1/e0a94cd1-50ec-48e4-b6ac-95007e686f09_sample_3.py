...
root.order.add_edge(scenario_simulate, inventory_adjust)
root.order.add_edge(scenario_simulate, procurement_plan)
root.order.add_edge(scenario_simulate, performance_track)
