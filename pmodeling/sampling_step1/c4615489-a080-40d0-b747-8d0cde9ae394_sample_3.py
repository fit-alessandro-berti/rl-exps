...
root = StrictPartialOrder(nodes=[
    site_survey, structural_audit, permit_filing, design_layout, install_hvac,
    set_lighting, build_racks, install_hydroponics, configure_sensors, select_crops,
    seed_planting, monitor_growth, nutrient_mixing, staff_training, market_launch,
    waste_recycling, customer_onboarding
])
