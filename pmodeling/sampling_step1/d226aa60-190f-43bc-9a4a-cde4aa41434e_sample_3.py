...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[sensor_check, data_analyze, water_adjust, light_control, humidity_monitor, pest_inspect, growth_forecast])
...
root = StrictPartialOrder(nodes=[seed_select, trend_analyze, nutrient_mix, auto_plant, xor])
...
root.order.add_edge(growth_forecast, rapid_cool)
