...
root = StrictPartialOrder(nodes=[artifact_intake, initial_survey_to_material_test, historical_check_to_registry_search, owner_interview_to_condition_report, forgery_scan_to_digital_tagging, ledger_entry_to_expert_review, legal_verify_to_provenance_draft, provenance_draft_to_client_approval, client_approval_to_final_certificate, final_certificate_to_archive_storage])
root.order.add_edge(artifact_intake, initial_survey_to_material_test)
root.order.add_edge(initial_survey_to_material_test, material_test)
root.order.add_edge(initial_survey_to_material_test, historical_check_to_registry_search)
root.order.add_edge(historical_check_to_registry_search, registry_search)
root.order.add_edge(owner_interview_to_condition_report, condition_report)
root.order.add_edge(forgery_scan_to_digital_tagging, digital_tagging)
root.order.add_edge(ledger_entry_to_expert_review, expert_review)
root.order.add_edge(legal_verify_to_provenance_draft, provenance_draft)
root.order.add_edge(provenance_draft_to_client_approval, client_approval)
root.order.add_edge(client_approval_to_final_certificate, final_certificate)
root.order.add_edge(final_certificate_to_archive_storage, archive_storage)