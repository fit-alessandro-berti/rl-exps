...
loop_aging = OperatorPOWL(operator=Operator.LOOP, children=[aging_process])

# Define the exclusive choice for the microbial test and quality check
exclusive_choice = OperatorPOWL(operator=Operator.XOR, children=[microbial_test, quality_check])
...
root.order.add_edge(salting_stage, loop_aging)
root.order.add_edge(loop_aging, exclusive_choice)
root.order.add_edge(exclusive_choice, eco_packaging)
