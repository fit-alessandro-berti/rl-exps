...
root.order.add_edge(condition_check, database_match)
root.order.add_edge(condition_check, provenance_check)
root.order.add_edge(multi_spectral_scan, expert_review)
root.order.add_edge(multi_spectral_scan, historical_query)
root.order.add_edge(material_test, lab_collaboration)
root.order.add_edge(expert_review, imaging_analysis)
root.order.add_edge(historical_query, imaging_analysis)
root.order.add_edge(lab_collaboration, imaging_analysis)
root.order.add_edge(imaging_analysis, forgery_detection)
root.order.add_edge(imaging_analysis, legal_drafting)
root.order.add_edge(forgery_detection, certification_issue)
root.order.add_edge(forgery_detection, client_briefing)
root.order.add_edge(legal_drafting, client_briefing)
