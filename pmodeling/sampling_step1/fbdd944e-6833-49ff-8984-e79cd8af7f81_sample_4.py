...
xor1 = OperatorPOWL(operator=Operator.XOR, children=[insurance_verify, client_onboard])
xor2 = OperatorPOWL(operator=Operator.XOR, children=[needs_assess, xor1])
xor3 = OperatorPOWL(operator=Operator.XOR, children=[drone_config, xor2])
xor4 = OperatorPOWL(operator=Operator.XOR, children=[route_program, xor3])
xor5 = OperatorPOWL(operator=Operator.XOR, children=[compliance_check, xor4])
