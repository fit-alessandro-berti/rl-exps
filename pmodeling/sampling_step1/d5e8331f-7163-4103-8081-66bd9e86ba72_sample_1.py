...
root.order.add_edge(env_monitor, growth_check)
root.order.add_edge(env_monitor, light_calibrate)
root.order.add_edge(env_monitor, energy_manage)
root.order.add_edge(pest_control, water_adjust)
root.order.add_edge(pest_control, growth_check)
root.order.add_edge(pest_control, light_calibrate)
root.order.add_edge(pest_control, energy_manage)
root.order.add_edge(growth_check, light_calibrate)
root.order.add_edge(growth_check, energy_manage)
...
root.order.add_edge(harvest_crop, pack_goods)
