...
approve_quote = SilentTransition()
...
root = StrictPartialOrder(nodes=[receive_inquiry, collect_info, address_concerns, guide_selection, provide_quote, approve_quote, place_order, record_order, send_confirmation])
...
root.order.add_edge(provide_quote, approve_quote)
root.order.add_edge(approve_quote, place_order)
