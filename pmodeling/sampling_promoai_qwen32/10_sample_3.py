...
loop = OperatorPOWL(operator=Operator.LOOP, children=[provide_support])

root = StrictPartialOrder(nodes=[submit_request, assess_compatibility, evaluate_cost, procure_tools, install_solution, test_solution, roll_out, provide_training, loop])
...
root.order.add_edge(provide_training, loop)