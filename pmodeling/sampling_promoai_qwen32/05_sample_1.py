...
root = StrictPartialOrder(nodes=[
    issue_rfp, receive_proposals, evaluate_proposal, conduct_site_visit, conduct_interview, select_supplier, 
    begin_contract_negotiations, sign_contract, execute_contract, onboard_supplier
])
