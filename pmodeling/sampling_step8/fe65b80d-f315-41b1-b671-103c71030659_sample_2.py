...
root = StrictPartialOrder(nodes=[
    ingredient_sourcing, quality_testing, scents_blending, micro_batch, sensory_panel, formula_adjust,
    safety_review, sustainability_check, packaging_design, prototype_creation, client_feedback, label_approval,
    final_production, marketing_plan, distribution_prep, sales_launch
])

# Define the dependencies
root.order.add_edge(ingredient_sourcing, quality_testing)
root.order.add_edge(quality_testing, scents_blending)
root.order.add_edge(scents_blending, micro_batch)
