...
loop = OperatorPOWL(operator=Operator.LOOP, children=[inventory_update, customer_notify, compliance_audit, cost_analysis, report_generate])

# Define the partial order
root.nodes = [return_request, authorization_check, pickup_schedule, transport_dispatch, receiving_goods, quality_inspect, sort_items, xor, loop]
