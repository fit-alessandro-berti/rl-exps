...
# Define transitions (activities) with their exact names
...
root = StrictPartialOrder(nodes=[
    site_survey, design_layout, material_sourcing, unit_assembly, system_wiring, sensor_install,
...
# Define the control flow (partial order) between activities
