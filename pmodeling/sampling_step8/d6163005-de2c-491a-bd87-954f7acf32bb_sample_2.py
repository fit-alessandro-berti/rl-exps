...
root = StrictPartialOrder(nodes=[
    req_analysis, sourcing, quality_check, frame_assembly, motor_installation, sensor_setup, control_unit,
    firmware_upload, system_calibration, flight_testing, error_correction, cosmetic_finish, packaging_prep,
    user_manual, client_training, support_scheduling
])

# Define the POWL partial order's edges
root.order.add_edge(req_analysis, sourcing)
