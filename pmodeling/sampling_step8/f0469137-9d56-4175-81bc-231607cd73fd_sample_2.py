...
root.order.add_edge(seed_germinate, irrigation_setup)
...
root.order.add_edge(robotic_harvest, waste_recycle)
root.order.add_edge(robotic_harvest, energy_optimize)
