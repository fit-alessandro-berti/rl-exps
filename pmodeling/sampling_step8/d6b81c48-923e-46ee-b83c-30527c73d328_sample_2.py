...
root.order.add_edge(sensor_calibrate, firmware_patch)
...
root.order.add_edge(flight_launch, anomaly_detect)
root.order.add_edge(flight_launch, collision_assess)
root.order.add_edge(telemetry_monitor, data_upload)
root.order.add_edge(telemetry_monitor, battery_optimize)
root.order.add_edge(telemetry_monitor, damage_repair)
root.order.add_edge(telemetry_monitor, compliance_report)
root.order.add_edge(anomaly_detect, battery_optimize)
root.order.add_edge(anomaly_detect, damage_repair)
root.order.add_edge(anomaly_detect, compliance_report)
root.order.add_edge(collision_assess, damage_repair)
root.order.add_edge(collision_assess, compliance_report)
root.order.add_edge(battery_optimize, postflight_review)
root.order.add_edge(battery_optimize, compliance_report)
root.order.add_edge(damage_repair, postflight_review)
