...
# Define the activities with exact names as given
...
root = StrictPartialOrder(nodes=[
    ...
    hydroponic_setup, community_meet, crop_select, sensor_install, water_testing,
    pest_control, growth_monitor, harvest_plan, market_launch, feedback_collect
])
