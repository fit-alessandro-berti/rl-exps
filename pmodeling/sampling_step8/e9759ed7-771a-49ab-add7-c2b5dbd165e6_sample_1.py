...
root = StrictPartialOrder(nodes=[
    sourcing, testing, extraction, formulation, quality_control, aging, allergen_check, market_research, bottle_design, label_approval, packaging_setup, batch_mixing, scent_profiling, client_feedback, release_scheduling, regulatory_review, sales_training
])
