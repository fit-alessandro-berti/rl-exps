...
# Define the workflow
# Provenance Check -> Material Scan -> Expert Review -> Legal Audit
# -> Condition Report -> Carbon Dating -> Ownership Verify -> Historical Match
# -> Customs Clearance -> Risk Assessment -> Ethics Approval -> Restoration Plan
# -> Final Approval -> Catalog Entry -> Exhibit Prep

# Create the Partial Order
root = StrictPartialOrder(nodes=[
    provenance_check, material_scan, expert_review, legal_audit,
    condition_report, carbon_dating, ownership_verify, historical_match,
    customs_clearance, risk_assessment, ethics_approval, restoration_plan,
    final_approval, catalog_entry, exhibit_prep
])
