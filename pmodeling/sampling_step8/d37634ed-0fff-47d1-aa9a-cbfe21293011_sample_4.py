...
root = StrictPartialOrder(nodes=[
    seed_selection, nutrient_mix, env_check, planting_setup, growth_monitoring, pest_control,
...
root.order.add_edge(seed_selection, env_check)
root.order.add_edge(nutrient_mix, planting_setup)
root.order.add_edge(env_check, planting_setup)
