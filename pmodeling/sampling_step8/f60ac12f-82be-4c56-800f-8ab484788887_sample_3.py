...
aging_loop = OperatorPOWL(operator=Operator.LOOP, children=[age_monitor, quality_test])

# Define the partial order for the supply chain
...
root.order.add_edge(salt_brine, aging_loop)
