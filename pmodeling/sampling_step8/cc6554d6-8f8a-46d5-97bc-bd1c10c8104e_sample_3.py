...
xor = OperatorPOWL(operator=Operator.XOR, children=[delay_monitor, feedback_loop])
loop = OperatorPOWL(operator=Operator.LOOP, children=[strategy_update])
...
root.order.add_edge(strategy_update, loop)
