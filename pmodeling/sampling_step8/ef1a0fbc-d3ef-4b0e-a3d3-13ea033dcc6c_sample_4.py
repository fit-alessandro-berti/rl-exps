...
root = StrictPartialOrder(
    ...
    order={
        milk_sourcing: [farm_selection],
        farm_selection: [quality_testing],
        quality_testing: [milk_pasteurize],
        milk_pasteurize: [starter_culture],
        starter_culture: [coagulation],
        coagulation: [curd_cutting],
        curd_cutting: [whey_draining],
        whey_draining: [mold_inoculate],
        mold_inoculate: [aging_control],
        aging_control: [flavor_tasting],
        flavor_tasting: [packaging_design],
        packaging_design: [label_approval],
        label_approval: [inventory_audit],
        inventory_audit: [order_fulfill],
