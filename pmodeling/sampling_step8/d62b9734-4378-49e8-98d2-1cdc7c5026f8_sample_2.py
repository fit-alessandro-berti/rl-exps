...
provenance_check_to_image_capture = OperatorPOWL(operator=Operator.XOR, children=[provenance_check, skip])
image_capture_to_material_scan = OperatorPOWL(operator=Operator.XOR, children=[image_capture, skip])
material_scan_to_expert_review = OperatorPOWL(operator=Operator.XOR, children=[material_scan, skip])
expert_review_to_historical_cross = OperatorPOWL(operator=Operator.XOR, children=[expert_review, skip])
historical_cross_to_legal_verify = OperatorPOWL(operator=Operator.XOR, children=[historical_cross, skip])
legal_verify_to_registry_search = OperatorPOWL(operator=Operator.XOR, children=[legal_verify, skip])
registry_search_to_customs_clear = OperatorPOWL(operator=Operator.XOR, children=[registry_search, skip])
customs_clear_to_condition_assess = OperatorPOWL(operator=Operator.XOR, children=[customs_clear, skip])
condition_assess_to_data_log = OperatorPOWL(operator=Operator.XOR, children=[condition_assess, skip])
data_log_to_chain_custody = OperatorPOWL(operator=Operator.XOR, children=[data_log, skip])
chain_custody_to_report_draft = OperatorPOWL(operator=Operator.XOR, children=[chain_custody, skip])
report_draft_to_certification = OperatorPOWL(operator=Operator.XOR, children=[report_draft, skip])
certification_to_secure_archive = OperatorPOWL(operator=Operator.XOR, children=[certification, skip])
secure_archive_to_auction_prep = OperatorPOWL(operator=Operator.XOR, children=[secure_archive, skip])
