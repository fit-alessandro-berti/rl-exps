...
xor = OperatorPOWL(operator=Operator.XOR, children=[restoration_plan, skip])
...
root.order.add_edge(visual_inspection, provenance_check)
...
root.order.add_edge(condition_check, forger_risk)
