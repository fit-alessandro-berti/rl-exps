...
root = StrictPartialOrder(
    ...
    order={
        site_survey: [light_mapping, water_testing],
        light_mapping: [design_modules],
        water_testing: [design_modules],
        design_modules: [iot_setup],
        iot_setup: [sensor_calibration, nutrient_mix],
        sensor_calibration: [climate_control],
        nutrient_mix: [climate_control],
        climate_control: [regulatory_check, community_meet],
