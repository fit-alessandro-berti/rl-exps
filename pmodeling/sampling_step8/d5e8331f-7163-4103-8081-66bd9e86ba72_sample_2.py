...
root = StrictPartialOrder(nodes=[
    SitePrep, SeedSelect, NutrientMix, PlantingRows, EnvMonitor, WaterAdjust, PestControl,
    GrowthCheck, LightCalibrate, EnergyManage, HarvestCrop, QualitySort, PackGoods, ColdStore,
    MarketShip, DataAnalyze
])
