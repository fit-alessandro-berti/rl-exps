...
root.order.add_edge(incident_injection, live_monitoring)
root.order.add_edge(response_tracking, live_monitoring)
root.order.add_edge(interlock_check, live_monitoring)
