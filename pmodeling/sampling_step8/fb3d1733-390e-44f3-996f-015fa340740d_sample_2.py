...
loop = OperatorPOWL(operator=Operator.LOOP, children=[initial_assess, disassemble_parts, ultrasonic_clean, inspect_components, fabricate_gears, dial_restoration, repaint_markers, reassemble_movement, lubricate_bearings, calibrate_timing, polish_case, re_case_watch, quality_testing, document_process, package_product])

# Define the XOR (exclusive choice) for the process
xor = OperatorPOWL(operator=Operator.XOR, children=[fabricate_gears, repainted_markers])
