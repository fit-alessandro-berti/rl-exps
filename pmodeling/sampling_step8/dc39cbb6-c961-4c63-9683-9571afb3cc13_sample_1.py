...
root = StrictPartialOrder(nodes=[client_inquiry, req_gather, concept_sketch, client_feedback, revision_cycle, final_approval, art_creation, progress_update, quality_check, final_adjust, invoice_issue, shipment_prep, delivery_confirm, post_support, license_setup, frame_arrange])
