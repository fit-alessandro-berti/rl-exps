...
# IoT monitoring and data analytics are executed continuously
iot_data_loop = OperatorPOWL(operator=Operator.LOOP, children=[iot_monitoring, data_analytics])
...
root.order.add_edge(plant_seeding, iot_data_loop)
root.order.add_edge(iot_data_loop, nutrient_adjust)
