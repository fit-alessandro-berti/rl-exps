...
root = StrictPartialOrder(nodes=[
    ...
    equipment_buy, sensor_setup, irrigation_fit, solar_install,
    staff_train, pilot_plant, data_monitor, crop_harvest, maintenance_plan,
    community_meet
])

# Define edges to represent the flow of activities
