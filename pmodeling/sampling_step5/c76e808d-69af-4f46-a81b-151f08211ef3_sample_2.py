...
# Define each activity as a Transition object with its respective label
...
root = StrictPartialOrder(nodes=[milk_sourcing, culture_selection, milk_testing, curd_formation, whey_separation, molding_cheese, salting_process, aging_setup, env_monitoring, flavor_profiling, packaging_design, blockchain_entry, quality_audit, retail_sync, transport_prep, delivery_tracking, customer_feedback])
...
# Now, 'root' contains the complete POWL model for the artisanal cheese supply chain process