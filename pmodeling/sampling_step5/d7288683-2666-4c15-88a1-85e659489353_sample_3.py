...
# Start with the component sourcing activity
component_sourcing = Transition(label='Component Sourcing')

# Frame assembly, motor installation, sensor mounting, wiring setup, firmware upload, AI module, calibration phase, stress testing, flight simulation, pattern adjustment
...
# Quality inspect, compliance check, packaging final, delivery setup
