...
# Define the POWL model as a StrictPartialOrder with its nodes and dependencies
root = StrictPartialOrder(nodes=[
    ...
    trial_planting, pest_control, soilless_prep, system_calibrate, 
    data_monitor, harvest_plan, community_outreach
])
