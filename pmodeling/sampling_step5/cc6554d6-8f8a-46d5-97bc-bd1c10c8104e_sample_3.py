...
# Define the activities (nodes) in the POWL model
...
root = StrictPartialOrder(nodes=[
    demand_forecast, risk_assess, supplier_audit, inventory_scan, 
    route_optimize, order_prioritize, contract_review, delay_monitor, 
    shipment_reroute, cost_analyze, compliance_check, alternative_engage, 
