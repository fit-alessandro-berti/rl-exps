...
activities = ['Initial Assess', 'Artifact Scan', 'Condition Map', 'Material Test', 'Cleaning Phase', 'Stability Check', 'Minor Repair', 'Structural Reinforce', 'Surface Restore', 'Coating Apply', 'Ethics Review', 'Provenance Verify', 'Client Update', 'Final Report', 'Archive Store']
