...
root = StrictPartialOrder(nodes=[
    site_survey, regulation_check, modular_design, material_sourcing, energy_integration, climate_setup, nutrient_mix, system_assembly, automation_config, crop_seeding, growth_monitoring, waste_handling, community_meet, data_analysis, feedback_loop, yield_forecast
])
