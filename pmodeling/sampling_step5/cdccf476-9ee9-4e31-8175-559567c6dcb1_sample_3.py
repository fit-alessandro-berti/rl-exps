...
root = StrictPartialOrder(nodes=[
    milk_sourcing, curdling, microbial_test, whey_removal, pressing_cheese, salt_application, aging_control, 
    quality_check, eco_packaging, inventory_log, temp_monitoring, carrier_booking, trace_recording, feedback_review, 
