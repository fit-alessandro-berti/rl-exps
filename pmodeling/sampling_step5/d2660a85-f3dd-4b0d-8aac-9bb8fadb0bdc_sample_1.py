...
root = StrictPartialOrder(nodes=[
    site_survey, design_layout, install_modules, set_controls, select_crops, configure_irrigation, setup_lighting, deploy_sensors, train_staff, start_cultivation, monitor_growth, manage_pests, harvest_crops, pack_produce, distribute_goods
])
