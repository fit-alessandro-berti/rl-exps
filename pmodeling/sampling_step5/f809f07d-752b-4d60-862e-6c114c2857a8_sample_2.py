...
root = StrictPartialOrder(nodes=[
    ...
    three_d_scanning, wear_analysis, database_cross, law_consult, forgery_detect, 
    certification, document_prep, client_brief, secure_storage, risk_assessment, final_approval
])
