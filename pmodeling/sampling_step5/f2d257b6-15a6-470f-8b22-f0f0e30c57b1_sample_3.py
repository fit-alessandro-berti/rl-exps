...
root = StrictPartialOrder(nodes=[
    artifact_intake, condition_check, material_sampling, radiocarbon_test,
    provenance_review, imaging_capture, chemical_analysis, historical_match,
    expert_consult, forgery_scan, market_survey, value_estimate, certification,
    digital_archive, final_storage
])
