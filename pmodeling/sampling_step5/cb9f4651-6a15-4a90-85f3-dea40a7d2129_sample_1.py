...
root = StrictPartialOrder(nodes=[
    milk_sourcing, culture_prep, milk_pasteurize, milk_inoculate,
    curd_formation, curd_cut, whey_drain, mold_inoculate, press_cheese,
    aging_setup, humidity_control, temperature_monitor, quality_test,
    packaging, order_fulfill, retail_deliver, feedback_collect
])
