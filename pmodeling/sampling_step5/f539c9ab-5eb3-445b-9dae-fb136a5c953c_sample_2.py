...
root = StrictPartialOrder(nodes=[
    site_survey, structural_audit, modular_design, hydroponic_setup, climate_config, nutrient_mix, pest_detect, lighting_setup,
    energy_audit, automation_install, staff_training, market_analysis, regulation_check, yield_monitor, waste_manage, data_analytics
])
