...
root = StrictPartialOrder(nodes=[
    site_assess, load_testing, climate_study, medium_prep, bed_install, irrigation_setup, crop_select, pest_control, community_meet, monitor_deploy, waste_cycle, yield_forecast, market_link, workshop_plan, tech_integrate
])
