...
# Define the activities (use these exactly)
...
root = StrictPartialOrder(nodes=[
    Milk_Sourcing, Quality_Testing, Milk_Pasteurize, Culture_Inoculate, Coagulation, Curd_Cutting,
    Whey_Drain, Pressing, Salting, Aging_Control, Sensory_Audit, Packaging_Design, Label_Approval,
    Order_Customization, Logistics_Plan, Market_Delivery, Customer_Feedback, Regulatory_Check
])
