...
root = StrictPartialOrder(nodes=[
    seed_selection, nutrient_mix, environment_setup, sensor_deployment, growth_monitoring, pest_detection,
...
# Define the order of execution (dependencies between transitions)
