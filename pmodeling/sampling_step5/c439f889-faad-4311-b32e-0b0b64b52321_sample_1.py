...
# Define the activities (labels) for the POWL model
activities = ['Seed Sourcing', 'Farm Scheduling', 'Sensor Monitoring', 'Nutrient Cycling', 'Crop Forecasting', 'Pest Inspection', 'Harvest Timing', 'Quality Check', 'Eco Packaging', 'Storage Allocation', 'Order Processing', 'Route Planning', 'Vehicle Dispatch', 'Customer Feedback', 'Demand Analysis', 'Waste Management', 'Community Outreach']
