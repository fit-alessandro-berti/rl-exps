...
loop = OperatorPOWL(operator=Operator.LOOP, children=[sensor_monitoring, health_check, pest_control])
xor = OperatorPOWL(operator=Operator.XOR, children=[climate_control, skip])
root = StrictPartialOrder(nodes=[seed_selection, germination_start, seedling_transplant, nutrient_mix, water_delivery, light_adjustment, loop, xor, harvest_planning, crop_harvest, waste_sorting, biomass_process, energy_recycling, data_analysis, yield_forecast])
