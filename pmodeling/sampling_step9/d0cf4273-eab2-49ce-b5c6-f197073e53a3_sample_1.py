...
# Define the loop
loop = OperatorPOWL(operator=Operator.LOOP, children=[material_sourcing, cultural_verify, eco_transport, batch_storytelling, craftsman_assignment, product_creation])

# Define the exclusive choice
xor = OperatorPOWL(operator=Operator.XOR, children=[provenance_catalog, skip])
