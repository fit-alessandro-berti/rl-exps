...
loop = OperatorPOWL(operator=Operator.LOOP, children=[SiteAssess, LoadTesting, ClimateStudy, MediumPrep, BedInstall, IrrigationSetup, CropSelect, PestControl])
xor = OperatorPOWL(operator=Operator.XOR, children=[CommunityMeet, MonitorDeploy, WasteCycle, YieldForecast, MarketLink, WorkshopPlan, TechIntegrate])
