...
loop = OperatorPOWL(operator=Operator.LOOP, children=[disassembly, surface_clean, structural_repair, reconstruction, finish_match, stabilize_parts])
xor = OperatorPOWL(operator=Operator.XOR, children=[documentation, quality_audit, valuation, market_analysis, target_outreach])
