...
loop1 = OperatorPOWL(operator=Operator.LOOP, children=[seed_sourcing, farm_scheduling, sensor_monitoring, nutrient_cycling])
loop2 = OperatorPOWL(operator=Operator.LOOP, children=[crop_forecasting, pest_inspection, harvest_timing])
loop3 = OperatorPOWL(operator=Operator.LOOP, children=[quality_check, eco_packaging, storage_allocation])
loop4 = OperatorPOWL(operator=Operator.LOOP, children=[order_processing, route_planning, vehicle_dispatch])
loop5 = OperatorPOWL(operator=Operator.LOOP, children=[customer_feedback, demand_analysis, waste_management])
loop6 = OperatorPOWL(operator=Operator.LOOP, children=[community_outreach])
