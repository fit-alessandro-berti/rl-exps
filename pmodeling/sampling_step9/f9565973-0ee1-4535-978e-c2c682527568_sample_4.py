...
root = StrictPartialOrder(nodes=[
    artifact_intake_to_initial_survey,
    initial_survey_to_material_test,
    material_test_to_historical_check,
    historical_check_to_registry_search,
    registry_search_to_owner_interview,
    owner_interview_to_condition_report,
    condition_report_to_forgery_scan,
    forgery_scan_to_digital_tagging,
    digital_tagging_to_ledger_entry,
    ledger_entry_to_expert_review,
    expert_review_to_legal_verify,
    legal_verify_to_provenance_draft,
    provenance_draft_to_client_approval,
    client_approval_to_final_certificate,
    final_certificate_to_archive_storage
])

# Define the dependencies between transitions
root.order.add_edge(artifact_intake_to_initial_survey, initial_survey_to_material_test)
root.order.add_edge(initial_survey_to_material_test, material_test_to_historical_check)
root.order.add_edge(material_test_to_historical_check, historical_check_to_registry_search)
root.order.add_edge(historical_check_to_registry_search, registry_search_to_owner_interview)
root.order.add_edge(registry_search_to_owner_interview, owner_interview_to_condition_report)
root.order.add_edge(owner_interview_to_condition_report, condition_report_to_forgery_scan)
root.order.add_edge(condition_report_to_forgery_scan, forgery_scan_to_digital_tagging)
root.order.add_edge(forgery_scan_to_digital_tagging, digital_tagging_to_ledger_entry)
root.order.add_edge(digital_tagging_to_ledger_entry, ledger_entry_to_expert_review)
root.order.add_edge(ledger_entry_to_expert_review, expert_review_to_legal_verify)
root.order.add_edge(expert_review_to_legal_verify, legal_verify_to_provenance_draft)
root.order.add_edge(legal_verify_to_provenance_draft, provenance_draft_to_client_approval)
root.order.add_edge(provenance_draft_to_client_approval, client_approval_to_final_certificate)
root.order.add_edge(client_approval_to_final_certificate, final_certificate_to_archive_storage)
