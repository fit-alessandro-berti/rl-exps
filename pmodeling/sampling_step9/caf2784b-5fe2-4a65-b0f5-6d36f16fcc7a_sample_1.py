...
# Define loop
loop = OperatorPOWL(operator=Operator.LOOP, children=[site_audit, impact_study, design_modules, sensor_setup, hydroponics_install, nutrient_test, lighting_config, staff_training, data_collection, yield_analysis, pest_control, harvest_plan, packaging_prep, market_delivery])
