...
# Define the multi-layered process
...
exclusive_choice1 = OperatorPOWL(operator=Operator.XOR, children=[acquisition_approval_loop, repatriation_review_loop])
exclusive_choice2 = OperatorPOWL(operator=Operator.XOR, children=[archival_storage_loop, skip])

# Define the root process
root = StrictPartialOrder(nodes=[initial_inquiry, document_review, historical_research_loop, material_sampling_loop, forensic_testing_loop, ownership_audit_loop, legal_verification_loop, ethical_screening_loop, expert_consultation_loop, cultural_assessment_loop, condition_survey_loop, provenance_mapping_loop, risk_analysis_loop, report_compilation_loop, exclusive_choice1, exclusive_choice2])
...
root.order.add_edge(report_compilation_loop, exclusive_choice1)
root.order.add_edge(exclusive_choice1, exclusive_choice2)
root.order.add_edge(exclusive_choice2, archival_storage_loop)