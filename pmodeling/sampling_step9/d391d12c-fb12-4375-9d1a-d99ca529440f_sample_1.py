...
# Define loop
loop = OperatorPOWL(operator=Operator.LOOP, children=[plant_seed, monitor_growth, adjust_controls, harvest_plan, waste_recycle])

# Define root
root = StrictPartialOrder(nodes=[site_survey, climate_check, soil_testing, media_select, design_layout, hydro_setup, nutrient_mix, sensor_install, regulation_review, permit_apply, stakeholder_meet, community_train, xor, loop])
...
root.order.add_edge(community_train, xor)
