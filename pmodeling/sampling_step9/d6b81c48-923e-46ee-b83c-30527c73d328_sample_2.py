...
# Define loop for flight execution
loop = OperatorPOWL(operator=Operator.LOOP, children=[flight_launch, telemetry_monitor, anomaly_detect, collision_assess, data_upload, postflight_review, battery_optimize, damage_repair, compliance_report, performance_log, mission_debrief])

# Define exclusive choice for pre-flight activities
xor = OperatorPOWL(operator=Operator.XOR, children=[preflight, skip])
