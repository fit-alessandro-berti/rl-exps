...
loop = OperatorPOWL(operator=Operator.LOOP, children=[initial_inquiry, document_review, historical_research, material_sampling, forensic_testing, ownership_audit, legal_verification, ethical_screening, expert_consultation, cultural_assessment, condition_survey, provenance_mapping, risk_analysis, report_compilation, acquisition_approval, repatriation_review, archival_storage])
xor = OperatorPOWL(operator=Operator.XOR, children=[skip, archival_storage])
