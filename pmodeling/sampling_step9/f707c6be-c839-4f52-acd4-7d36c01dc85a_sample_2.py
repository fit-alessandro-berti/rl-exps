...
loop = OperatorPOWL(operator=Operator.LOOP, children=[artifact_intake, condition_check, multi_spectral_scan, material_test, database_match, provenance_check, expert_review, historical_query, lab_collaboration, imaging_analysis, forgeries_detection, legal_drafting, certification_issue, client_briefing, archival_update])
xor = OperatorPOWL(operator=Operator.XOR, children=[certification_issue, skip])
