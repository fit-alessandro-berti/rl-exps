...
loop_audit = OperatorPOWL(operator=Operator.LOOP, children=[gather_documents, verify_suppliers, screen_transactions, classify_products, assess_risks, check_sanctions, review_tariffs, cross_verify_data, conduct_interviews, analyze_reports, identify_gaps, recommend_actions, implement_changes, monitor_compliance, finalize_report])
xor_audit = OperatorPOWL(operator=Operator.XOR, children=[skip, finalize_report])

# Define the root POWL model
root = StrictPartialOrder(nodes=[loop_audit, xor_audit])
