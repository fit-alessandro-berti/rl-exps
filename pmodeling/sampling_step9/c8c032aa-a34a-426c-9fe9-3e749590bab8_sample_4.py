...
root.order.add_edge(seed_planting, pest_monitoring)
root.order.add_edge(irrigation_check, quality_testing)
root.order.add_edge(pest_monitoring, quality_testing)
root.order.add_edge(energy_tracking, data_analysis)
