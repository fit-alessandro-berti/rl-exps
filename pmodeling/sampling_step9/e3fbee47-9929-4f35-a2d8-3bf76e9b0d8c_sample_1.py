...
loop = OperatorPOWL(operator=Operator.LOOP, children=[aging_monitor, flavor_adjust, packaging_design, label_approval])
xor = OperatorPOWL(operator=Operator.XOR, children=[order_processing, skip])
