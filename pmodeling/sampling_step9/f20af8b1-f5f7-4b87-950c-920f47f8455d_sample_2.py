...
root = StrictPartialOrder(nodes=[site_survey_loop, modular_build_loop, seed_select_loop, climate_calibrate_loop, ai_integration_loop, growth_adjust_loop, packaging_loop, sustain_audit_loop])
