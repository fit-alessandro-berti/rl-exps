...
loop = OperatorPOWL(operator=Operator.LOOP, children=[intake_review, preliminary_inspect, provenance_check, archival_research, material_testing, radiocarbon_date, stylistic_assess, expert_consult, findings_compile])
xor = OperatorPOWL(operator=Operator.XOR, children=[internal_review, client_present, approval_confirm])
