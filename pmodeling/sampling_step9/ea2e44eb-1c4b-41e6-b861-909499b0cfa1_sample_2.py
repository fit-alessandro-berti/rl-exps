...
artifact_intake_loop = OperatorPOWL(operator=Operator.LOOP, children=[artifact_intake, provenance_check])
...
panel_review_loop = OperatorPOWL(operator=Operator.LOOP, children=[panel_review, certify_report])
...
root = StrictPartialOrder(nodes=[artifact_intake_loop, provenance_check_xor, material_scan_xor, stylistic_match_xor, panel_review_loop, condition_assess_xor, catalog_entry_xor, loan_arrange_xor])
root.order.add_edge(artifact_intake_loop, provenance_check_xor)
root.order.add_edge(provenance_check_xor, material_scan_xor)
root.order.add_edge(material_scan_xor, stylistic_match_xor)
root.order.add_edge(stylistic_match_xor, panel_review_loop)
root.order.add_edge(panel_review_loop, condition_assess_xor)
