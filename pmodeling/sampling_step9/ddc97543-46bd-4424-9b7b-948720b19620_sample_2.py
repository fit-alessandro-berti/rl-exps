...
# Define the loop for data monitoring and yield forecasting
loop = OperatorPOWL(operator=Operator.LOOP, children=[data_monitor, yield_forecast])

# Define the root node
root = StrictPartialOrder(nodes=[site_survey_to_structure_prep, structure_prep_to_system_install, system_install_to_env_control, env_control_to_nutrient_mix, nutrient_mix_to_crop_select, crop_select_to_ai_setup, ai_setup_to_worker_train, worker_train_to_pest_control, pest_control_to_irrigation_plan, irrigation_plan_to_loop, loop, yield_forecast_to_energy_audit, energy_audit_to_market_setup, market_setup_to_logistics_plan, logistics_plan_to_waste_manage])
...
root.order.add_edge(pest_control_to_irrigation_plan, irrigation_plan_to_loop)
root.order.add_edge(irrigation_plan_to_loop, loop)
root.order.add_edge(loop, data_monitor_to_yield_forecast)
