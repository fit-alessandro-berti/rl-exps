...
root = StrictPartialOrder(nodes=[site_survey_to_regulation_check, regulation_check_to_modular_design, modular_design_to_material_sourcing, material_sourcing_to_energy_integration, energy_integration_to_climate_setup, climate_setup_to_nutrient_mix, nutrient_mix_to_system_assembly, system_assembly_to_automation_config, automation_config_to_crop_seeding, crop_seeding_to_growth_monitoring, growth_monitoring_to_waste_handling, waste_handling_to_community_meet, community_meet_to_data_analysis, data_analysis_to_feedback_loop, feedback_loop_to_yield_forecast])
