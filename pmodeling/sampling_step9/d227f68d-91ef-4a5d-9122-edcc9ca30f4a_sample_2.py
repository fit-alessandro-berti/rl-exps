...
loop = OperatorPOWL(operator=Operator.LOOP, children=[seed_selection, nutrient_mix])
xor = OperatorPOWL(operator=Operator.XOR, children=[climate_setup, automation_link])
root = StrictPartialOrder(nodes=[site_survey, design_layout, permits_check, foundation_prep, frame_assembly, hydro_setup, loop, xor, staff_training, yield_tracking, distribution_plan])
...
root.order.add_edge(climate_setup, automation_link)
