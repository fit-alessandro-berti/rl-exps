...
loop = OperatorPOWL(operator=Operator.LOOP, children=[Assess_Artifact, Verify_Provenance, Analyze_Condition, Plan_Conservation, Clean_Surface, Stabilize_Structure, Source_Materials, Fabricate_Parts, Perform_Repairs, Apply_Patina, Match_Colors, Document_Process, Review_Quality, Obtain_Approval, Package_Securely, Arrange_Transport])
