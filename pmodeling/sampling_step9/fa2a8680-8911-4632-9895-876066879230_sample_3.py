...
loop = OperatorPOWL(operator=Operator.LOOP, children=[ClientMeet, RequirementGather, ModuleDesign, SupplierVetting, ComponentOrder, PrototypeBuild, FieldTesting, TestAnalysis, SoftwareSetup, DataIntegration, PilotTrain, ComplianceCheck])
xor = OperatorPOWL(operator=Operator.XOR, children=[FleetDeploy, RemoteMonitor, MaintenancePlan, PerformanceTune])
