...
xor3 = OperatorPOWL(operator=Operator.XOR, children=[conservation_plan, storage_setup])
xor4 = OperatorPOWL(operator=Operator.XOR, children=[stakeholder_update, acquisition_approval])

root = StrictPartialOrder(nodes=[artifact_intake, condition_check, loop, xor, xor2, xor3, xor4])
...
root.order.add_edge(xor4, acquisition_approval)