...
loop = OperatorPOWL(operator=Operator.LOOP, children=[nutrient_mix, sensor_check, light_adjust, water_cycle, pest_scan, growth_audit, harvest_plan, demand_sync, quality_grade, pack_items, waste_compost, data_review])
xor = OperatorPOWL(operator=Operator.XOR, children=[cycle_reset, skip])
