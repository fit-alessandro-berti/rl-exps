...
loop = OperatorPOWL(operator=Operator.LOOP, children=[GatherSpecs, DesignCustom, SourceParts, FirmwareLoad, MechanicalFit, CableRouting, SensorAlign, ComponentTest, SoftwareSync, FlightCalibrate, EnviroTest, RemotePair, QualityCheck, PackageUnit, RegisterDrone, ClientTrain])
