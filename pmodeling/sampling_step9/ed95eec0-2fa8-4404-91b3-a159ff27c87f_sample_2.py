...
loop = OperatorPOWL(operator=Operator.LOOP, children=[Trend_Scan, Idea_Harvest, Sector_Match, Brainstorm_Hub, Concept_Filter, Prototype_Build, Hybrid_Testing])
xor = OperatorPOWL(operator=Operator.XOR, children=[Risk_Assess, Scenario_Map, Strategy_Align])
xor2 = OperatorPOWL(operator=Operator.XOR, children=[Pilot_Launch, Data_Capture])
xor3 = OperatorPOWL(operator=Operator.XOR, children=[Market_Sense, Scale_Plan])
