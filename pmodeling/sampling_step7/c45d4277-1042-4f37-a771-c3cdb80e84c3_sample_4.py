...
root = StrictPartialOrder(nodes=[
    trend_scan, opportunity_map, expert_gather, idea_sprint, proto_build, user_feedback, risk_review, ip_audit, pilot_launch, stakeholder_meet, resource_shift, scale_up, impact_assess, knowledge_share, monitor_trends
])
