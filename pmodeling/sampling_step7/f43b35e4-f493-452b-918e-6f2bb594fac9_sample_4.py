...
root = StrictPartialOrder(nodes=[
    client_brief, design_draft, part_sourcing, component_fabric, circuit_assembly,
    software_upload, initial_testing, flight_calibrate, payload_mount, stress_testing,
    feedback_loop, quality_check, certification, packaging, delivery_plan, post_support
])
