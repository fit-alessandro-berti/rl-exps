...
src_components = Transition(label='Component Sourcing')
...
# Create a partial order model for the process
...
root.order.add_edge(req_analysis, src_components)
root.order.add_edge(src_components, quality_check)
