...
root = StrictPartialOrder(nodes=[permit_securing, structure_check, soil_testing, water_analysis, material_sourcing, planter_setup, sensor_install, irrigation_setup, vendor_liaison, staff_training, pest_control, produce_marketing, crop_rotation, health_audit, waste_composting])
